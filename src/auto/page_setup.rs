...
impl PageSetup {
    ...
    //pub fn new_from_file(file_name: &str, error: Option<glib::Error>) -> PageSetup {
    //    unsafe { TODO: call ffi::gtk_page_setup_new_from_file() }
    //}

    //pub fn new_from_key_file(key_file: /*Ignored*/&glib::KeyFile, group_name: Option<&str>, error: Option<glib::Error>) -> PageSetup {

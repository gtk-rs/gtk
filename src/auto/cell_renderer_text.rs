...
impl<O: IsA<CellRendererText> + IsA<glib::object::Object>> CellRendererTextExt for O {
    ...
    fn get_property_ellipsize(&self) -> pango::EllipsizeMode {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <pango::EllipsizeMode as StaticType>::static_type().to_glib());
    ...
    fn get_property_stretch(&self) -> pango::Stretch {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <pango::Stretch as StaticType>::static_type().to_glib());
    ...
    fn get_property_style(&self) -> pango::Style {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <pango::Style as StaticType>::static_type().to_glib());
    ...
    fn get_property_underline(&self) -> pango::Underline {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <pango::Underline as StaticType>::static_type().to_glib());
    ...
    fn get_property_variant(&self) -> pango::Variant {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <pango::Variant as StaticType>::static_type().to_glib());
    ...
    fn get_property_wrap_mode(&self) -> pango::WrapMode {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <pango::WrapMode as StaticType>::static_type().to_glib());

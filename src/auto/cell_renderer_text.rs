...
pub trait CellRendererTextExt {
    ...
    fn connect_property_align_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_alignment_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_editable_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_ellipsize_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_ellipsize_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_family_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_family_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_font_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_foreground_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_foreground_rgba_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_language_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_rise_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_rise_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_single_paragraph_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_size_points_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_size_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_stretch_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_stretch_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_style_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_variant_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_variant_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_weight_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_weight_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_width_chars_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_wrap_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_wrap_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<CellRendererText> {
    ...
    f(&CellRendererText::from_glib_none(this).downcast_unchecked())
}

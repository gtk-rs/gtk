...
impl TreePath {
    ...
    //#[cfg(feature = "v3_12")]
    //pub fn new_from_indicesv(indices: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 14 }) -> TreePath {
    ...
    //pub fn get_indices_with_depth(&mut self) -> /*Unimplemented*/CArray TypeId { ns_id: 0, id: 14 } {

...
pub trait FontChooserExt {
    ...
    fn connect_property_font_desc_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_preview_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_preview_entry_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<FontChooser> {
    ...
    f(&FontChooser::from_glib_none(this).downcast_unchecked())
}

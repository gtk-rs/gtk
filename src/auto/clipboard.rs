...
impl Clipboard {
    ...
    //pub fn request_contents<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, target: &gdk::Atom, callback: /*Unknown conversion*//*Unimplemented*/ClipboardReceivedFunc, user_data: P) {
    //    unsafe { TODO: call ffi::gtk_clipboard_request_contents() }
    //}

    //pub fn request_image<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, callback: /*Unknown conversion*//*Unimplemented*/ClipboardImageReceivedFunc, user_data: P) {
    //    unsafe { TODO: call ffi::gtk_clipboard_request_image() }
    //}

    //pub fn request_rich_text<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, buffer: &TextBuffer, callback: /*Unknown conversion*//*Unimplemented*/ClipboardRichTextReceivedFunc, user_data: P) {
    //    unsafe { TODO: call ffi::gtk_clipboard_request_rich_text() }
    //}

    //pub fn request_targets<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, callback: /*Unknown conversion*//*Unimplemented*/ClipboardTargetsReceivedFunc, user_data: P) {
    //    unsafe { TODO: call ffi::gtk_clipboard_request_targets() }
    //}

    //pub fn request_text<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, callback: /*Unknown conversion*//*Unimplemented*/ClipboardTextReceivedFunc, user_data: P) {
    //    unsafe { TODO: call ffi::gtk_clipboard_request_text() }
    //}

    //pub fn request_uris<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, callback: /*Unknown conversion*//*Unimplemented*/ClipboardURIReceivedFunc, user_data: P) {
    ...
    //pub fn set_with_data<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, targets: &[&TargetEntry], n_targets: u32, get_func: /*Unknown conversion*//*Unimplemented*/ClipboardGetFunc, clear_func: /*Unknown conversion*//*Unimplemented*/ClipboardClearFunc, user_data: P) -> bool {
    //    unsafe { TODO: call ffi::gtk_clipboard_set_with_data() }
    //}

    //pub fn set_with_owner<P: IsA<glib::Object>>(&self, targets: &[&TargetEntry], n_targets: u32, get_func: /*Unknown conversion*//*Unimplemented*/ClipboardGetFunc, clear_func: /*Unknown conversion*//*Unimplemented*/ClipboardClearFunc, owner: &P) -> bool {
    ...
    //pub fn wait_for_rich_text(&self, buffer: &TextBuffer) -> (/*Unimplemented*/Option<CArray TypeId { ns_id: 0, id: 3 }>, gdk::Atom, /*Unimplemented*/Fundamental: Size) {

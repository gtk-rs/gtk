...
pub trait ClipboardExt {
    ...
    //fn set_with_data<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, targets: &[&TargetEntry], n_targets: u32, get_func: /*Unknown conversion*//*Unimplemented*/ClipboardGetFunc, clear_func: /*Unknown conversion*//*Unimplemented*/ClipboardClearFunc, user_data: P) -> bool;

    //fn set_with_owner<P: IsA<glib::Object>>(&self, targets: &[&TargetEntry], n_targets: u32, get_func: /*Unknown conversion*//*Unimplemented*/ClipboardGetFunc, clear_func: /*Unknown conversion*//*Unimplemented*/ClipboardClearFunc, owner: &P) -> bool;
    ...
    //fn wait_for_rich_text(&self, buffer: &TextBuffer) -> (/*Unimplemented*/Option<CArray TypeId { ns_id: 0, id: 3 }>, gdk::Atom, /*Unimplemented*/Fundamental: Size);

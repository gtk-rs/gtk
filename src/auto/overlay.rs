...
impl Overlay {
    ...
    #[cfg(feature = "v3_18")]
    pub fn get_overlay_pass_through<P: IsA<Widget>>(&self, widget: &P) -> bool {
        unsafe {
    ...
    #[cfg(feature = "v3_18")]
    pub fn reorder_overlay<P: IsA<Widget>>(&self, child: &P, position: i32) {
        unsafe {
    ...
    #[cfg(feature = "v3_18")]
    pub fn set_overlay_pass_through<P: IsA<Widget>>(&self, widget: &P, pass_through: bool) {
        unsafe {

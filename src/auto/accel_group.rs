...
impl AccelGroup {
    ...
    //pub fn activate<T: IsA</*Ignored*/gobject::Object>>(&self, accel_quark: /*Ignored*/glib::Quark, acceleratable: &T, accel_key: u32, accel_mods: gdk::ModifierType) -> bool {
    ...
    pub fn disconnect_key(&self, accel_key: u32, accel_mods: gdk::ModifierType) -> bool {
        unsafe {
            from_glib(ffi::gtk_accel_group_disconnect_key(self.to_glib_none().0, accel_key, accel_mods))
        }
    }

    //pub fn find(&self, find_func: /*Unknown conversion*//*Unimplemented*/AccelGroupFindFunc, data: /*Unimplemented*/Fundamental: Pointer) -> /*Ignored*/AccelKey {
    ...
    pub fn get_modifier_mask(&self) -> gdk::ModifierType {
        unsafe {
            ffi::gtk_accel_group_get_modifier_mask(self.to_glib_none().0)
        }
    }

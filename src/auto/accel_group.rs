...
impl AccelGroup {
    ...
    //pub fn activate<P: IsA<glib::Object>>(&self, accel_quark: /*Ignored*/glib::Quark, acceleratable: &P, accel_key: u32, accel_mods: gdk::ModifierType) -> bool {
    ...
    //pub fn disconnect<'a, P: Into<Option<&'a /*Ignored*/glib::Closure>>>(&self, closure: P) -> bool {
    ...
    //pub fn find<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, find_func: /*Unknown conversion*//*Unimplemented*/AccelGroupFindFunc, data: P) -> /*Ignored*/Option<AccelKey> {

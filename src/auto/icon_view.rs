...
pub trait IconViewExt {
    ...
    fn connect_property_cell_area_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_column_spacing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_columns_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_item_orientation_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_item_padding_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_item_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_margin_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_markup_column_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_model_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_pixbuf_column_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_selection_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_spacing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_text_column_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

...
impl IconView {
    ...
    #[cfg(feature = "v3_6")]
    pub fn get_cell_rect<'a, P: IsA<CellRenderer> + 'a, Q: Into<Option<&'a P>>>(&self, path: &TreePath, cell: Q) -> Option<gdk::Rectangle> {
        let cell = cell.into();
        let cell = cell.to_glib_none().0;
        unsafe {
            let mut rect = gdk::Rectangle::uninitialized();
            let ret = from_glib(ffi::gtk_icon_view_get_cell_rect(self.to_glib_none().0, mut_override(path.to_glib_none().0), cell, rect.to_glib_none_mut().0));
    ...
    //pub fn selected_foreach<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, func: /*Unknown conversion*//*Unimplemented*/IconViewForeachFunc, data: P) {
    ...
    pub fn set_cursor<'a, P: IsA<CellRenderer> + 'a, Q: Into<Option<&'a P>>>(&self, path: &TreePath, cell: Q, start_editing: bool) {
        let cell = cell.into();
        let cell = cell.to_glib_none().0;
        unsafe {
            ffi::gtk_icon_view_set_cursor(self.to_glib_none().0, mut_override(path.to_glib_none().0), cell, start_editing.to_glib());
        }
    }

    pub fn set_drag_dest_item<'a, P: Into<Option<&'a TreePath>>>(&self, path: P, pos: IconViewDropPosition) {
        let path = path.into();
        unsafe {
    ...
    pub fn set_model<'a, P: IsA<TreeModel> + 'a, Q: Into<Option<&'a P>>>(&self, model: Q) {
        ...
        unsafe {
            ffi::gtk_icon_view_set_model(self.to_glib_none().0, model);
        }
    }
    ...
    pub fn set_tooltip_cell<'a, P: IsA<CellRenderer> + 'a, Q: Into<Option<&'a P>>>(&self, tooltip: &Tooltip, path: &TreePath, cell: Q) {
        let cell = cell.into();
        let cell = cell.to_glib_none().0;
        unsafe {
            ffi::gtk_icon_view_set_tooltip_cell(self.to_glib_none().0, tooltip.to_glib_none().0, mut_override(path.to_glib_none().0), cell);
        }
    }

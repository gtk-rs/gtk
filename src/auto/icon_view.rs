...
impl IconView {
    ...
    pub fn create_drag_icon(&self, path: &mut TreePath) -> Option<cairo::Surface> {
        unsafe {
            from_glib_full(ffi::gtk_icon_view_create_drag_icon(self.to_glib_none().0, path.to_glib_none_mut().0))
        }
    }
...
unsafe extern "C" fn activate_cursor_item_trampoline(this: *mut GtkIconView, f: gpointer) -> gboolean {
    callback_guard!();
    let f: &Box_<Fn(&IconView) -> bool + 'static> = transmute(f);
    f(&from_glib_none(this)).to_glib()
}

unsafe extern "C" fn item_activated_trampoline(this: *mut GtkIconView, path: *mut GtkTreePath, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&IconView, &TreePath) + 'static> = transmute(f);
    f(&from_glib_none(this), &from_glib_none(path))
}

unsafe extern "C" fn move_cursor_trampoline(this: *mut GtkIconView, step: GtkMovementStep, count: c_int, f: gpointer) -> gboolean {
    callback_guard!();
    let f: &Box_<Fn(&IconView, MovementStep, i32) -> bool + 'static> = transmute(f);
    f(&from_glib_none(this), from_glib(step), count).to_glib()
}

unsafe extern "C" fn select_all_trampoline(this: *mut GtkIconView, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&IconView) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

unsafe extern "C" fn select_cursor_item_trampoline(this: *mut GtkIconView, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&IconView) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

unsafe extern "C" fn selection_changed_trampoline(this: *mut GtkIconView, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&IconView) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

unsafe extern "C" fn toggle_cursor_item_trampoline(this: *mut GtkIconView, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&IconView) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

unsafe extern "C" fn unselect_all_trampoline(this: *mut GtkIconView, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&IconView) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

...
impl Tooltip {
    pub fn set_custom<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, custom_widget: Q) {
        ...
        let custom_widget = custom_widget.to_glib_none().0;
        unsafe {
            ffi::gtk_tooltip_set_custom(self.to_glib_none().0, custom_widget);
        }
    }
    ...
    pub fn set_icon<'a, P: Into<Option<&'a gdk_pixbuf::Pixbuf>>>(&self, pixbuf: P) {
        ...
        unsafe {
            ffi::gtk_tooltip_set_icon(self.to_glib_none().0, pixbuf);
        }
    }

    //pub fn set_icon_from_gicon<'a, P: IsA</*Ignored*/gio::Icon> + 'a, Q: Into<Option<&'a P>>>(&self, gicon: Q, size: i32) {
    //    unsafe { TODO: call ffi::gtk_tooltip_set_icon_from_gicon() }
    //}

    pub fn set_icon_from_icon_name<'a, P: Into<Option<&'a str>>>(&self, icon_name: P, size: i32) {
        let icon_name = icon_name.into();
        let icon_name = icon_name.to_glib_none().0;
        unsafe {
            ffi::gtk_tooltip_set_icon_from_icon_name(self.to_glib_none().0, icon_name, size);
        }
    }

    pub fn set_icon_from_stock<'a, P: Into<Option<&'a str>>>(&self, stock_id: P, size: i32) {
        let stock_id = stock_id.into();
        let stock_id = stock_id.to_glib_none().0;
        unsafe {
            ffi::gtk_tooltip_set_icon_from_stock(self.to_glib_none().0, stock_id, size);
        }
    }
    ...
    pub fn set_markup<'a, P: Into<Option<&'a str>>>(&self, markup: P) {
        ...
        unsafe {
            ffi::gtk_tooltip_set_markup(self.to_glib_none().0, markup);
        }
    }
    ...
    pub fn set_text<'a, P: Into<Option<&'a str>>>(&self, text: P) {
        ...
        unsafe {
            ffi::gtk_tooltip_set_text(self.to_glib_none().0, text);
        }
    }

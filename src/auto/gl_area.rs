...
pub trait GLAreaExt {
    ...
    #[cfg(feature = "v3_16")]
    fn connect_property_auto_render_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_16")]
    fn connect_property_context_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_16")]
    fn connect_property_has_alpha_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_16")]
    fn connect_property_has_depth_buffer_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_16")]
    fn connect_property_has_stencil_buffer_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_22")]
    fn connect_property_use_es_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<GLArea> {
    ...
    f(&GLArea::from_glib_none(this).downcast_unchecked())
}

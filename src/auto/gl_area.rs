...
impl GLArea {
    ...
    //#[cfg(gtk_3_16)]
    //pub fn get_error(&self) -> /*Ignored*/glib::Error {
    //    unsafe { TODO: call ffi::gtk_gl_area_get_error() }
    //}
    ...
    //#[cfg(gtk_3_16)]
    //pub fn set_error(&self, error: /*Ignored*/Option<&glib::Error>) {
    //    unsafe { TODO: call ffi::gtk_gl_area_set_error() }
    //}

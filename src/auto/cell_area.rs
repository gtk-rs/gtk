...
pub trait CellAreaExt {
    ...
    fn connect_property_edit_widget_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_edited_cell_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_focus_cell_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}

...
pub trait CellAreaExt {
    ...
    //fn activate_cell<T: IsA<Widget>, U: IsA<CellRenderer>>(&self, widget: &T, renderer: &U, event: /*Unknown conversion*/Unknown rust type: "Event", cell_area: &Rectangle, flags: CellRendererState) -> bool;
    ...
    //fn add_with_properties<T: IsA<CellRenderer>>(&self, renderer: &T, first_prop_name: &str, : /*Unknown conversion*/Fundamental: VarArgs);
    ...
    //fn cell_get<T: IsA<CellRenderer>>(&self, renderer: &T, first_prop_name: &str, : /*Unknown conversion*/Fundamental: VarArgs);

    //fn cell_get_property<T: IsA<CellRenderer>>(&self, renderer: &T, property_name: &str, value: /*Ignored*/&mut gobject::Value);

    //fn cell_get_valist<T: IsA<CellRenderer>>(&self, renderer: &T, first_property_name: &str, var_args: /*Unknown conversion*/Unsupported);

    //fn cell_set<T: IsA<CellRenderer>>(&self, renderer: &T, first_prop_name: &str, : /*Unknown conversion*/Fundamental: VarArgs);

    //fn cell_set_property<T: IsA<CellRenderer>>(&self, renderer: &T, property_name: &str, value: /*Ignored*/&gobject::Value);

    //fn cell_set_valist<T: IsA<CellRenderer>>(&self, renderer: &T, first_property_name: &str, var_args: /*Unknown conversion*/Unsupported);

    fn copy_context(&self, context: &CellAreaContext) -> Option<CellAreaContext>;

    fn create_context(&self) -> Option<CellAreaContext>;

    //fn event<T: IsA<Widget>>(&self, context: &CellAreaContext, widget: &T, event: /*Unknown conversion*/Unknown rust type: "Event", cell_area: &Rectangle, flags: CellRendererState) -> i32;

    fn focus(&self, direction: DirectionType) -> bool;

    //fn foreach(&self, callback: /*Unknown conversion*/Unknown rust type: "CellCallback", callback_data: Fundamental: Pointer);

    //fn foreach_alloc<T: IsA<Widget>>(&self, context: &CellAreaContext, widget: &T, cell_area: &Rectangle, background_area: &Rectangle, callback: /*Unknown conversion*/Unknown rust type: "CellAllocCallback", callback_data: Fundamental: Pointer);

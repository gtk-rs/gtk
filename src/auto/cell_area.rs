...
pub trait CellAreaExt {
    ...
    //fn cell_get_property<T: IsA<CellRenderer>>(&self, renderer: &T, property_name: &str, value: /*Ignored*/&mut glib::Value);
    ...
    //fn cell_set_property<T: IsA<CellRenderer>>(&self, renderer: &T, property_name: &str, value: /*Ignored*/&glib::Value);

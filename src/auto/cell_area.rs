...
pub trait CellAreaExt {
    ...
    fn activate_cell<T: IsA<Widget>, U: IsA<CellRenderer>>(&self, widget: &T, renderer: &U, event: &gdk::Event, cell_area: &Rectangle, flags: CellRendererState) -> bool;
    ...
    fn event<T: IsA<Widget>>(&self, context: &CellAreaContext, widget: &T, event: &gdk::Event, cell_area: &Rectangle, flags: CellRendererState) -> i32;

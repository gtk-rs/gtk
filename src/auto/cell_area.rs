...
pub trait CellAreaExt {
    ...
    //fn foreach_alloc<T: IsA<Widget>>(&self, context: &CellAreaContext, widget: &T, cell_area: &gdk::Rectangle, background_area: &gdk::Rectangle, callback: /*Unknown conversion*//*Unimplemented*/CellAllocCallback, callback_data: /*Unimplemented*/Fundamental: Pointer);

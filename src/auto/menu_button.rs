...
impl MenuButton {
    ...
    #[cfg(feature = "v3_6")]
    pub fn set_align_widget<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, align_widget: Q) {
        let align_widget = align_widget.into();
        let align_widget = align_widget.to_glib_none().0;
        unsafe {
            ffi::gtk_menu_button_set_align_widget(self.to_glib_none().0, align_widget);
        }
    }
    ...
    #[cfg(feature = "v3_6")]
    pub fn set_menu_model<'a, P: IsA<gio::MenuModel> + 'a, Q: Into<Option<&'a P>>>(&self, menu_model: Q) {
        let menu_model = menu_model.into();
        let menu_model = menu_model.to_glib_none().0;
        unsafe {
            ffi::gtk_menu_button_set_menu_model(self.to_glib_none().0, menu_model);
        }
    }

    #[cfg(feature = "v3_12")]
    pub fn set_popover<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, popover: Q) {
        let popover = popover.into();
        let popover = popover.to_glib_none().0;
        unsafe {
            ffi::gtk_menu_button_set_popover(self.to_glib_none().0, popover);
        }
    }

    #[cfg(feature = "v3_6")]
    pub fn set_popup<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, menu: Q) {
        let menu = menu.into();
        let menu = menu.to_glib_none().0;
        unsafe {
            ffi::gtk_menu_button_set_popup(self.to_glib_none().0, menu);
        }
    }

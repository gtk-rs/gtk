...
impl Notebook {
    ...
    pub fn get_menu_label_text<P: IsA<Widget>>(&self, child: &P) -> Option<String> {
        unsafe {
    ...
    pub fn get_tab_label_text<P: IsA<Widget>>(&self, child: &P) -> Option<String> {
        unsafe {
    ...
    pub fn set_group_name<'a, P: Into<Option<&'a str>>>(&self, group_name: P) {
        let group_name = group_name.into();
        let group_name = group_name.to_glib_none().0;
        unsafe {
            ffi::gtk_notebook_set_group_name(self.to_glib_none().0, group_name);
        }
    }

    pub fn set_menu_label<'a, P: IsA<Widget>, Q: IsA<Widget> + 'a, R: Into<Option<&'a Q>>>(&self, child: &P, menu_label: R) {
        let menu_label = menu_label.into();
        let menu_label = menu_label.to_glib_none().0;
        unsafe {
            ffi::gtk_notebook_set_menu_label(self.to_glib_none().0, child.to_glib_none().0, menu_label);
        }
    }
    ...
    pub fn set_tab_label<'a, P: IsA<Widget>, Q: IsA<Widget> + 'a, R: Into<Option<&'a Q>>>(&self, child: &P, tab_label: R) {
        let tab_label = tab_label.into();
        let tab_label = tab_label.to_glib_none().0;
        unsafe {
            ffi::gtk_notebook_set_tab_label(self.to_glib_none().0, child.to_glib_none().0, tab_label);
        }
    }

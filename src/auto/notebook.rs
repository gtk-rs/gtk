...
impl Notebook {
    ...
    pub fn append_page<T: Upcast<Widget>, U: Upcast<Widget>>(&self, child: &T, tab_label: Option<&U>) -> i32 {
        unsafe {
            ffi::gtk_notebook_append_page(self.to_glib_none().0, child.upcast().to_glib_none().0, tab_label.map(Upcast::upcast).to_glib_none().0)
        }
    }
    ...
    pub fn append_page_menu<T: Upcast<Widget>, U: Upcast<Widget>, V: Upcast<Widget>>(&self, child: &T, tab_label: Option<&U>, menu_label: Option<&V>) -> i32 {
        unsafe {
            ffi::gtk_notebook_append_page_menu(self.to_glib_none().0, child.upcast().to_glib_none().0, tab_label.map(Upcast::upcast).to_glib_none().0, menu_label.map(Upcast::upcast).to_glib_none().0)
        }
    }
    ...
    pub fn detach_tab<T: Upcast<Widget>>(&self, child: &T) {
        unsafe {
            ffi::gtk_notebook_detach_tab(self.to_glib_none().0, child.upcast().to_glib_none().0);
        }
    }
    ...
    pub fn get_menu_label<T: Upcast<Widget>>(&self, child: &T) -> Option<Widget> {
        unsafe {
            from_glib_none(ffi::gtk_notebook_get_menu_label(self.to_glib_none().0, child.upcast().to_glib_none().0))
        }
    }

    pub fn get_menu_label_text<T: Upcast<Widget>>(&self, child: &T) -> Option<String> {
        unsafe {
            from_glib_none(ffi::gtk_notebook_get_menu_label_text(self.to_glib_none().0, child.upcast().to_glib_none().0))
        }
    }
    ...
    pub fn get_tab_detachable<T: Upcast<Widget>>(&self, child: &T) -> bool {
        unsafe {
            from_glib(ffi::gtk_notebook_get_tab_detachable(self.to_glib_none().0, child.upcast().to_glib_none().0))
        }
    }
    ...
    pub fn get_tab_label<T: Upcast<Widget>>(&self, child: &T) -> Option<Widget> {
        unsafe {
            from_glib_none(ffi::gtk_notebook_get_tab_label(self.to_glib_none().0, child.upcast().to_glib_none().0))
        }
    }

    pub fn get_tab_label_text<T: Upcast<Widget>>(&self, child: &T) -> Option<String> {
        unsafe {
            from_glib_none(ffi::gtk_notebook_get_tab_label_text(self.to_glib_none().0, child.upcast().to_glib_none().0))
        }
    }
    ...
    pub fn get_tab_reorderable<T: Upcast<Widget>>(&self, child: &T) -> bool {
        unsafe {
            from_glib(ffi::gtk_notebook_get_tab_reorderable(self.to_glib_none().0, child.upcast().to_glib_none().0))
        }
    }
    ...
    pub fn insert_page<T: Upcast<Widget>, U: Upcast<Widget>>(&self, child: &T, tab_label: Option<&U>, position: i32) -> i32 {
        unsafe {
            ffi::gtk_notebook_insert_page(self.to_glib_none().0, child.upcast().to_glib_none().0, tab_label.map(Upcast::upcast).to_glib_none().0, position)
        }
    }
    ...
    pub fn insert_page_menu<T: Upcast<Widget>, U: Upcast<Widget>, V: Upcast<Widget>>(&self, child: &T, tab_label: Option<&U>, menu_label: Option<&V>, position: i32) -> i32 {
        unsafe {
            ffi::gtk_notebook_insert_page_menu(self.to_glib_none().0, child.upcast().to_glib_none().0, tab_label.map(Upcast::upcast).to_glib_none().0, menu_label.map(Upcast::upcast).to_glib_none().0, position)
        }
    }
    ...
    pub fn prepend_page<T: Upcast<Widget>, U: Upcast<Widget>>(&self, child: &T, tab_label: Option<&U>) -> i32 {
        unsafe {
            ffi::gtk_notebook_prepend_page(self.to_glib_none().0, child.upcast().to_glib_none().0, tab_label.map(Upcast::upcast).to_glib_none().0)
        }
    }
    ...
    pub fn prepend_page_menu<T: Upcast<Widget>, U: Upcast<Widget>, V: Upcast<Widget>>(&self, child: &T, tab_label: Option<&U>, menu_label: Option<&V>) -> i32 {
        unsafe {
            ffi::gtk_notebook_prepend_page_menu(self.to_glib_none().0, child.upcast().to_glib_none().0, tab_label.map(Upcast::upcast).to_glib_none().0, menu_label.map(Upcast::upcast).to_glib_none().0)
        }
    }
    ...
    pub fn reorder_child<T: Upcast<Widget>>(&self, child: &T, position: i32) {
        unsafe {
            ffi::gtk_notebook_reorder_child(self.to_glib_none().0, child.upcast().to_glib_none().0, position);
        }
    }

    pub fn set_action_widget<T: Upcast<Widget>>(&self, widget: &T, pack_type: PackType) {
        unsafe {
            ffi::gtk_notebook_set_action_widget(self.to_glib_none().0, widget.upcast().to_glib_none().0, pack_type);
        }
    }
    ...
    pub fn set_menu_label<T: Upcast<Widget>, U: Upcast<Widget>>(&self, child: &T, menu_label: Option<&U>) {
        unsafe {
            ffi::gtk_notebook_set_menu_label(self.to_glib_none().0, child.upcast().to_glib_none().0, menu_label.map(Upcast::upcast).to_glib_none().0);
        }
    }

    pub fn set_menu_label_text<T: Upcast<Widget>>(&self, child: &T, menu_text: &str) {
        unsafe {
            ffi::gtk_notebook_set_menu_label_text(self.to_glib_none().0, child.upcast().to_glib_none().0, menu_text.to_glib_none().0);
        }
    }
    ...
    pub fn set_tab_detachable<T: Upcast<Widget>>(&self, child: &T, detachable: bool) {
        unsafe {
            ffi::gtk_notebook_set_tab_detachable(self.to_glib_none().0, child.upcast().to_glib_none().0, detachable.to_glib());
        }
    }

    pub fn set_tab_label<T: Upcast<Widget>, U: Upcast<Widget>>(&self, child: &T, tab_label: Option<&U>) {
        unsafe {
            ffi::gtk_notebook_set_tab_label(self.to_glib_none().0, child.upcast().to_glib_none().0, tab_label.map(Upcast::upcast).to_glib_none().0);
        }
    }

    pub fn set_tab_label_text<T: Upcast<Widget>>(&self, child: &T, tab_text: &str) {
        unsafe {
            ffi::gtk_notebook_set_tab_label_text(self.to_glib_none().0, child.upcast().to_glib_none().0, tab_text.to_glib_none().0);
        }
    }
    ...
    pub fn set_tab_reorderable<T: Upcast<Widget>>(&self, child: &T, reorderable: bool) {
        unsafe {
            ffi::gtk_notebook_set_tab_reorderable(self.to_glib_none().0, child.upcast().to_glib_none().0, reorderable.to_glib());
        }
    }

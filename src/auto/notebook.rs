...
unsafe extern "C" fn change_current_page_trampoline(this: *mut GtkNotebook, object: c_int, f: gpointer) -> gboolean {
    callback_guard!();
    let f: &Box_<Fn(&Notebook, i32) -> bool + 'static> = transmute(f);
    f(&from_glib_none(this), object).to_glib()
}

unsafe extern "C" fn create_window_trampoline(this: *mut GtkNotebook, page: *mut GtkWidget, x: c_int, y: c_int, f: gpointer) -> *mut GtkNotebook {
    callback_guard!();
...
unsafe extern "C" fn focus_tab_trampoline(this: *mut GtkNotebook, object: GtkNotebookTab, f: gpointer) -> gboolean {
    callback_guard!();
    let f: &Box_<Fn(&Notebook, NotebookTab) -> bool + 'static> = transmute(f);
    f(&from_glib_none(this), from_glib(object)).to_glib()
}

unsafe extern "C" fn move_focus_out_trampoline(this: *mut GtkNotebook, object: GtkDirectionType, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&Notebook, DirectionType) + 'static> = transmute(f);
    f(&from_glib_none(this), from_glib(object))
}

unsafe extern "C" fn page_added_trampoline(this: *mut GtkNotebook, child: *mut GtkWidget, page_num: c_uint, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&Notebook, &Widget, u32) + 'static> = transmute(f);
    f(&from_glib_none(this), &from_glib_none(child), page_num)
}

unsafe extern "C" fn page_removed_trampoline(this: *mut GtkNotebook, child: *mut GtkWidget, page_num: c_uint, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&Notebook, &Widget, u32) + 'static> = transmute(f);
    f(&from_glib_none(this), &from_glib_none(child), page_num)
}

unsafe extern "C" fn page_reordered_trampoline(this: *mut GtkNotebook, child: *mut GtkWidget, page_num: c_uint, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&Notebook, &Widget, u32) + 'static> = transmute(f);
    f(&from_glib_none(this), &from_glib_none(child), page_num)
}

unsafe extern "C" fn reorder_tab_trampoline(this: *mut GtkNotebook, object: GtkDirectionType, p0: gboolean, f: gpointer) -> gboolean {
    callback_guard!();
...
unsafe extern "C" fn select_page_trampoline(this: *mut GtkNotebook, object: gboolean, f: gpointer) -> gboolean {
    callback_guard!();
    let f: &Box_<Fn(&Notebook, bool) -> bool + 'static> = transmute(f);
    f(&from_glib_none(this), from_glib(object)).to_glib()
}

unsafe extern "C" fn switch_page_trampoline(this: *mut GtkNotebook, page: *mut GtkWidget, page_num: c_uint, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&Notebook, &Widget, u32) + 'static> = transmute(f);

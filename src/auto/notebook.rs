...
pub trait NotebookExt {
    ...
    fn connect_property_enable_popup_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_group_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_page_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_scrollable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_border_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_tabs_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_tab_pos_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
impl<O: IsA<Notebook> + IsA<Container> + IsA<glib::object::Object>> NotebookExt for O {
    ...
    fn connect_property_enable_popup_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64 {
        unsafe {
            ...
            connect(self.to_glib_none().0, "notify::enable-popup",
    ...
    fn connect_property_group_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64 {
        unsafe {
            let f: Box_<Box_<Fn(&Self) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::group-name",
    ...
    fn connect_property_page_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64 {
        unsafe {
            let f: Box_<Box_<Fn(&Self) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::page",
    ...
    fn connect_property_scrollable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64 {
        unsafe {
            let f: Box_<Box_<Fn(&Self) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::scrollable",
    ...
    fn connect_property_show_border_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64 {
        unsafe {
            let f: Box_<Box_<Fn(&Self) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::show-border",
    ...
    fn connect_property_show_tabs_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64 {
        unsafe {
            let f: Box_<Box_<Fn(&Self) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::show-tabs",
    ...
    fn connect_property_tab_pos_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64 {
        unsafe {
            let f: Box_<Box_<Fn(&Self) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::tab-pos",
...
where P: IsA<Notebook> {
    ...
    f(&Notebook::from_glib_none(this).downcast_unchecked())
}

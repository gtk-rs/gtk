...
impl<O: IsA<MenuItem>> GtkMenuItemExt for O {
    ...
    fn get_property_right_justified(&self) -> bool {
        unsafe {
            ...
            gobject_sys::g_object_get_property(self.to_glib_none().0 as *mut gobject_sys::GObject, b"right-justified\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get().unwrap()
        }
    }
    ...
    fn set_property_right_justified(&self, right_justified: bool) {
        unsafe {
            gobject_sys::g_object_set_property(self.to_glib_none().0 as *mut gobject_sys::GObject, b"right-justified\0".as_ptr() as *const _, Value::from(&right_justified).to_glib_none().0);
        }
    }
...
unsafe extern "C" fn notify_right_justified_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkMenuItem, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<MenuItem> {
    let f: &F = &*(f as *const F);
    f(&MenuItem::from_glib_borrow(this).unsafe_cast())
}

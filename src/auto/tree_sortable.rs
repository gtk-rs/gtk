...
impl<O: IsA<TreeSortable> + IsA<Object>> TreeSortableExt for O {
    ...
    fn set_sort_column_id(&self, sort_column_id: i32, order: SortType) {
        unsafe {
            ffi::gtk_tree_sortable_set_sort_column_id(self.to_glib_none().0, sort_column_id, order.to_glib());
        }
    }
...
unsafe extern "C" fn sort_column_changed_trampoline<T>(this: *mut GtkTreeSortable, f: gpointer)

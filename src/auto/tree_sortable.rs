...
pub trait TreeSortableExt {
    ...
    //fn set_default_sort_func(&self, sort_func: /*Unknown conversion*/Unknown rust type: "TreeIterCompareFunc", user_data: Option<Fundamental: Pointer>, destroy: /*Unknown conversion*/Unknown rust type: "DestroyNotify");
    fn set_sort_column_id(&self, sort_column_id: i32, order: SortType);
    //fn set_sort_func(&self, sort_column_id: i32, sort_func: /*Unknown conversion*/Unknown rust type: "TreeIterCompareFunc", user_data: Option<Fundamental: Pointer>, destroy: /*Unknown conversion*/Unknown rust type: "DestroyNotify");
    fn sort_column_changed(&self);
}

impl<O: Upcast<TreeSortable>> TreeSortableExt for O {
    fn get_sort_column_id(&self) -> Option<(i32, SortType)> {
        unsafe {

...
pub trait CellRendererPixbufExt {
    ...
    fn connect_property_follow_state_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_pixbuf_expander_closed_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_pixbuf_expander_open_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_stock_detail_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_stock_id_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_stock_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<CellRendererPixbuf> {
    ...
    f(&CellRendererPixbuf::from_glib_none(this).downcast_unchecked())
}

...
pub trait ScaleExt {
    ...
    fn connect_property_draw_value_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_has_origin_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_value_pos_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<Scale> {
    ...
    f(&Scale::from_glib_none(this).downcast_unchecked())
}

...
impl Scale {
    ...
    pub fn add_mark(&self, value: f64, position: PositionType, markup: Option<&str>) {
        unsafe {
            ffi::gtk_scale_add_mark(self.to_glib_none().0, value, position.to_glib(), markup.to_glib_none().0);
        }
    }
...
unsafe extern "C" fn format_value_trampoline(this: *mut GtkScale, value: c_double, f: gpointer) -> *mut c_char {
    callback_guard!();

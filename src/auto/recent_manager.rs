...
impl RecentManager {
    ...
    //pub fn lookup_item(&self, uri: &str, error: Option<glib::Error>) -> RecentInfo {
    //    unsafe { TODO: call ffi::gtk_recent_manager_lookup_item() }
    //}

    //pub fn move_item(&self, uri: &str, new_uri: Option<&str>, error: Option<glib::Error>) -> bool {
    //    unsafe { TODO: call ffi::gtk_recent_manager_move_item() }
    //}

    //pub fn purge_items(&self, error: Option<glib::Error>) -> i32 {
    //    unsafe { TODO: call ffi::gtk_recent_manager_purge_items() }
    //}

    //pub fn remove_item(&self, uri: &str, error: Option<glib::Error>) -> bool {

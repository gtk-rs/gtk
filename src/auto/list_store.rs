...
impl ListStore {
    ...
    //pub fn newv(n_columns: i32, types: /*Unknown conversion*/Unknown rust type: "CArray TypeId { ns_id: 0, id: 30 }") -> ListStore {
    ...
    //pub fn insert_with_valuesv(&self, position: i32, columns: /*Unknown conversion*/Unknown rust type: "CArray TypeId { ns_id: 0, id: 14 }", values: /*Unknown conversion*/Unknown rust type: "CArray TypeId { ns_id: 3, id: 12 }", n_values: i32) -> TreeIter {
    ...
    //pub fn reorder(&self, new_order: /*Unknown conversion*/Unknown rust type: "CArray TypeId { ns_id: 0, id: 14 }") {

...
impl TextIter {
    ...
    //pub fn backward_find_char(&mut self, pred: /*Unknown conversion*/Unknown rust type: "TextCharPredicate", user_data: Fundamental: Pointer, limit: Option<&TextIter>) -> bool {
    ...
    pub fn backward_search(&self, str: &str, flags: TextSearchFlags, limit: Option<&TextIter>) -> Option<(TextIter, TextIter)> {
        unsafe {
            ...
            let ret = from_glib(ffi::gtk_text_iter_backward_search(self.to_glib_none().0, str.to_glib_none().0, flags, match_start.to_glib_none_mut().0, match_end.to_glib_none_mut().0, limit.to_glib_none().0));
    ...
    //pub fn forward_find_char(&mut self, pred: /*Unknown conversion*/Unknown rust type: "TextCharPredicate", user_data: Fundamental: Pointer, limit: Option<&TextIter>) -> bool {
    ...
    pub fn forward_search(&self, str: &str, flags: TextSearchFlags, limit: Option<&TextIter>) -> Option<(TextIter, TextIter)> {
        unsafe {
            let mut match_start = TextIter::uninitialized();
            let mut match_end = TextIter::uninitialized();
            let ret = from_glib(ffi::gtk_text_iter_forward_search(self.to_glib_none().0, str.to_glib_none().0, flags, match_start.to_glib_none_mut().0, match_end.to_glib_none_mut().0, limit.to_glib_none().0));
            if ret { Some((match_start, match_end)) } else { None }
        }
    }

...
impl TextIter {
    ...
    pub fn backward_search<'a, P: Into<Option<&'a TextIter>>>(&self, str: &str, flags: TextSearchFlags, limit: P) -> Option<(TextIter, TextIter)> {
        ...
        let limit = limit.to_glib_none().0;
        unsafe {
            let mut match_start = TextIter::uninitialized();
            let mut match_end = TextIter::uninitialized();
            let ret = from_glib(ffi::gtk_text_iter_backward_search(self.to_glib_none().0, str.to_glib_none().0, flags.to_glib(), match_start.to_glib_none_mut().0, match_end.to_glib_none_mut().0, limit));
    ...
    pub fn backward_to_tag_toggle<'a, P: Into<Option<&'a TextTag>>>(&mut self, tag: P) -> bool {
        let tag = tag.into();
        let tag = tag.to_glib_none().0;
        unsafe {
            from_glib(ffi::gtk_text_iter_backward_to_tag_toggle(self.to_glib_none_mut().0, tag))
        }
    }
    ...
    pub fn begins_tag<'a, P: Into<Option<&'a TextTag>>>(&self, tag: P) -> bool {
        ...
        let tag = tag.to_glib_none().0;
        unsafe {
            from_glib(ffi::gtk_text_iter_begins_tag(self.to_glib_none().0, tag))
        }
    }
    ...
    pub fn ends_tag<'a, P: Into<Option<&'a TextTag>>>(&self, tag: P) -> bool {
        ...
        let tag = tag.to_glib_none().0;
        unsafe {
            from_glib(ffi::gtk_text_iter_ends_tag(self.to_glib_none().0, tag))
        }
    }
    ...
    pub fn forward_search<'a, P: Into<Option<&'a TextIter>>>(&self, str: &str, flags: TextSearchFlags, limit: P) -> Option<(TextIter, TextIter)> {
        ...
        unsafe {
            let mut match_start = TextIter::uninitialized();
            let mut match_end = TextIter::uninitialized();
            let ret = from_glib(ffi::gtk_text_iter_forward_search(self.to_glib_none().0, str.to_glib_none().0, flags.to_glib(), match_start.to_glib_none_mut().0, match_end.to_glib_none_mut().0, limit));
            if ret { Some((match_start, match_end)) } else { None }
        }
    }
    ...
    pub fn forward_to_tag_toggle<'a, P: Into<Option<&'a TextTag>>>(&mut self, tag: P) -> bool {
        ...
        let tag = tag.to_glib_none().0;
        unsafe {
            from_glib(ffi::gtk_text_iter_forward_to_tag_toggle(self.to_glib_none_mut().0, tag))
        }
    }
    ...
    pub fn starts_tag<'a, P: Into<Option<&'a TextTag>>>(&self, tag: P) -> bool {
        ...
        let tag = tag.to_glib_none().0;
        unsafe {
            from_glib(ffi::gtk_text_iter_starts_tag(self.to_glib_none().0, tag))
        }
    }
    ...
    pub fn toggles_tag<'a, P: Into<Option<&'a TextTag>>>(&self, tag: P) -> bool {
        ...
        let tag = tag.to_glib_none().0;
        unsafe {
            from_glib(ffi::gtk_text_iter_toggles_tag(self.to_glib_none().0, tag))
        }
    }
}

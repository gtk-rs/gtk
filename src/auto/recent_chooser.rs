...
unsafe extern "C" fn item_activated_trampoline<T>(this: *mut GtkRecentChooser, f: gpointer)
...
unsafe extern "C" fn selection_changed_trampoline<T>(this: *mut GtkRecentChooser, f: gpointer)
where T: IsA<RecentChooser> {
    callback_guard!();
    let f: &Box_<Fn(&T) + 'static> = transmute(f);
    f(&RecentChooser::from_glib_none(this).downcast_unchecked())

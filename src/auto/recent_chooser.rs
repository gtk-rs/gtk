...
impl<O: IsA<RecentChooser>> RecentChooserExt for O {
    fn add_filter(&self, filter: &RecentFilter) {
        unsafe {
            gtk_sys::gtk_recent_chooser_add_filter(self.as_ref().to_glib_none().0, filter.to_glib_none().0);
        }
    }

    fn get_current_item(&self) -> Option<RecentInfo> {
        unsafe {
            from_glib_full(gtk_sys::gtk_recent_chooser_get_current_item(self.as_ref().to_glib_none().0))
        }
    }

    fn get_current_uri(&self) -> Option<GString> {
        unsafe {
            from_glib_full(gtk_sys::gtk_recent_chooser_get_current_uri(self.as_ref().to_glib_none().0))
        }
    }

    fn get_filter(&self) -> Option<RecentFilter> {
        unsafe {
            from_glib_none(gtk_sys::gtk_recent_chooser_get_filter(self.as_ref().to_glib_none().0))
        }
    }

    fn get_items(&self) -> Vec<RecentInfo> {
        unsafe {
            FromGlibPtrContainer::from_glib_full(gtk_sys::gtk_recent_chooser_get_items(self.as_ref().to_glib_none().0))
        }
    }

    fn get_limit(&self) -> i32 {
        unsafe {
            gtk_sys::gtk_recent_chooser_get_limit(self.as_ref().to_glib_none().0)
        }
    }

    fn get_local_only(&self) -> bool {
        unsafe {
            from_glib(gtk_sys::gtk_recent_chooser_get_local_only(self.as_ref().to_glib_none().0))
        }
    }

    fn get_select_multiple(&self) -> bool {
        unsafe {
            from_glib(gtk_sys::gtk_recent_chooser_get_select_multiple(self.as_ref().to_glib_none().0))
        }
    }

    fn get_show_icons(&self) -> bool {
        unsafe {
            from_glib(gtk_sys::gtk_recent_chooser_get_show_icons(self.as_ref().to_glib_none().0))
        }
    }

    fn get_show_not_found(&self) -> bool {
        unsafe {
            from_glib(gtk_sys::gtk_recent_chooser_get_show_not_found(self.as_ref().to_glib_none().0))
        }
    }

    fn get_show_private(&self) -> bool {
        unsafe {
            from_glib(gtk_sys::gtk_recent_chooser_get_show_private(self.as_ref().to_glib_none().0))
        }
    }

    fn get_show_tips(&self) -> bool {
        unsafe {
            from_glib(gtk_sys::gtk_recent_chooser_get_show_tips(self.as_ref().to_glib_none().0))
        }
    }

    fn get_sort_type(&self) -> RecentSortType {
        unsafe {
            from_glib(gtk_sys::gtk_recent_chooser_get_sort_type(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn get_uris(&self) -> Vec<GString> {
        unsafe {
            ...
            let ret = FromGlibContainer::from_glib_full_num(gtk_sys::gtk_recent_chooser_get_uris(self.as_ref().to_glib_none().0, &mut length), length as usize);
            ret
        }
    }
    ...
    fn list_filters(&self) -> Vec<RecentFilter> {
        unsafe {
            FromGlibPtrContainer::from_glib_container(gtk_sys::gtk_recent_chooser_list_filters(self.as_ref().to_glib_none().0))
        }
    }

    fn remove_filter(&self, filter: &RecentFilter) {
        unsafe {
            gtk_sys::gtk_recent_chooser_remove_filter(self.as_ref().to_glib_none().0, filter.to_glib_none().0);
        }
    }
    ...
    fn select_uri(&self, uri: &str) -> Result<(), Error> {
        unsafe {
            ...
            let _ = gtk_sys::gtk_recent_chooser_select_uri(self.as_ref().to_glib_none().0, uri.to_glib_none().0, &mut error);
    ...
    fn set_current_uri(&self, uri: &str) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = gtk_sys::gtk_recent_chooser_set_current_uri(self.as_ref().to_glib_none().0, uri.to_glib_none().0, &mut error);
            if error.is_null() { Ok(()) } else { Err(from_glib_full(error)) }
        }
    }
    ...
    fn set_filter(&self, filter: Option<&RecentFilter>) {
        unsafe {
            gtk_sys::gtk_recent_chooser_set_filter(self.as_ref().to_glib_none().0, filter.to_glib_none().0);
        }
    }
    ...
    fn set_local_only(&self, local_only: bool) {
        unsafe {
            gtk_sys::gtk_recent_chooser_set_local_only(self.as_ref().to_glib_none().0, local_only.to_glib());
        }
    }

    fn set_select_multiple(&self, select_multiple: bool) {
        unsafe {
            gtk_sys::gtk_recent_chooser_set_select_multiple(self.as_ref().to_glib_none().0, select_multiple.to_glib());
        }
    }

    fn set_show_icons(&self, show_icons: bool) {
        unsafe {
            gtk_sys::gtk_recent_chooser_set_show_icons(self.as_ref().to_glib_none().0, show_icons.to_glib());
        }
    }

    fn set_show_not_found(&self, show_not_found: bool) {
        unsafe {
            gtk_sys::gtk_recent_chooser_set_show_not_found(self.as_ref().to_glib_none().0, show_not_found.to_glib());
        }
    }

    fn set_show_private(&self, show_private: bool) {
        unsafe {
            gtk_sys::gtk_recent_chooser_set_show_private(self.as_ref().to_glib_none().0, show_private.to_glib());
        }
    }

    fn set_show_tips(&self, show_tips: bool) {
        unsafe {
            gtk_sys::gtk_recent_chooser_set_show_tips(self.as_ref().to_glib_none().0, show_tips.to_glib());
        }
    }

    fn set_sort_func<P: Fn(&RecentInfo, &RecentInfo) -> i32 + 'static>(&self, sort_func: P) {
        let sort_func_data: Box_<P> = Box::new(sort_func);
        unsafe extern "C" fn sort_func_func<P: Fn(&RecentInfo, &RecentInfo) -> i32 + 'static>(a: *mut gtk_sys::GtkRecentInfo, b: *mut gtk_sys::GtkRecentInfo, user_data: glib_sys::gpointer) -> libc::c_int {
        ...
        unsafe extern "C" fn data_destroy_func<P: Fn(&RecentInfo, &RecentInfo) -> i32 + 'static>(data: glib_sys::gpointer) {
            let _callback: Box_<P> = Box_::from_raw(data as *mut _);
        }
        let destroy_call3 = Some(data_destroy_func::<P> as _);
        let super_callback0: Box_<P> = sort_func_data;
        unsafe {
            gtk_sys::gtk_recent_chooser_set_sort_func(self.as_ref().to_glib_none().0, sort_func, Box::into_raw(super_callback0) as *mut _, destroy_call3);
        }
    }

    fn set_sort_type(&self, sort_type: RecentSortType) {
        unsafe {
            gtk_sys::gtk_recent_chooser_set_sort_type(self.as_ref().to_glib_none().0, sort_type.to_glib());
        }
    }
    ...
    fn unselect_uri(&self, uri: &str) {
        unsafe {
            gtk_sys::gtk_recent_chooser_unselect_uri(self.as_ref().to_glib_none().0, uri.to_glib_none().0);
        }
    }

...
pub trait RecentChooserExt {
    ...
    //fn get_uris(&self) -> (Vec<String>, Fundamental: Size);
    fn list_filters(&self) -> Vec<RecentFilter>;
    fn remove_filter(&self, filter: &RecentFilter);
    fn select_all(&self);
    //fn select_uri(&self, uri: &str, error: Option<glib::Error>) -> bool;
    //fn set_current_uri(&self, uri: &str, error: Option<glib::Error>) -> bool;

...
impl TextBuffer {
    ...
    //pub fn deserialize(&self, content_buffer: &TextBuffer, format: /*Unknown conversion*/Unknown rust type: "Atom", iter: /*Ignored*/&TextIter, data: /*Unknown conversion*/Unknown rust type: "CArray TypeId { ns_id: 0, id: 3 }", length: Fundamental: Size, error: /*Ignored*/Option<glib::Error>) -> bool {
    //    unsafe { TODO: call ffi::gtk_text_buffer_deserialize() }
    //}

    //pub fn deserialize_get_can_create_tags(&self, format: /*Unknown conversion*/Unknown rust type: "Atom") -> bool {
    //    unsafe { TODO: call ffi::gtk_text_buffer_deserialize_get_can_create_tags() }
    //}

    //pub fn deserialize_set_can_create_tags(&self, format: /*Unknown conversion*/Unknown rust type: "Atom", can_create_tags: bool) {
    ...
    //pub fn register_deserialize_format(&self, mime_type: &str, function: /*Unknown conversion*/Unknown rust type: "TextBufferDeserializeFunc", user_data: Fundamental: Pointer, user_data_destroy: /*Unknown conversion*/Unknown rust type: "DestroyNotify") -> /*Unknown conversion*/Unknown rust type: "Atom" {
    //    unsafe { TODO: call ffi::gtk_text_buffer_register_deserialize_format() }
    //}

    //pub fn register_deserialize_tagset(&self, tagset_name: Option<&str>) -> /*Unknown conversion*/Unknown rust type: "Atom" {
    //    unsafe { TODO: call ffi::gtk_text_buffer_register_deserialize_tagset() }
    //}

    //pub fn register_serialize_format(&self, mime_type: &str, function: /*Unknown conversion*/Unknown rust type: "TextBufferSerializeFunc", user_data: Fundamental: Pointer, user_data_destroy: /*Unknown conversion*/Unknown rust type: "DestroyNotify") -> /*Unknown conversion*/Unknown rust type: "Atom" {
    //    unsafe { TODO: call ffi::gtk_text_buffer_register_serialize_format() }
    //}

    //pub fn register_serialize_tagset(&self, tagset_name: Option<&str>) -> /*Unknown conversion*/Unknown rust type: "Atom" {
    ...
    //pub fn serialize(&self, content_buffer: &TextBuffer, format: /*Unknown conversion*/Unknown rust type: "Atom", start: /*Ignored*/&TextIter, end: /*Ignored*/&TextIter, length: Fundamental: Size) -> /*Unknown conversion*/Unknown rust type: "CArray TypeId { ns_id: 0, id: 3 }" {
    ...
    //pub fn unregister_deserialize_format(&self, format: /*Unknown conversion*/Unknown rust type: "Atom") {
    //    unsafe { TODO: call ffi::gtk_text_buffer_unregister_deserialize_format() }
    //}

    //pub fn unregister_serialize_format(&self, format: /*Unknown conversion*/Unknown rust type: "Atom") {

...
pub trait TextBufferExt {
    ...
    fn connect_property_copy_target_list_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_cursor_position_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_has_selection_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_paste_target_list_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_tag_table_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

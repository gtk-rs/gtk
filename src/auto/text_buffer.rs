...
impl TextBuffer {
    ...
    //pub fn create_tag<'a, T: Into<Option<&'a str>>, U: Into<Option<&'a str>>>(&self, tag_name: T, first_property_name: U, : /*Unknown conversion*//*Unimplemented*/Fundamental: VarArgs) -> Option<TextTag> {

...
impl TextBuffer {
    ...
    //pub fn deserialize(&self, content_buffer: &TextBuffer, format: &Atom, iter: &mut TextIter, data: &Unknown rust type: "CArray TypeId { ns_id: 0, id: 3 }", length: Fundamental: Size) -> Result<(), Error> {

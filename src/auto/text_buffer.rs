...
impl TextBuffer {
    pub fn new<'a, P: Into<Option<&'a TextTagTable>>>(table: P) -> TextBuffer {
        ...
        let table = table.to_glib_none().0;
        unsafe {
            from_glib_full(ffi::gtk_text_buffer_new(table))
        }
    }
    ...
    pub fn create_mark<'a, P: Into<Option<&'a str>>>(&self, mark_name: P, where_: &TextIter, left_gravity: bool) -> Option<TextMark> {
        let mark_name = mark_name.into();
        let mark_name = mark_name.to_glib_none().0;
        unsafe {
            from_glib_none(ffi::gtk_text_buffer_create_mark(self.to_glib_none().0, mark_name, where_.to_glib_none().0, left_gravity.to_glib()))
        }
    }

    //pub fn create_tag<'a, 'b, P: Into<Option<&'a str>>, Q: Into<Option<&'b str>>>(&self, tag_name: P, first_property_name: Q, : /*Unknown conversion*//*Unimplemented*/Fundamental: VarArgs) -> Option<TextTag> {
    ...
    pub fn paste_clipboard<'a, P: Into<Option<&'a TextIter>>>(&self, clipboard: &Clipboard, override_location: P, default_editable: bool) {
    ...
    //pub fn register_deserialize_format<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, mime_type: &str, function: /*Unknown conversion*//*Unimplemented*/TextBufferDeserializeFunc, user_data: P, user_data_destroy: /*Unknown conversion*//*Unimplemented*/DestroyNotify) -> Option<gdk::Atom> {
    //    unsafe { TODO: call ffi::gtk_text_buffer_register_deserialize_format() }
    //}

    pub fn register_deserialize_tagset<'a, P: Into<Option<&'a str>>>(&self, tagset_name: P) -> gdk::Atom {
        let tagset_name = tagset_name.into();
        let tagset_name = tagset_name.to_glib_none().0;
        unsafe {
            from_glib_none(ffi::gtk_text_buffer_register_deserialize_tagset(self.to_glib_none().0, tagset_name))
        }
    }

    //pub fn register_serialize_format<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, mime_type: &str, function: /*Unknown conversion*//*Unimplemented*/TextBufferSerializeFunc, user_data: P, user_data_destroy: /*Unknown conversion*//*Unimplemented*/DestroyNotify) -> Option<gdk::Atom> {
    //    unsafe { TODO: call ffi::gtk_text_buffer_register_serialize_format() }
    //}

    pub fn register_serialize_tagset<'a, P: Into<Option<&'a str>>>(&self, tagset_name: P) -> gdk::Atom {
        let tagset_name = tagset_name.into();
        let tagset_name = tagset_name.to_glib_none().0;
        unsafe {
            from_glib_none(ffi::gtk_text_buffer_register_serialize_tagset(self.to_glib_none().0, tagset_name))
        }
    }

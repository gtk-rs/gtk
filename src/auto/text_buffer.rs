...
pub trait TextBufferExt {
    ...
    //fn deserialize(&self, content_buffer: &TextBuffer, format: &gdk::Atom, iter: &mut TextIter, data: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 3 }) -> Result<(), Error>;
    ...
    //fn serialize(&self, content_buffer: &TextBuffer, format: &gdk::Atom, start: &TextIter, end: &TextIter) -> /*Unimplemented*/CArray TypeId { ns_id: 0, id: 3 };

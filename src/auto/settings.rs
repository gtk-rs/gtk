...
pub trait SettingsExt {
    ...
    //fn get_property_color_hash(&self) -> /*Unimplemented*/HashTable TypeId { ns_id: 0, id: 28 }/TypeId { ns_id: 10, id: 10 };
...
impl<O: IsA<Settings> + IsA<glib::object::Object>> SettingsExt for O {
    ...
    //        gobject_ffi::g_object_get_property(self.to_glib_none().0, "color-hash".to_glib_none().0, value.to_glib_none_mut().0);
    //        value.get().unwrap()
    //    }
    //}
    ...
    fn get_property_gtk_im_preedit_style(&self) -> IMPreeditStyle {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <IMPreeditStyle as StaticType>::static_type().to_glib());
    ...
    fn get_property_gtk_im_status_style(&self) -> IMStatusStyle {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <IMStatusStyle as StaticType>::static_type().to_glib());
    ...
    fn get_property_gtk_scrolled_window_placement(&self) -> CornerType {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <CornerType as StaticType>::static_type().to_glib());
    ...
    fn get_property_gtk_toolbar_icon_size(&self) -> IconSize {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <IconSize as StaticType>::static_type().to_glib());
    ...
    fn get_property_gtk_toolbar_style(&self) -> ToolbarStyle {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <ToolbarStyle as StaticType>::static_type().to_glib());
    ...
    fn get_property_gtk_visible_focus(&self) -> PolicyType {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <PolicyType as StaticType>::static_type().to_glib());

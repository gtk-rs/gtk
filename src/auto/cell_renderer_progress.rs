...
pub trait CellRendererProgressExt {
    ...
    fn connect_property_text_xalign_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_text_yalign_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
...
where P: IsA<CellRendererProgress> {
    ...
    f(&CellRendererProgress::from_glib_none(this).downcast_unchecked())
}

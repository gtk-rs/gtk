...
pub trait TreeModelExt {
    ...
    //#[cfg(gtk_3_10)]
    //fn rows_reordered_with_length(&self, path: &mut TreePath, iter: Option<&mut TreeIter>, new_order: /*Unknown conversion*/Unknown rust type: "CArray TypeId { ns_id: 0, id: 14 }", length: i32);

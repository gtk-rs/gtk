...
unsafe extern "C" fn row_changed_trampoline<T>(this: *mut GtkTreeModel, path: *mut GtkTreePath, iter: *mut GtkTreeIter, f: gpointer)
...
unsafe extern "C" fn row_deleted_trampoline<T>(this: *mut GtkTreeModel, path: *mut GtkTreePath, f: gpointer)
where T: IsA<TreeModel> {
    callback_guard!();
...
unsafe extern "C" fn row_has_child_toggled_trampoline<T>(this: *mut GtkTreeModel, path: *mut GtkTreePath, iter: *mut GtkTreeIter, f: gpointer)
where T: IsA<TreeModel> {
    callback_guard!();
    let f: &Box_<Fn(&T, &TreePath, &TreeIter) + 'static> = transmute(f);
    f(&TreeModel::from_glib_none(this).downcast_unchecked(), &from_glib_none(path), &from_glib_none(iter))
...
unsafe extern "C" fn row_inserted_trampoline<T>(this: *mut GtkTreeModel, path: *mut GtkTreePath, iter: *mut GtkTreeIter, f: gpointer)
where T: IsA<TreeModel> {
    callback_guard!();
    let f: &Box_<Fn(&T, &TreePath, &TreeIter) + 'static> = transmute(f);
    f(&TreeModel::from_glib_none(this).downcast_unchecked(), &from_glib_none(path), &from_glib_none(iter))

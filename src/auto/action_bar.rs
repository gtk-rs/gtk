...
impl ActionBar {
    ...
    #[cfg(feature = "v3_12")]
    pub fn set_center_widget<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, center_widget: Q) {
        let center_widget = center_widget.into();
        let center_widget = center_widget.to_glib_none().0;
        unsafe {
            ffi::gtk_action_bar_set_center_widget(self.to_glib_none().0, center_widget);
        }
    }

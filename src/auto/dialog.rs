...
unsafe extern "C" fn close_trampoline<T>(this: *mut GtkDialog, f: gpointer)
where T: IsA<Dialog> {
    callback_guard!();
...
unsafe extern "C" fn response_trampoline<T>(this: *mut GtkDialog, response_id: c_int, f: gpointer)
where T: IsA<Dialog> {
    callback_guard!();

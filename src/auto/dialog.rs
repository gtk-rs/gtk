...
impl Dialog {
    ...
    //pub fn new_with_buttons<'a, T: Into<Option<&'a str>>, U: IsA<Window>, V: Into<Option<&'a str>>>(title: T, parent: Option<&U>, flags: DialogFlags, first_button_text: V, : /*Unknown conversion*//*Unimplemented*/Fundamental: VarArgs) -> Dialog {

...
impl ApplicationWindow {
    ...
    #[cfg(feature = "v3_20")]
    pub fn set_help_overlay<'a, P: Into<Option<&'a ShortcutsWindow>>>(&self, help_overlay: P) {
        let help_overlay = help_overlay.into();
        let help_overlay = help_overlay.to_glib_none().0;
        unsafe {
            ffi::gtk_application_window_set_help_overlay(self.to_glib_none().0, help_overlay);
        }
    }

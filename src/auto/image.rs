...
impl Image {
    ...
    //pub fn new_from_gicon<T: IsA</*Ignored*/glib::Icon>>(icon: &T, size: i32) -> Image {
    ...
    //pub fn get_gicon(&self, gicon: /*Ignored*/glib::Icon) -> i32 {
    ...
    //pub fn set_from_gicon<T: IsA</*Ignored*/glib::Icon>>(&self, icon: &T, size: i32) {

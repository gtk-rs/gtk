...
impl Image {
    ...
    pub fn new_from_pixbuf<'a, P: Into<Option<&'a gdk_pixbuf::Pixbuf>>>(pixbuf: P) -> Image {
        ...
        unsafe {
            Widget::from_glib_none(ffi::gtk_image_new_from_pixbuf(pixbuf)).downcast_unchecked()
        }
    }
    ...
    pub fn set_from_pixbuf<'a, P: Into<Option<&'a gdk_pixbuf::Pixbuf>>>(&self, pixbuf: P) {
        ...
        let pixbuf = pixbuf.to_glib_none().0;
        unsafe {
            ffi::gtk_image_set_from_pixbuf(self.to_glib_none().0, pixbuf);
        }
    }

    pub fn set_from_resource<'a, P: Into<Option<&'a str>>>(&self, resource_path: P) {
        let resource_path = resource_path.into();
        let resource_path = resource_path.to_glib_none().0;
        unsafe {
            ffi::gtk_image_set_from_resource(self.to_glib_none().0, resource_path);
        }
    }

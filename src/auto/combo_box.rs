...
pub trait ComboBoxExt {
    ...
    fn connect_property_active_id_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_add_tearoffs_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_button_sensitivity_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_cell_area_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_column_span_column_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_entry_text_column_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_has_entry_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_has_frame_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_id_column_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_model_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_popup_fixed_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_popup_shown_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_row_span_column_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_tearoff_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_wrap_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}

impl<O: IsA<ComboBox> + IsA<glib::object::Object>> ComboBoxExt for O {
    fn get_active(&self) -> i32 {
        unsafe {

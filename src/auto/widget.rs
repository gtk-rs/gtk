...
pub trait WidgetExt {
    ...
    //fn input_shape_combine_region<'a, P: Into<Option<&'a /*Ignored*/cairo::Region>>>(&self, region: P);
    ...
    //fn shape_combine_region<'a, P: Into<Option<&'a /*Ignored*/cairo::Region>>>(&self, region: P);
...
impl<O: IsA<Widget> + IsA<Object>> WidgetExt for O {
    ...
    fn create_pango_layout<'a, P: Into<Option<&'a str>>>(&self, text: P) -> Option<pango::Layout> {
        let text = text.into();
        let text = text.to_glib_none().0;
        unsafe {
            from_glib_full(ffi::gtk_widget_create_pango_layout(self.to_glib_none().0, text))
        }
    }
    ...
    fn drag_dest_find_target<'a, P: Into<Option<&'a TargetList>>>(&self, context: &gdk::DragContext, target_list: P) -> Option<gdk::Atom> {
        ...
        let target_list = target_list.to_glib_none().0;
        unsafe {
            from_glib_none(ffi::gtk_drag_dest_find_target(self.to_glib_none().0, context.to_glib_none().0, target_list))
        }
    }
    ...
    fn drag_dest_set_target_list<'a, P: Into<Option<&'a TargetList>>>(&self, target_list: P) {
        ...
        let target_list = target_list.to_glib_none().0;
        unsafe {
            ffi::gtk_drag_dest_set_target_list(self.to_glib_none().0, target_list);
        }
    }
    ...
    fn drag_source_set_target_list<'a, P: Into<Option<&'a TargetList>>>(&self, target_list: P) {
        ...
        let target_list = target_list.to_glib_none().0;
        unsafe {
            ffi::gtk_drag_source_set_target_list(self.to_glib_none().0, target_list);
        }
    }
    ...
    fn insert_action_group<'a, P: IsA<gio::ActionGroup> + 'a, Q: Into<Option<&'a P>>>(&self, name: &str, group: Q) {
        ...
        let group = group.to_glib_none().0;
        unsafe {
            ffi::gtk_widget_insert_action_group(self.to_glib_none().0, name.to_glib_none().0, group);
        }
    }
    ...
    fn override_background_color<'a, P: Into<Option<&'a gdk::RGBA>>>(&self, state: StateFlags, color: P) {
        ...
        let color = color.to_glib_none().0;
        unsafe {
    ...
    fn override_color<'a, P: Into<Option<&'a gdk::RGBA>>>(&self, state: StateFlags, color: P) {
        ...
        let color = color.to_glib_none().0;
        unsafe {
            ffi::gtk_widget_override_color(self.to_glib_none().0, state.to_glib(), color);
        }
    }
    ...
    fn override_cursor<'a, 'b, P: Into<Option<&'a gdk::RGBA>>, Q: Into<Option<&'b gdk::RGBA>>>(&self, cursor: P, secondary_cursor: Q) {
        ...
        let secondary_cursor = secondary_cursor.to_glib_none().0;
        unsafe {
            ffi::gtk_widget_override_cursor(self.to_glib_none().0, cursor, secondary_cursor);
        }
    }

    fn override_font<'a, P: Into<Option<&'a pango::FontDescription>>>(&self, font_desc: P) {
        let font_desc = font_desc.into();
        let font_desc = font_desc.to_glib_none().0;
        unsafe {
            ffi::gtk_widget_override_font(self.to_glib_none().0, font_desc);
        }
    }
    ...
    fn override_symbolic_color<'a, P: Into<Option<&'a gdk::RGBA>>>(&self, name: &str, color: P) {
        ...
        let color = color.to_glib_none().0;
        unsafe {
            ffi::gtk_widget_override_symbolic_color(self.to_glib_none().0, name.to_glib_none().0, color);
        }
    }
    ...
    fn set_accel_path<'a, 'b, P: Into<Option<&'a str>>, Q: Into<Option<&'b AccelGroup>>>(&self, accel_path: P, accel_group: Q) {
        ...
        unsafe {
            ffi::gtk_widget_set_accel_path(self.to_glib_none().0, accel_path, accel_group);
        }
    }
    ...
    fn set_font_map<'a, P: Into<Option<&'a pango::FontMap>>>(&self, font_map: P) {
        ...
        let font_map = font_map.to_glib_none().0;
        unsafe {
            ffi::gtk_widget_set_font_map(self.to_glib_none().0, font_map);
        }
    }
    ...
    fn set_tooltip_markup<'a, P: Into<Option<&'a str>>>(&self, markup: P) {
        ...
        unsafe {
            ffi::gtk_widget_set_tooltip_markup(self.to_glib_none().0, markup);
        }
    }
    ...
    fn set_tooltip_text<'a, P: Into<Option<&'a str>>>(&self, text: P) {
        ...
        let text = text.to_glib_none().0;
        unsafe {
            ffi::gtk_widget_set_tooltip_text(self.to_glib_none().0, text);
        }
    }

    fn set_tooltip_window<'a, P: IsA<Window> + 'a, Q: Into<Option<&'a P>>>(&self, custom_window: Q) {
        let custom_window = custom_window.into();
        let custom_window = custom_window.to_glib_none().0;
        unsafe {
            ffi::gtk_widget_set_tooltip_window(self.to_glib_none().0, custom_window);
        }
    }
    ...
    fn set_visual<'a, P: Into<Option<&'a gdk::Visual>>>(&self, visual: P) {
        ...
        let visual = visual.to_glib_none().0;
        unsafe {
            ffi::gtk_widget_set_visual(self.to_glib_none().0, visual);
        }
    }

...
pub trait WidgetExt {
    ...
    //fn add_device_events(&self, device: &gdk::Device, events: /*Ignored*/gdk::EventMask);
    ...
    //fn get_device_events(&self, device: &gdk::Device) -> /*Ignored*/gdk::EventMask;
    ...
    //fn set_device_events(&self, device: &gdk::Device, events: /*Ignored*/gdk::EventMask);

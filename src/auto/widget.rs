...
pub trait WidgetExt {
    ...
    fn connect_property_app_paintable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_can_default_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_can_focus_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_composite_child_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_double_buffered_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_events_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_expand_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_20")]
    fn connect_property_focus_on_click_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_halign_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_has_default_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_has_focus_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_has_tooltip_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_height_request_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_hexpand_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_hexpand_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_is_focus_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_margin_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_margin_bottom_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_12")]
    fn connect_property_margin_end_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_margin_left_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_margin_right_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_12")]
    fn connect_property_margin_start_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_margin_top_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_no_show_all_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_8")]
    fn connect_property_opacity_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_parent_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_receives_default_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_10")]
    fn connect_property_scale_factor_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_valign_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_vexpand_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_vexpand_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_visible_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_width_request_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
...
where P: IsA<Widget> {
    ...
    f(&Widget::from_glib_none(this).downcast_unchecked(), from_glib(group_cycling)).to_glib()
}

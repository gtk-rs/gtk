...
pub trait WidgetExt {
    ...
    fn create_pango_layout<'a, T: Into<Option<&'a str>>>(&self, text: T) -> Option<pango::Layout>;
    ...
    #[cfg(feature = "v3_18")]
    fn set_font_map(&self, font_map: Option<&pango::FontMap>);
...
impl<O: IsA<Widget> + IsA<Object>> WidgetExt for O {
    ...
    fn create_pango_layout<'a, T: Into<Option<&'a str>>>(&self, text: T) -> Option<pango::Layout> {
        unsafe {
            from_glib_full(ffi::gtk_widget_create_pango_layout(self.to_glib_none().0, text.into().to_glib_none().0))
        }
    }
    ...
    fn set_font_map(&self, font_map: Option<&pango::FontMap>) {
        unsafe {
            ffi::gtk_widget_set_font_map(self.to_glib_none().0, font_map.to_glib_none().0);
        }
    }

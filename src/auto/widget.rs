...
pub trait WidgetExt {
    ...
    //fn drag_source_set_icon_gicon<T: IsA</*Ignored*/glib::Icon>>(&self, icon: &T);
    ...
    //#[cfg(feature = "v3_16")]
    //fn get_action_group(&self, prefix: &str) -> /*Ignored*/Option<glib::ActionGroup>;
    ...
    //#[cfg(feature = "v3_6")]
    //fn insert_action_group<T: IsA</*Ignored*/glib::ActionGroup>>(&self, name: &str, group: Option<&T>);
    ...
    //fn style_get_property(&self, property_name: &str, value: /*Ignored*/&mut glib::Value);

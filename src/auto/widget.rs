...
impl Widget {
    //pub fn new(type_: glib::types::Type, first_property_name: &str, : /*Unknown conversion*/Fundamental: VarArgs) -> Widget {
...
pub trait WidgetExt {
    ...
    //fn add_device_events(&self, device: /*Ignored*/&gdk::Device, events: gdk::EventMask);
    ...
    //#[cfg(gtk_3_8)]
    //fn add_tick_callback(&self, callback: /*Unknown conversion*/Unknown rust type: "TickCallback", user_data: Fundamental: Pointer, notify: /*Unknown conversion*/Unknown rust type: "DestroyNotify") -> u32;
    ...
    //fn destroyed<T: IsA</*Ignored*/Widget>>(&self, widget_pointer: &T);

    //fn device_is_shadowed(&self, device: /*Ignored*/&gdk::Device) -> bool;

    //fn drag_begin(&self, targets: /*Ignored*/&TargetList, actions: gdk::DragAction, button: i32, event: /*Unknown conversion*/Unknown rust type: "Event") -> /*Ignored*/Option<gdk::DragContext>;

    //#[cfg(gtk_3_10)]
    //fn drag_begin_with_coordinates(&self, targets: /*Ignored*/&TargetList, actions: gdk::DragAction, button: i32, event: /*Unknown conversion*/Unknown rust type: "Event", x: i32, y: i32) -> /*Ignored*/Option<gdk::DragContext>;
    ...
    //fn drag_dest_find_target(&self, context: /*Ignored*/&gdk::DragContext, target_list: /*Ignored*/Option<&TargetList>) -> Atom;

    //fn drag_dest_get_target_list(&self) -> /*Ignored*/TargetList;

    fn drag_dest_get_track_motion(&self) -> bool;

    //fn drag_dest_set(&self, flags: DestDefaults, targets: &[&TargetEntry], n_targets: i32, actions: gdk::DragAction);
    ...
    //fn drag_get_data(&self, context: /*Ignored*/&gdk::DragContext, target: &Atom, time_: u32);
    ...
    //fn drag_source_set(&self, start_button_mask: gdk::ModifierType, targets: &[&TargetEntry], n_targets: i32, actions: gdk::DragAction);
    ...
    //fn event(&self, event: /*Unknown conversion*/Unknown rust type: "Event") -> bool;
    ...
    //fn get_clipboard(&self, selection: &Atom) -> /*Ignored*/Option<Clipboard>;

    fn get_composite_name(&self) -> Option<String>;

    //fn get_device_enabled(&self, device: /*Ignored*/&gdk::Device) -> bool;

    //fn get_device_events(&self, device: /*Ignored*/&gdk::Device) -> gdk::EventMask;
    ...
    //fn list_accel_closures(&self) -> Vec<gobject::Closure>;
    ...
    //fn send_expose(&self, event: /*Unknown conversion*/Unknown rust type: "Event") -> i32;

    //fn send_focus_change(&self, event: /*Unknown conversion*/Unknown rust type: "Event") -> bool;
    ...
    //fn set_device_events(&self, device: /*Ignored*/&gdk::Device, events: gdk::EventMask);
    ...
    //fn style_get(&self, first_property_name: &str, : /*Unknown conversion*/Fundamental: VarArgs);

    //fn style_get_property(&self, property_name: &str, value: /*Ignored*/&mut gobject::Value);

    //fn style_get_valist(&self, first_property_name: &str, var_args: /*Unknown conversion*/Unsupported);

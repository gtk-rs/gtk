...
pub trait GtkApplicationExt {
    ...
    fn connect_property_active_window_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_app_menu_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_menubar_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_register_session_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}

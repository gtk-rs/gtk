...
impl Application {
    pub fn add_accelerator<'a, P: Into<Option<&'a glib::Variant>>>(&self, accelerator: &str, action_name: &str, parameter: P) {
        let parameter = parameter.into();
        let parameter = parameter.to_glib_none().0;
        unsafe {
            ffi::gtk_application_add_accelerator(self.to_glib_none().0, accelerator.to_glib_none().0, action_name.to_glib_none().0, parameter);
        }
    }

    pub fn add_window<P: IsA<Window>>(&self, window: &P) {
        unsafe {
    ...
    pub fn inhibit<'a, 'b, P: IsA<Window> + 'a, Q: Into<Option<&'a P>>, R: Into<Option<&'b str>>>(&self, window: Q, flags: ApplicationInhibitFlags, reason: R) -> u32 {
        ...
        let reason = reason.to_glib_none().0;
        unsafe {
            ffi::gtk_application_inhibit(self.to_glib_none().0, window, flags.to_glib(), reason)
        }
    }
    ...
    pub fn remove_accelerator<'a, P: Into<Option<&'a glib::Variant>>>(&self, action_name: &str, parameter: P) {
        let parameter = parameter.into();
        let parameter = parameter.to_glib_none().0;
        unsafe {
            ffi::gtk_application_remove_accelerator(self.to_glib_none().0, action_name.to_glib_none().0, parameter);
        }
    }

    pub fn remove_window<P: IsA<Window>>(&self, window: &P) {
        unsafe {
    ...
    pub fn set_app_menu<'a, P: IsA<gio::MenuModel> + 'a, Q: Into<Option<&'a P>>>(&self, app_menu: Q) {
        let app_menu = app_menu.into();
        let app_menu = app_menu.to_glib_none().0;
        unsafe {
            ffi::gtk_application_set_app_menu(self.to_glib_none().0, app_menu);
        }
    }

    pub fn set_menubar<'a, P: IsA<gio::MenuModel> + 'a, Q: Into<Option<&'a P>>>(&self, menubar: Q) {
        let menubar = menubar.into();
        let menubar = menubar.to_glib_none().0;
        unsafe {
            ffi::gtk_application_set_menubar(self.to_glib_none().0, menubar);
        }
    }

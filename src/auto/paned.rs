...
pub trait PanedExt {
    ...
    fn connect_accept_position<F: Fn(&Self) -> bool + 'static>(&self, f: F) -> u64;

    fn connect_cancel_position<F: Fn(&Self) -> bool + 'static>(&self, f: F) -> u64;

    fn connect_cycle_child_focus<F: Fn(&Self, bool) -> bool + 'static>(&self, f: F) -> u64;

    fn connect_cycle_handle_focus<F: Fn(&Self, bool) -> bool + 'static>(&self, f: F) -> u64;

    fn connect_move_handle<F: Fn(&Self, ScrollType) -> bool + 'static>(&self, f: F) -> u64;

    fn connect_toggle_handle_focus<F: Fn(&Self) -> bool + 'static>(&self, f: F) -> u64;

    fn connect_property_max_position_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_min_position_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_position_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_position_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_16")]
    fn connect_property_wide_handle_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}

impl<O: IsA<Paned> + IsA<Container> + IsA<glib::object::Object>> PanedExt for O {
    fn add1<P: IsA<Widget>>(&self, child: &P) {
        unsafe {
...
where P: IsA<Paned> {
    ...
    f(&Paned::from_glib_none(this).downcast_unchecked()).to_glib()
}
...
where P: IsA<Paned> {
    ...
    f(&Paned::from_glib_none(this).downcast_unchecked(), from_glib(reversed)).to_glib()
}
...
where P: IsA<Paned> {
    ...
    f(&Paned::from_glib_none(this).downcast_unchecked(), from_glib(scroll_type)).to_glib()
}
...
where P: IsA<Paned> {
    ...
    f(&Paned::from_glib_none(this).downcast_unchecked())
}

...
unsafe extern "C" fn accept_position_trampoline(this: *mut GtkPaned, f: gpointer) -> gboolean {
    callback_guard!();
    let f: &Box_<Fn(&Paned) -> bool + 'static> = transmute(f);
    f(&from_glib_none(this)).to_glib()
}

unsafe extern "C" fn cancel_position_trampoline(this: *mut GtkPaned, f: gpointer) -> gboolean {
    callback_guard!();
    let f: &Box_<Fn(&Paned) -> bool + 'static> = transmute(f);
    f(&from_glib_none(this)).to_glib()
}

unsafe extern "C" fn cycle_child_focus_trampoline(this: *mut GtkPaned, reversed: gboolean, f: gpointer) -> gboolean {
    callback_guard!();
    let f: &Box_<Fn(&Paned, bool) -> bool + 'static> = transmute(f);
    f(&from_glib_none(this), from_glib(reversed)).to_glib()
}

unsafe extern "C" fn cycle_handle_focus_trampoline(this: *mut GtkPaned, reversed: gboolean, f: gpointer) -> gboolean {
    callback_guard!();
    let f: &Box_<Fn(&Paned, bool) -> bool + 'static> = transmute(f);
    f(&from_glib_none(this), from_glib(reversed)).to_glib()
}

unsafe extern "C" fn move_handle_trampoline(this: *mut GtkPaned, scroll_type: GtkScrollType, f: gpointer) -> gboolean {
    callback_guard!();
    let f: &Box_<Fn(&Paned, ScrollType) -> bool + 'static> = transmute(f);
    f(&from_glib_none(this), from_glib(scroll_type)).to_glib()
}

unsafe extern "C" fn toggle_handle_focus_trampoline(this: *mut GtkPaned, f: gpointer) -> gboolean {
    callback_guard!();
    let f: &Box_<Fn(&Paned) -> bool + 'static> = transmute(f);
    f(&from_glib_none(this)).to_glib()
}

...
impl MessageDialog {
    ...
    //pub fn format_secondary_text<'a, P: Into<Option<&'a str>>>(&self, message_format: P, : /*Unknown conversion*//*Unimplemented*/Fundamental: VarArgs) {
    ...
    pub fn set_image<P: IsA<Widget>>(&self, image: &P) {
        unsafe {

...
pub trait TextViewExt {
    ...
    fn connect_property_accepts_tab_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_18")]
    fn connect_property_bottom_margin_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_buffer_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_cursor_visible_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_monospace_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_overwrite_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_tabs_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_18")]
    fn connect_property_top_margin_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

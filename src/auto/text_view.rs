...
impl TextViewBuilder {
    ...
    pub fn build(self) -> TextView {
        ...
        glib::Object::new(TextView::static_type(), &properties).expect("object new").downcast().expect("downcast")
    }
...
impl<O: IsA<TextView>> TextViewExt for O {
    ...
    fn buffer_to_window_coords(&self, win: TextWindowType, buffer_x: i32, buffer_y: i32) -> (i32, i32) {
        unsafe {
            ...
            gtk_sys::gtk_text_view_buffer_to_window_coords(self.as_ref().to_glib_none().0, win.to_glib(), buffer_x, buffer_y, &mut window_x, &mut window_y);
            (window_x, window_y)
        }
    }
    ...
    fn get_default_attributes(&self) -> TextAttributes {
        unsafe {
            from_glib_full(gtk_sys::gtk_text_view_get_default_attributes(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn get_window(&self, win: TextWindowType) -> Option<gdk::Window> {
        unsafe {
            from_glib_none(gtk_sys::gtk_text_view_get_window(self.as_ref().to_glib_none().0, win.to_glib()))
        }
    }

    fn get_window_type<P: IsA<gdk::Window>>(&self, window: &P) -> TextWindowType {
        unsafe {
            from_glib(gtk_sys::gtk_text_view_get_window_type(self.as_ref().to_glib_none().0, window.as_ref().to_glib_none().0))
        }
    }
    ...
    fn im_context_filter_keypress(&self, event: &gdk::EventKey) -> bool {
        unsafe {
            from_glib(gtk_sys::gtk_text_view_im_context_filter_keypress(self.as_ref().to_glib_none().0, mut_override(event.to_glib_none().0)))
        }
    }
    ...
    fn get_property_monospace(&self) -> bool {
        unsafe {
            ...
            gobject_sys::g_object_get_property(self.to_glib_none().0 as *mut gobject_sys::GObject, b"monospace\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get().unwrap()
        }
    }
    ...
    fn set_property_monospace(&self, monospace: bool) {
        unsafe {
            gobject_sys::g_object_set_property(self.to_glib_none().0 as *mut gobject_sys::GObject, b"monospace\0".as_ptr() as *const _, Value::from(&monospace).to_glib_none().0);
        }
    }

...
impl TextView {
    ...
    pub fn add_child_at_anchor<P: IsA<Widget>>(&self, child: &P, anchor: &TextChildAnchor) {
        unsafe {
            ffi::gtk_text_view_add_child_at_anchor(self.to_glib_none().0, child.to_glib_none().0, anchor.to_glib_none().0);
        }
    }

    pub fn add_child_in_window<P: IsA<Widget>>(&self, child: &P, which_window: TextWindowType, xpos: i32, ypos: i32) {
        unsafe {
    ...
    pub fn get_cursor_locations<'a, P: Into<Option<&'a TextIter>>>(&self, iter: P) -> (gdk::Rectangle, gdk::Rectangle) {
        let iter = iter.into();
        let iter = iter.to_glib_none().0;
        unsafe {
            let mut strong = gdk::Rectangle::uninitialized();
            let mut weak = gdk::Rectangle::uninitialized();
            ffi::gtk_text_view_get_cursor_locations(self.to_glib_none().0, iter, strong.to_glib_none_mut().0, weak.to_glib_none_mut().0);
            (strong, weak)
        }
    }
    ...
    pub fn move_child<P: IsA<Widget>>(&self, child: &P, xpos: i32, ypos: i32) {
        unsafe {
    ...
    pub fn set_buffer<'a, P: Into<Option<&'a TextBuffer>>>(&self, buffer: P) {
        let buffer = buffer.into();
        let buffer = buffer.to_glib_none().0;
        unsafe {
            ffi::gtk_text_view_set_buffer(self.to_glib_none().0, buffer);
        }
    }

...
use ffi::GtkScrollStep;
#[cfg(feature = "v3_16")]
use ffi::GtkTextExtendSelection;
#[cfg(feature = "v3_16")]
use ffi::GtkTextIter;
use ffi::GtkTextView;
use ffi::GtkWidget;
...
impl TextView {
    ...
    #[cfg(feature = "v3_16")]
    pub fn connect_extend_selection<F: Fn(&TextView, TextExtendSelection, &TextIter, &TextIter, &TextIter) -> bool + 'static>(&self, f: F) -> u64 {
        unsafe {
            let f: Box_<Box_<Fn(&TextView, TextExtendSelection, &TextIter, &TextIter, &TextIter) -> bool + 'static>> = Box_::new(Box_::new(f));
...
unsafe extern "C" fn backspace_trampoline(this: *mut GtkTextView, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&TextView) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

unsafe extern "C" fn copy_clipboard_trampoline(this: *mut GtkTextView, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&TextView) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

unsafe extern "C" fn cut_clipboard_trampoline(this: *mut GtkTextView, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&TextView) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

unsafe extern "C" fn delete_from_cursor_trampoline(this: *mut GtkTextView, type_: GtkDeleteType, count: c_int, f: gpointer) {
    callback_guard!();
...
#[cfg(feature = "v3_16")]
unsafe extern "C" fn extend_selection_trampoline(this: *mut GtkTextView, granularity: GtkTextExtendSelection, location: *mut GtkTextIter, start: *mut GtkTextIter, end: *mut GtkTextIter, f: gpointer) -> gboolean {
    callback_guard!();
    let f: &Box_<Fn(&TextView, TextExtendSelection, &TextIter, &TextIter, &TextIter) -> bool + 'static> = transmute(f);
    f(&from_glib_none(this), from_glib(granularity), &from_glib_none(location), &from_glib_none(start), &from_glib_none(end)).to_glib()
}

unsafe extern "C" fn insert_at_cursor_trampoline(this: *mut GtkTextView, string: *mut c_char, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&TextView, &str) + 'static> = transmute(f);
    f(&from_glib_none(this), &String::from_glib_none(string))
}

unsafe extern "C" fn move_cursor_trampoline(this: *mut GtkTextView, step: GtkMovementStep, count: c_int, extend_selection: gboolean, f: gpointer) {
    callback_guard!();
...
unsafe extern "C" fn move_viewport_trampoline(this: *mut GtkTextView, step: GtkScrollStep, count: c_int, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&TextView, ScrollStep, i32) + 'static> = transmute(f);
    f(&from_glib_none(this), from_glib(step), count)
}

unsafe extern "C" fn paste_clipboard_trampoline(this: *mut GtkTextView, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&TextView) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

unsafe extern "C" fn populate_popup_trampoline(this: *mut GtkTextView, popup: *mut GtkWidget, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&TextView, &Widget) + 'static> = transmute(f);
    f(&from_glib_none(this), &from_glib_none(popup))
}

unsafe extern "C" fn preedit_changed_trampoline(this: *mut GtkTextView, preedit: *mut c_char, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&TextView, &str) + 'static> = transmute(f);
    f(&from_glib_none(this), &String::from_glib_none(preedit))
}

unsafe extern "C" fn select_all_trampoline(this: *mut GtkTextView, select: gboolean, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&TextView, bool) + 'static> = transmute(f);
    f(&from_glib_none(this), from_glib(select))
}

unsafe extern "C" fn set_anchor_trampoline(this: *mut GtkTextView, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&TextView) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

unsafe extern "C" fn toggle_cursor_visible_trampoline(this: *mut GtkTextView, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&TextView) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

unsafe extern "C" fn toggle_overwrite_trampoline(this: *mut GtkTextView, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&TextView) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

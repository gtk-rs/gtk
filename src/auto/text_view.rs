...
impl TextView {
    ...
    //#[cfg(feature = "v3_16")]
    //pub fn connect_extend_selection<Unsupported or ignored types>(&self, f: F) -> u64 {
    //    Ignored granularity: Gtk.TextExtendSelection
    //}
    ...
    //pub fn connect_move_viewport<Unsupported or ignored types>(&self, f: F) -> u64 {

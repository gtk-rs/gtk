...
impl RadioButton {
    ...
    pub fn new_from_widget<'a, P: Into<Option<&'a RadioButton>>>(radio_group_member: P) -> RadioButton {
        ...
        let radio_group_member = radio_group_member.to_glib_none().0;
        unsafe {
            Widget::from_glib_none(ffi::gtk_radio_button_new_from_widget(radio_group_member)).downcast_unchecked()
        }
    }
    ...
    pub fn new_with_label_from_widget<'a, P: Into<Option<&'a RadioButton>>>(radio_group_member: P, label: &str) -> RadioButton {
        ...
        let radio_group_member = radio_group_member.to_glib_none().0;
        unsafe {
            Widget::from_glib_none(ffi::gtk_radio_button_new_with_label_from_widget(radio_group_member, label.to_glib_none().0)).downcast_unchecked()
        }
    }
    ...
    pub fn new_with_mnemonic_from_widget<'a, P: Into<Option<&'a RadioButton>>>(radio_group_member: P, label: &str) -> RadioButton {
        ...
        let radio_group_member = radio_group_member.to_glib_none().0;
        unsafe {
            Widget::from_glib_none(ffi::gtk_radio_button_new_with_mnemonic_from_widget(radio_group_member, label.to_glib_none().0)).downcast_unchecked()
        }
    }
    ...
    pub fn join_group<'a, P: Into<Option<&'a RadioButton>>>(&self, group_source: P) {
        ...
        let group_source = group_source.to_glib_none().0;
        unsafe {
            ffi::gtk_radio_button_join_group(self.to_glib_none().0, group_source);
        }
    }

...
impl RadioButton {
    //pub fn new(group: /*Unknown kind*/Unknown rust type: "SList TypeId { ns_id: 1, id: 665 }") -> RadioButton {
    ...
    //pub fn new_with_label(group: /*Unknown kind*/Unknown rust type: "SList TypeId { ns_id: 1, id: 665 }", label: &str) -> RadioButton {
    ...
    //pub fn new_with_mnemonic(group: /*Unknown kind*/Unknown rust type: "SList TypeId { ns_id: 1, id: 665 }", label: &str) -> RadioButton {
    ...
    //pub fn get_group(&self) -> /*Unknown kind*/Unknown rust type: "SList TypeId { ns_id: 1, id: 665 }" {
    ...
    //pub fn set_group(&self, group: /*Unknown kind*/Unknown rust type: "SList TypeId { ns_id: 1, id: 665 }") {

...
pub trait AdjustmentExt {
    ...
    fn connect_property_lower_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_page_increment_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_page_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_step_increment_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_upper_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

...
impl RadioMenuItem {
    ...
    pub fn new_from_widget<'a, P: Into<Option<&'a RadioMenuItem>>>(group: P) -> RadioMenuItem {
        ...
        unsafe {
            Widget::from_glib_none(ffi::gtk_radio_menu_item_new_from_widget(group)).downcast_unchecked()
        }
    }
    ...
    pub fn new_with_label_from_widget<'a, 'b, P: Into<Option<&'a RadioMenuItem>>, Q: Into<Option<&'b str>>>(group: P, label: Q) -> RadioMenuItem {
        ...
        unsafe {
            Widget::from_glib_none(ffi::gtk_radio_menu_item_new_with_label_from_widget(group, label)).downcast_unchecked()
        }
    }
    ...
    pub fn new_with_mnemonic_from_widget<'a, 'b, P: Into<Option<&'a RadioMenuItem>>, Q: Into<Option<&'b str>>>(group: P, label: Q) -> RadioMenuItem {
        ...
        let label = label.to_glib_none().0;
        unsafe {
            Widget::from_glib_none(ffi::gtk_radio_menu_item_new_with_mnemonic_from_widget(group, label)).downcast_unchecked()
        }
    }
    ...
    #[cfg(feature = "v3_18")]
    pub fn join_group<'a, P: Into<Option<&'a RadioMenuItem>>>(&self, group_source: P) {
        let group_source = group_source.into();
        let group_source = group_source.to_glib_none().0;
        unsafe {
            ffi::gtk_radio_menu_item_join_group(self.to_glib_none().0, group_source);
        }
    }

...
impl TreeStore {
    ...
    //pub fn insert_with_valuesv(&self, parent: Option<&mut TreeIter>, position: i32, columns: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 14 }, values: /*Ignored*/&[&gobject::Value], n_values: i32) -> TreeIter {
    ...
    //pub fn set_valuesv(&self, iter: &mut TreeIter, columns: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 14 }, values: /*Ignored*/&[&gobject::Value], n_values: i32) {

...
impl TreeStore {
    ...
    pub fn append<'a, P: Into<Option<&'a TreeIter>>>(&self, parent: P) -> TreeIter {
    ...
    pub fn insert<'a, P: Into<Option<&'a TreeIter>>>(&self, parent: P, position: i32) -> TreeIter {
        let parent = parent.into();
        unsafe {
            let mut iter = TreeIter::uninitialized();
    ...
    pub fn insert_after<'a, 'b, P: Into<Option<&'a TreeIter>>, Q: Into<Option<&'b TreeIter>>>(&self, parent: P, sibling: Q) -> TreeIter {
        let parent = parent.into();
    ...
    pub fn insert_before<'a, 'b, P: Into<Option<&'a TreeIter>>, Q: Into<Option<&'b TreeIter>>>(&self, parent: P, sibling: Q) -> TreeIter {
        let parent = parent.into();
        let sibling = sibling.into();
        unsafe {
            let mut iter = TreeIter::uninitialized();
    ...
    //pub fn insert_with_values<'a, P: Into<Option<&'a TreeIter>>>(&self, parent: P, position: i32, : /*Unknown conversion*//*Unimplemented*/Fundamental: VarArgs) -> TreeIter {
    //    unsafe { TODO: call ffi::gtk_tree_store_insert_with_values() }
    //}

    //pub fn insert_with_valuesv<'a, P: Into<Option<&'a TreeIter>>>(&self, parent: P, position: i32, columns: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 14 }, values: &[&glib::Value], n_values: i32) -> TreeIter {
    ...
    pub fn move_after<'a, P: Into<Option<&'a TreeIter>>>(&self, iter: &TreeIter, position: P) {
    ...
    pub fn move_before<'a, P: Into<Option<&'a TreeIter>>>(&self, iter: &TreeIter, position: P) {
        let position = position.into();
        unsafe {
    ...
    pub fn prepend<'a, P: Into<Option<&'a TreeIter>>>(&self, parent: P) -> TreeIter {
        let parent = parent.into();
        unsafe {
            let mut iter = TreeIter::uninitialized();
    ...
    //pub fn reorder<'a, P: Into<Option<&'a TreeIter>>>(&self, parent: P, new_order: /*Unimplemented*/&CArray TypeId { ns_id: 0, id: 14 }) {

...
impl TreeStore {
    ...
    //pub fn newv(n_columns: i32, types: &Unknown rust type: "CArray TypeId { ns_id: 0, id: 30 }") -> TreeStore {
    ...
    //pub fn insert_with_valuesv(&self, parent: Option<&mut TreeIter>, position: i32, columns: &Unknown rust type: "CArray TypeId { ns_id: 0, id: 14 }", values: &[&gobject::Value], n_values: i32) -> TreeIter {
    ...
    //pub fn reorder(&self, parent: Option<&mut TreeIter>, new_order: &Unknown rust type: "CArray TypeId { ns_id: 0, id: 14 }") {

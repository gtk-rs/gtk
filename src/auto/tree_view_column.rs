...
pub trait TreeViewColumnExt {
    ...
    fn connect_property_clickable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_expand_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_fixed_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_max_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_min_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_sizing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_sort_column_id_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_sort_indicator_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_sort_order_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_x_offset_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}

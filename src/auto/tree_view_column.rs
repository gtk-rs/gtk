...
impl TreeViewColumn {
    ...
    pub fn cell_get_size<'a, P: Into<Option<&'a gdk::Rectangle>>>(&self, cell_area: P) -> (i32, i32, i32, i32) {
        let cell_area = cell_area.into();
        let cell_area = cell_area.to_glib_none().0;
        unsafe {
            let mut x_offset = mem::uninitialized();
            let mut y_offset = mem::uninitialized();
            let mut width = mem::uninitialized();
            let mut height = mem::uninitialized();
            ffi::gtk_tree_view_column_cell_get_size(self.to_glib_none().0, cell_area, &mut x_offset, &mut y_offset, &mut width, &mut height);
    ...
    pub fn cell_set_cell_data<P: IsA<TreeModel>>(&self, tree_model: &P, iter: &TreeIter, is_expander: bool, is_expanded: bool) {
        unsafe {
    ...
    //pub fn set_cell_data_func<'a, P: IsA<CellRenderer>, Q: Into<Option<&'a /*Unimplemented*/TreeCellDataFunc>>, R: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, cell_renderer: &P, func: Q, func_data: R, destroy: /*Unknown conversion*//*Unimplemented*/DestroyNotify) {
    ...
    pub fn set_widget<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, widget: Q) {
        let widget = widget.into();
        let widget = widget.to_glib_none().0;
        unsafe {
            ffi::gtk_tree_view_column_set_widget(self.to_glib_none().0, widget);
        }
    }

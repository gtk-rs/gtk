...
impl TreeViewColumn {
    ...
    pub fn new_with_area<T: Upcast<CellArea>>(area: &T) -> TreeViewColumn {
        unsafe {
            from_glib_none(ffi::gtk_tree_view_column_new_with_area(area.to_glib_none().0))
        }
    }

    //pub fn new_with_attributes<T: Upcast<CellRenderer>>(title: &str, cell: &T, : /*Unknown conversion*/Fundamental: VarArgs) -> TreeViewColumn {
    //    unsafe { TODO: call ffi::gtk_tree_view_column_new_with_attributes() }
    //}

    pub fn add_attribute<T: Upcast<CellRenderer>>(&self, cell_renderer: &T, attribute: &str, column: i32) {
        unsafe {
            ffi::gtk_tree_view_column_add_attribute(self.to_glib_none().0, cell_renderer.to_glib_none().0, attribute.to_glib_none().0, column);
        }
    }

    pub fn cell_get_position<T: Upcast<CellRenderer>>(&self, cell_renderer: &T) -> Option<(i32, i32)> {
        unsafe {
    ...
    pub fn cell_set_cell_data<T: Upcast<TreeModel>>(&self, tree_model: &T, iter: &mut TreeIter, is_expander: bool, is_expanded: bool) {
        unsafe {
    ...
    pub fn clear_attributes<T: Upcast<CellRenderer>>(&self, cell_renderer: &T) {
        unsafe {
    ...
    pub fn focus_cell<T: Upcast<CellRenderer>>(&self, cell: &T) {
        unsafe {
    ...
    //pub fn set_attributes<T: Upcast<CellRenderer>>(&self, cell_renderer: &T, : /*Unknown conversion*/Fundamental: VarArgs) {
    //    unsafe { TODO: call ffi::gtk_tree_view_column_set_attributes() }
    //}

    //pub fn set_cell_data_func<T: Upcast<CellRenderer>>(&self, cell_renderer: &T, func: /*Unknown conversion*/Unknown rust type: "TreeCellDataFunc", func_data: Fundamental: Pointer, destroy: /*Unknown conversion*/Unknown rust type: "DestroyNotify") {

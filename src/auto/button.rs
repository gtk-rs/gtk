...
pub trait ButtonExt {
    ...
    #[cfg(feature = "v3_6")]
    fn connect_property_always_show_image_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_image_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_image_position_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_relief_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_use_stock_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

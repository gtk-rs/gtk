...
impl Button {
    ...
    pub fn new_from_icon_name(icon_name: Option<&str>, size: IconSize) -> Button {
        assert_initialized_main_thread!();
        unsafe {
            Widget::from_glib_none(gtk_sys::gtk_button_new_from_icon_name(icon_name.to_glib_none().0, size.to_glib())).unsafe_cast()
        }
    }
...
impl<O: IsA<Button>> ButtonExt for O {
    ...
    fn get_always_show_image(&self) -> bool {
        unsafe {
            from_glib(gtk_sys::gtk_button_get_always_show_image(self.as_ref().to_glib_none().0))
        }
    }

    fn get_event_window(&self) -> Option<gdk::Window> {
        unsafe {
            from_glib_none(gtk_sys::gtk_button_get_event_window(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn get_focus_on_click(&self) -> bool {
        unsafe {
            from_glib(gtk_sys::gtk_button_get_focus_on_click(self.as_ref().to_glib_none().0))
        }
    }

    fn get_image(&self) -> Option<Widget> {
        unsafe {
            from_glib_none(gtk_sys::gtk_button_get_image(self.as_ref().to_glib_none().0))
        }
    }

    fn get_image_position(&self) -> PositionType {
        unsafe {
            from_glib(gtk_sys::gtk_button_get_image_position(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_always_show_image(&self, always_show: bool) {
        unsafe {
            gtk_sys::gtk_button_set_always_show_image(self.as_ref().to_glib_none().0, always_show.to_glib());
        }
    }
    ...
    fn set_focus_on_click(&self, focus_on_click: bool) {
        unsafe {
            gtk_sys::gtk_button_set_focus_on_click(self.as_ref().to_glib_none().0, focus_on_click.to_glib());
        }
    }

    fn set_image<P: IsA<Widget>>(&self, image: Option<&P>) {
        unsafe {
            gtk_sys::gtk_button_set_image(self.as_ref().to_glib_none().0, image.map(|p| p.as_ref()).to_glib_none().0);
        }
    }

    fn set_image_position(&self, position: PositionType) {
        unsafe {
            gtk_sys::gtk_button_set_image_position(self.as_ref().to_glib_none().0, position.to_glib());
        }
    }
    ...
    fn connect_property_always_show_image_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_always_show_image_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkButton, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
            where P: IsA<Button>
        {
            let f: &F = &*(f as *const F);
            f(&Button::from_glib_borrow(this).unsafe_cast())
    ...
    fn connect_property_image_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_image_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkButton, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
            where P: IsA<Button>
        {
            let f: &F = &*(f as *const F);
            f(&Button::from_glib_borrow(this).unsafe_cast())
    ...
    fn connect_property_image_position_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_image_position_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkButton, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
            where P: IsA<Button>
        {
            let f: &F = &*(f as *const F);
            f(&Button::from_glib_borrow(this).unsafe_cast())

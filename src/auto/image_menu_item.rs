...
impl ImageMenuItem {
    ...
    pub fn new_from_stock<'a, P: Into<Option<&'a AccelGroup>>>(stock_id: &str, accel_group: P) -> ImageMenuItem {
        ...
        unsafe {
            Widget::from_glib_none(ffi::gtk_image_menu_item_new_from_stock(stock_id.to_glib_none().0, accel_group)).downcast_unchecked()
        }
    }
    ...
    pub fn set_image<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, image: Q) {
        let image = image.into();
        let image = image.to_glib_none().0;
        unsafe {
            ffi::gtk_image_menu_item_set_image(self.to_glib_none().0, image);
        }
    }

...
impl StyleContext {
    ...
    pub fn add_provider<P: IsA<StyleProvider>>(&self, provider: &P, priority: u32) {
        unsafe {
    ...
    //pub fn cancel_animations<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, region_id: P) {
    ...
    //pub fn notify_state_change<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, window: &gdk::Window, region_id: P, state: StateType, state_value: bool) {
    ...
    //pub fn push_animatable_region<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, region_id: P) {
    ...
    pub fn remove_provider<P: IsA<StyleProvider>>(&self, provider: &P) {
        unsafe {
    ...
    pub fn set_parent<'a, P: Into<Option<&'a StyleContext>>>(&self, parent: P) {
        let parent = parent.into();
        let parent = parent.to_glib_none().0;
        unsafe {
            ffi::gtk_style_context_set_parent(self.to_glib_none().0, parent);
        }
    }

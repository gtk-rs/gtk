...
impl StyleContext {
    ...
    //pub fn add_provider(&self, provider: Unknown rust type: "StyleProvider", priority: u32) {
    ...
    //pub fn remove_provider(&self, provider: Unknown rust type: "StyleProvider") {
    ...
    //pub fn add_provider_for_screen(screen: &gdk::Screen, provider: Unknown rust type: "StyleProvider", priority: u32) {
    //    unsafe { TODO: call ffi::gtk_style_context_add_provider_for_screen() }
    //}

    //pub fn remove_provider_for_screen(screen: &gdk::Screen, provider: Unknown rust type: "StyleProvider") {

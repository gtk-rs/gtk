...
impl StyleContext {
    ...
    //pub fn add_provider<T: IsA</*Ignored*/StyleProvider>>(&self, provider: &T, priority: u32) {
    ...
    //pub fn get_property(&self, property: &str, state: StateFlags, value: /*Ignored*/glib::Value) {
    ...
    //pub fn get_style_property(&self, property_name: &str, value: /*Ignored*/&mut glib::Value) {
    ...
    //pub fn push_animatable_region(&self, region_id: /*Unimplemented*/Fundamental: Pointer) {
    ...
    //pub fn remove_provider<T: IsA</*Ignored*/StyleProvider>>(&self, provider: &T) {
    ...
    //pub fn add_provider_for_screen<T: IsA</*Ignored*/StyleProvider>>(screen: &gdk::Screen, provider: &T, priority: u32) {
    //    unsafe { TODO: call ffi::gtk_style_context_add_provider_for_screen() }
    //}

    //pub fn remove_provider_for_screen<T: IsA</*Ignored*/StyleProvider>>(screen: &gdk::Screen, provider: &T) {

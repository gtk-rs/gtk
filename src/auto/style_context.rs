...
impl StyleContext {
    ...
    //pub fn get_section(&self, property: &str) -> /*Ignored*/Option<CssSection> {
...
unsafe extern "C" fn changed_trampoline(this: *mut GtkStyleContext, f: gpointer) {
    callback_guard!();

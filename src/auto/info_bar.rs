...
pub type InfoBar = Object<ffi::GtkInfoBar>;

unsafe impl Upcast<Widget> for InfoBar { }
unsafe impl Upcast<Container> for InfoBar { }
unsafe impl Upcast<Box> for InfoBar { }
unsafe impl Upcast<Buildable> for InfoBar { }
unsafe impl Upcast<Orientable> for InfoBar { }
...
impl InfoBar {
    ...
    //pub fn new_with_buttons(first_button_text: Option<&str>, : /*Unknown kind*/Fundamental: VarArgs) -> InfoBar {
    //    unsafe { TODO: call ffi:gtk_info_bar_new_with_buttons() }
    //}

    pub fn add_action_widget<T: Upcast<Widget>>(&self, child: &T, response_id: i32) {
        unsafe {
            ffi::gtk_info_bar_add_action_widget(self.to_glib_none().0, child.upcast().to_glib_none().0, response_id);
        }
    }
    ...
    //pub fn add_buttons(&self, first_button_text: &str, : /*Unknown kind*/Fundamental: VarArgs) {
...
impl types::StaticType for InfoBar {
    #[inline]
    fn static_type() -> types::Type {
        unsafe { from_glib(ffi::gtk_info_bar_get_type()) }
    }
}

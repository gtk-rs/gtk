...
unsafe extern "C" fn close_trampoline(this: *mut GtkInfoBar, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&InfoBar) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

unsafe extern "C" fn response_trampoline(this: *mut GtkInfoBar, response_id: c_int, f: gpointer) {
    callback_guard!();

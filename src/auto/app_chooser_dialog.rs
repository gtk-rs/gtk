...
pub trait AppChooserDialogExt {
    ...
    fn connect_property_gfile_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_heading_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<AppChooserDialog> {
    ...
    f(&AppChooserDialog::from_glib_none(this).downcast_unchecked())
}

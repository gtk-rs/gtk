...
pub trait CellRendererExt {
    ...
    fn connect_property_cell_background_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_cell_background_rgba_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_cell_background_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_editing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_is_expanded_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_is_expander_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_sensitive_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
...
impl<O: IsA<CellRenderer> + IsA<glib::object::Object>> CellRendererExt for O {
    ...
    fn connect_property_cell_background_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64 {
        unsafe {
            let f: Box_<Box_<Fn(&Self) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::cell-background",
    ...
    fn connect_property_cell_background_rgba_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64 {
        unsafe {
            let f: Box_<Box_<Fn(&Self) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::cell-background-rgba",
    ...
    fn connect_property_cell_background_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64 {
        unsafe {
            let f: Box_<Box_<Fn(&Self) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::cell-background-set",
    ...
    fn connect_property_editing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64 {
        unsafe {
            let f: Box_<Box_<Fn(&Self) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::editing",
    ...
    fn connect_property_is_expanded_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64 {
        unsafe {
            let f: Box_<Box_<Fn(&Self) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::is-expanded",
    ...
    fn connect_property_is_expander_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64 {
        unsafe {
            let f: Box_<Box_<Fn(&Self) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::is-expander",

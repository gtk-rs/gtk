...
pub trait CellRendererExt {
    //fn activate<T: IsA<Widget>>(&self, event: /*Unknown conversion*/Unknown rust type: "Event", widget: &T, path: &str, background_area: &Rectangle, cell_area: &Rectangle, flags: CellRendererState) -> bool;
    ...
    //fn start_editing<T: IsA<Widget>>(&self, event: /*Unknown conversion*/Unknown rust type: "Event", widget: &T, path: &str, background_area: &Rectangle, cell_area: &Rectangle, flags: CellRendererState) -> Option<CellEditable>;

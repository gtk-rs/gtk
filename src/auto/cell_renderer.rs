...
pub trait CellRendererExt {
    ...
    fn start_editing<T: IsA<Widget>>(&self, event: &gdk::Event, widget: &T, path: &str, background_area: &gdk::Rectangle, cell_area: &gdk::Rectangle, flags: CellRendererState) -> Option<CellEditable>;

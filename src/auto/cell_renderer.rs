...
pub trait CellRendererExt {
    //fn activate<T: Upcast<Widget>>(&self, event: /*Unknown conversion*/Unknown rust type: "Event", widget: &T, path: &str, background_area: &Rectangle, cell_area: &Rectangle, flags: CellRendererState) -> bool;
    fn get_aligned_area<T: Upcast<Widget>>(&self, widget: &T, flags: CellRendererState, cell_area: &Rectangle) -> Rectangle;
    ...
    //fn render<T: Upcast<Widget>>(&self, cr: /*Ignored*/&mut cairo::Context, widget: &T, background_area: &Rectangle, cell_area: &Rectangle, flags: CellRendererState);
    fn set_alignment(&self, xalign: f32, yalign: f32);
    fn set_fixed_size(&self, width: i32, height: i32);
    fn set_padding(&self, xpad: i32, ypad: i32);
    fn set_sensitive(&self, sensitive: bool);
    fn set_visible(&self, visible: bool);
    //fn start_editing<T: Upcast<Widget>>(&self, event: /*Unknown conversion*/Unknown rust type: "Event", widget: &T, path: &str, background_area: &Rectangle, cell_area: &Rectangle, flags: CellRendererState) -> Option<CellEditable>;

...
impl Window {
    pub fn new(type_: WindowType) -> Window {
        ...
        unsafe {
            Widget::from_glib_none(ffi::gtk_window_new(type_)).downcast_unchecked()
        }
    }
...
pub trait WindowExt {
    ...
    //fn get_application(&self) -> /*Ignored*/Option<Application>;
    ...
    //fn set_application(&self, application: /*Ignored*/Option<&Application>);
...
impl<O: IsA<Window>> WindowExt for O {
    ...
    fn begin_resize_drag(&self, edge: gdk::WindowEdge, button: i32, root_x: i32, root_y: i32, timestamp: u32) {
        unsafe {
            ffi::gtk_window_begin_resize_drag(self.to_glib_none().0, edge, button, root_x, root_y, timestamp);
        }
    }
    ...
    //fn get_application(&self) -> /*Ignored*/Option<Application> {
    //    unsafe { TODO: call ffi::gtk_window_get_application() }
    //}
    ...
    fn get_gravity(&self) -> gdk::Gravity {
        unsafe {
            ffi::gtk_window_get_gravity(self.to_glib_none().0)
        }
    }
    ...
    fn get_mnemonic_modifier(&self) -> gdk::ModifierType {
        unsafe {
            ffi::gtk_window_get_mnemonic_modifier(self.to_glib_none().0)
        }
    }
    ...
    fn get_type_hint(&self) -> gdk::WindowTypeHint {
        unsafe {
            ffi::gtk_window_get_type_hint(self.to_glib_none().0)
        }
    }
    ...
    fn get_window_type(&self) -> WindowType {
        unsafe {
            ffi::gtk_window_get_window_type(self.to_glib_none().0)
        }
    }
    ...
    fn mnemonic_activate(&self, keyval: u32, modifier: gdk::ModifierType) -> bool {
        unsafe {
            from_glib(ffi::gtk_window_mnemonic_activate(self.to_glib_none().0, keyval, modifier))
        }
    }
    ...
    //fn set_application(&self, application: /*Ignored*/Option<&Application>) {
    //    unsafe { TODO: call ffi::gtk_window_set_application() }
    //}
    ...
    fn set_gravity(&self, gravity: gdk::Gravity) {
        unsafe {
            ffi::gtk_window_set_gravity(self.to_glib_none().0, gravity);
        }
    }
    ...
    fn set_mnemonic_modifier(&self, modifier: gdk::ModifierType) {
        unsafe {
            ffi::gtk_window_set_mnemonic_modifier(self.to_glib_none().0, modifier);
        }
    }
    ...
    fn set_position(&self, position: WindowPosition) {
        unsafe {
            ffi::gtk_window_set_position(self.to_glib_none().0, position);
        }
    }

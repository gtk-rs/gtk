...
unsafe extern "C" fn activate_default_trampoline<T>(this: *mut GtkWindow, f: gpointer)
where T: IsA<Window> {
    callback_guard!();
...
unsafe extern "C" fn activate_focus_trampoline<T>(this: *mut GtkWindow, f: gpointer)
where T: IsA<Window> {
    callback_guard!();
    let f: &Box_<Fn(&T) + 'static> = transmute(f);
    f(&Window::from_glib_none(this).downcast_unchecked())
...
unsafe extern "C" fn enable_debugging_trampoline<T>(this: *mut GtkWindow, toggle: gboolean, f: gpointer) -> gboolean
where T: IsA<Window> {
    callback_guard!();
...
unsafe extern "C" fn keys_changed_trampoline<T>(this: *mut GtkWindow, f: gpointer)
where T: IsA<Window> {
    callback_guard!();
    let f: &Box_<Fn(&T) + 'static> = transmute(f);
    f(&Window::from_glib_none(this).downcast_unchecked())
...
unsafe extern "C" fn set_focus_trampoline<T>(this: *mut GtkWindow, object: *mut GtkWidget, f: gpointer)
where T: IsA<Window> {
    callback_guard!();

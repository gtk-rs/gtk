...
impl<O: IsA<Window> + IsA<glib::object::Object> + glib::object::ObjectExt> GtkWindowExt for O {
    ...
    fn get_property_type(&self) -> WindowType {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <WindowType as StaticType>::static_type().to_glib());
    ...
    fn get_property_window_position(&self) -> WindowPosition {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <WindowPosition as StaticType>::static_type().to_glib());

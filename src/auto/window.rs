...
pub trait WindowExt {
    ...
    fn connect_property_accept_focus_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_application_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_attached_to_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_decorated_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_default_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_default_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_deletable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_destroy_with_parent_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_focus_on_map_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_focus_visible_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_gravity_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_has_resize_grip_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_has_toplevel_focus_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_hide_titlebar_when_maximized_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_is_active_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_is_maximized_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_mnemonics_visible_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_modal_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_resizable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_resize_grip_visible_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_skip_pager_hint_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_skip_taskbar_hint_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_startup_id_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_transient_for_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_type_hint_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_urgency_hint_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

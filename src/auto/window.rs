...
impl<O: IsA<Window> + IsA<Object>> WindowExt for O {
    ...
    fn set_application<'a, P: Into<Option<&'a Application>>>(&self, application: P) {
        ...
        let application = application.to_glib_none().0;
        unsafe {
            ffi::gtk_window_set_application(self.to_glib_none().0, application);
        }
    }

    fn set_attached_to<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, attach_widget: Q) {
        let attach_widget = attach_widget.into();
        let attach_widget = attach_widget.to_glib_none().0;
        unsafe {
            ffi::gtk_window_set_attached_to(self.to_glib_none().0, attach_widget);
        }
    }
    ...
    fn set_default<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, default_widget: Q) {
        ...
        let default_widget = default_widget.to_glib_none().0;
        unsafe {
            ffi::gtk_window_set_default(self.to_glib_none().0, default_widget);
        }
    }
    ...
    fn set_focus<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, focus: Q) {
        ...
        let focus = focus.to_glib_none().0;
        unsafe {
            ffi::gtk_window_set_focus(self.to_glib_none().0, focus);
        }
    }
    ...
    fn set_icon<'a, P: Into<Option<&'a gdk_pixbuf::Pixbuf>>>(&self, icon: P) {
        let icon = icon.into();
        let icon = icon.to_glib_none().0;
        unsafe {
            ffi::gtk_window_set_icon(self.to_glib_none().0, icon);
        }
    }
    ...
    fn set_icon_name<'a, P: Into<Option<&'a str>>>(&self, name: P) {
        ...
        unsafe {
            ffi::gtk_window_set_icon_name(self.to_glib_none().0, name);
        }
    }
    ...
    fn set_titlebar<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, titlebar: Q) {
        ...
        let titlebar = titlebar.to_glib_none().0;
        unsafe {
            ffi::gtk_window_set_titlebar(self.to_glib_none().0, titlebar);
        }
    }

    fn set_transient_for<'a, P: IsA<Window> + 'a, Q: Into<Option<&'a P>>>(&self, parent: Q) {
        let parent = parent.into();
        let parent = parent.to_glib_none().0;
        unsafe {
            ffi::gtk_window_set_transient_for(self.to_glib_none().0, parent);
        }
    }

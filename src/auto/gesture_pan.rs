...
use ffi;
#[cfg(feature = "v3_14")]
use ffi::GtkGesturePan;
#[cfg(feature = "v3_14")]
use ffi::GtkPanDirection;
...
#[cfg(feature = "v3_14")]
unsafe extern "C" fn pan_trampoline(this: *mut GtkGesturePan, direction: GtkPanDirection, offset: c_double, f: gpointer) {
    callback_guard!();

...
impl ToolItemGroup {
    ...
    pub fn get_item_position<P: IsA<ToolItem>>(&self, item: &P) -> i32 {
        unsafe {
    ...
    pub fn insert<P: IsA<ToolItem>>(&self, item: &P, position: i32) {
        unsafe {
    ...
    pub fn set_item_position<P: IsA<ToolItem>>(&self, item: &P, position: i32) {
        unsafe {
    ...
    pub fn set_label_widget<P: IsA<Widget>>(&self, label_widget: &P) {
        unsafe {

...
pub trait ScrolledWindowExt {
    ...
    fn connect_property_hadjustment_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_hscrollbar_policy_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_kinetic_scrolling_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_22")]
    fn connect_property_max_content_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_22")]
    fn connect_property_max_content_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_min_content_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_min_content_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_16")]
    fn connect_property_overlay_scrolling_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_22")]
    fn connect_property_propagate_natural_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_22")]
    fn connect_property_propagate_natural_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_shadow_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_vadjustment_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_vscrollbar_policy_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_window_placement_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_window_placement_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<ScrolledWindow> {
    ...
    f(&ScrolledWindow::from_glib_none(this).downcast_unchecked())
}

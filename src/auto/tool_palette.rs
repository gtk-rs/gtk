...
pub type ToolPalette = Object<ffi::GtkToolPalette>;

unsafe impl Upcast<Widget> for ToolPalette { }
unsafe impl Upcast<Container> for ToolPalette { }
unsafe impl Upcast<Buildable> for ToolPalette { }
unsafe impl Upcast<Orientable> for ToolPalette { }
...
impl ToolPalette {
    ...
    //pub fn get_drag_item(&self, selection: /*Unknown kind*/Unknown rust type: "SelectionData") -> Option<Widget> {
    ...
    //pub fn get_drag_target_group() -> /*Unknown kind*/Unknown rust type: "TargetEntry" {
    //    unsafe { TODO: call ffi:gtk_tool_palette_get_drag_target_group() }
    //}

    //pub fn get_drag_target_item() -> /*Unknown kind*/Unknown rust type: "TargetEntry" {
    //    unsafe { TODO: call ffi:gtk_tool_palette_get_drag_target_item() }
    //}

}

impl types::StaticType for ToolPalette {
    #[inline]
    fn static_type() -> types::Type {
        unsafe { from_glib(ffi::gtk_tool_palette_get_type()) }
    }
}

...
pub trait MenuShellExt {
    ...
    fn connect_move_selected<F: Fn(&Self, i32) -> bool + 'static>(&self, f: F) -> u64;
...
unsafe extern "C" fn activate_current_trampoline<T>(this: *mut GtkMenuShell, force_hide: gboolean, f: gpointer)
...
unsafe extern "C" fn cancel_trampoline<T>(this: *mut GtkMenuShell, f: gpointer)
where T: IsA<MenuShell> {
    callback_guard!();
...
unsafe extern "C" fn cycle_focus_trampoline<T>(this: *mut GtkMenuShell, direction: GtkDirectionType, f: gpointer)
where T: IsA<MenuShell> {
    callback_guard!();
...
unsafe extern "C" fn deactivate_trampoline<T>(this: *mut GtkMenuShell, f: gpointer)
where T: IsA<MenuShell> {
    callback_guard!();
    let f: &Box_<Fn(&T) + 'static> = transmute(f);
    f(&MenuShell::from_glib_none(this).downcast_unchecked())
...
unsafe extern "C" fn insert_trampoline<T>(this: *mut GtkMenuShell, child: *mut GtkWidget, position: c_int, f: gpointer)
where T: IsA<MenuShell> {
    callback_guard!();
...
unsafe extern "C" fn move_current_trampoline<T>(this: *mut GtkMenuShell, direction: GtkMenuDirectionType, f: gpointer)
where T: IsA<MenuShell> {
    callback_guard!();
...
unsafe extern "C" fn move_selected_trampoline<T>(this: *mut GtkMenuShell, distance: c_int, f: gpointer) -> gboolean
where T: IsA<MenuShell> {
    callback_guard!();
    let f: &Box_<Fn(&T, i32) -> bool + 'static> = transmute(f);
    f(&MenuShell::from_glib_none(this).downcast_unchecked(), distance).to_glib()
}

unsafe extern "C" fn selection_done_trampoline<T>(this: *mut GtkMenuShell, f: gpointer)
where T: IsA<MenuShell> {
    callback_guard!();
    let f: &Box_<Fn(&T) + 'static> = transmute(f);
    f(&MenuShell::from_glib_none(this).downcast_unchecked())

...
glib_wrapper! {
    pub struct MenuShell(Object<ffi::GtkMenuShell>): Container, Widget, Buildable;
...
pub trait MenuShellExt {
    ...
    //#[cfg(feature = "v3_6")]
    //fn bind_model<T: IsA</*Ignored*/glib::MenuModel>>(&self, model: Option<&T>, action_namespace: Option<&str>, with_separators: bool);

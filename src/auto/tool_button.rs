...
impl ToolButton {
    pub fn new<'a, 'b, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>, R: Into<Option<&'b str>>>(icon_widget: Q, label: R) -> ToolButton {
        ...
        let icon_widget = icon_widget.to_glib_none().0;
        let label = label.into();
        let label = label.to_glib_none().0;
        unsafe {
            ToolItem::from_glib_none(ffi::gtk_tool_button_new(icon_widget, label)).downcast_unchecked()
        }
    }
...
impl<O: IsA<ToolButton> + IsA<Object>> ToolButtonExt for O {
    ...
    fn set_icon_name<'a, P: Into<Option<&'a str>>>(&self, icon_name: P) {
        ...
        unsafe {
            ffi::gtk_tool_button_set_icon_name(self.to_glib_none().0, icon_name);
        }
    }
    ...
    fn set_icon_widget<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, icon_widget: Q) {
        ...
        let icon_widget = icon_widget.to_glib_none().0;
        unsafe {
            ffi::gtk_tool_button_set_icon_widget(self.to_glib_none().0, icon_widget);
        }
    }
    ...
    fn set_label<'a, P: Into<Option<&'a str>>>(&self, label: P) {
        ...
        let label = label.to_glib_none().0;
        unsafe {
            ffi::gtk_tool_button_set_label(self.to_glib_none().0, label);
        }
    }

    fn set_label_widget<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, label_widget: Q) {
        let label_widget = label_widget.into();
        let label_widget = label_widget.to_glib_none().0;
        unsafe {
            ffi::gtk_tool_button_set_label_widget(self.to_glib_none().0, label_widget);
        }
    }
    ...
    fn set_stock_id<'a, P: Into<Option<&'a str>>>(&self, stock_id: P) {
        ...
        unsafe {
            ffi::gtk_tool_button_set_stock_id(self.to_glib_none().0, stock_id);
        }
    }

...
glib_wrapper! {
    pub struct ToolButton(Object<gtk_sys::GtkToolButton, gtk_sys::GtkToolButtonClass, ToolButtonClass>) @extends ToolItem, Bin, Container, Widget, @implements Buildable, Actionable;

    match fn {
        get_type => || gtk_sys::gtk_tool_button_get_type(),
    }
}
...
impl ToolButton {
    pub fn new<P: IsA<Widget>>(icon_widget: Option<&P>, label: Option<&str>) -> ToolButton {
        ...
        unsafe {
            ToolItem::from_glib_none(gtk_sys::gtk_tool_button_new(icon_widget.map(|p| p.as_ref()).to_glib_none().0, label.to_glib_none().0)).unsafe_cast()
        }
    }
}
...
impl ToolButtonBuilder {
    ...
    pub fn build(self) -> ToolButton {
        ...
        glib::Object::new(ToolButton::static_type(), &properties).expect("object new").downcast().expect("downcast")
    }
...
impl<O: IsA<ToolButton>> ToolButtonExt for O {
    fn get_icon_name(&self) -> Option<GString> {
        unsafe {
            from_glib_none(gtk_sys::gtk_tool_button_get_icon_name(self.as_ref().to_glib_none().0))
        }
    }

    fn get_icon_widget(&self) -> Option<Widget> {
        unsafe {
            from_glib_none(gtk_sys::gtk_tool_button_get_icon_widget(self.as_ref().to_glib_none().0))
        }
    }

    fn get_label(&self) -> Option<GString> {
        unsafe {
            from_glib_none(gtk_sys::gtk_tool_button_get_label(self.as_ref().to_glib_none().0))
        }
    }

    fn get_label_widget(&self) -> Option<Widget> {
        unsafe {
            from_glib_none(gtk_sys::gtk_tool_button_get_label_widget(self.as_ref().to_glib_none().0))
        }
    }

    fn get_use_underline(&self) -> bool {
        unsafe {
            from_glib(gtk_sys::gtk_tool_button_get_use_underline(self.as_ref().to_glib_none().0))
        }
    }

    fn set_icon_name(&self, icon_name: Option<&str>) {
        unsafe {
            gtk_sys::gtk_tool_button_set_icon_name(self.as_ref().to_glib_none().0, icon_name.to_glib_none().0);
        }
    }

    fn set_icon_widget<P: IsA<Widget>>(&self, icon_widget: Option<&P>) {
        unsafe {
            gtk_sys::gtk_tool_button_set_icon_widget(self.as_ref().to_glib_none().0, icon_widget.map(|p| p.as_ref()).to_glib_none().0);
        }
    }

    fn set_label(&self, label: Option<&str>) {
        unsafe {
            gtk_sys::gtk_tool_button_set_label(self.as_ref().to_glib_none().0, label.to_glib_none().0);
        }
    }

    fn set_label_widget<P: IsA<Widget>>(&self, label_widget: Option<&P>) {
        unsafe {
            gtk_sys::gtk_tool_button_set_label_widget(self.as_ref().to_glib_none().0, label_widget.map(|p| p.as_ref()).to_glib_none().0);
        }
    }

    fn set_use_underline(&self, use_underline: bool) {
        unsafe {
            gtk_sys::gtk_tool_button_set_use_underline(self.as_ref().to_glib_none().0, use_underline.to_glib());
        }
    }
...
unsafe extern "C" fn clicked_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkToolButton, f: glib_sys::gpointer)
where P: IsA<ToolButton> {
    let f: &F = &*(f as *const F);
    f(&ToolButton::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_icon_name_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkToolButton, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<ToolButton> {
    let f: &F = &*(f as *const F);
    f(&ToolButton::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_icon_widget_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkToolButton, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<ToolButton> {
    let f: &F = &*(f as *const F);
    f(&ToolButton::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_label_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkToolButton, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<ToolButton> {
    let f: &F = &*(f as *const F);
    f(&ToolButton::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_label_widget_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkToolButton, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<ToolButton> {
    let f: &F = &*(f as *const F);
    f(&ToolButton::from_glib_borrow(this).unsafe_cast())
}

unsafe extern "C" fn notify_use_underline_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkToolButton, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<ToolButton> {
    let f: &F = &*(f as *const F);
    f(&ToolButton::from_glib_borrow(this).unsafe_cast())
}

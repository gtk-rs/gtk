...
pub trait AlignmentExt {
    ...
    fn connect_property_bottom_padding_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_left_padding_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_right_padding_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_top_padding_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_xalign_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_xscale_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_yalign_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_yscale_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<Alignment> {
    ...
    f(&Alignment::from_glib_none(this).downcast_unchecked())
}

...
impl ButtonBox {
    ...
    pub fn get_child_non_homogeneous<P: IsA<Widget>>(&self, child: &P) -> bool {
        unsafe {
            from_glib(ffi::gtk_button_box_get_child_non_homogeneous(self.to_glib_none().0, child.to_glib_none().0))
        }
    }

    pub fn get_child_secondary<P: IsA<Widget>>(&self, child: &P) -> bool {
        unsafe {
    ...
    pub fn set_child_non_homogeneous<P: IsA<Widget>>(&self, child: &P, non_homogeneous: bool) {
        unsafe {
            ffi::gtk_button_box_set_child_non_homogeneous(self.to_glib_none().0, child.to_glib_none().0, non_homogeneous.to_glib());
        }
    }

    pub fn set_child_secondary<P: IsA<Widget>>(&self, child: &P, is_secondary: bool) {
        unsafe {

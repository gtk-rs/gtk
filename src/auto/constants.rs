...
lazy_static! {
    pub static ref STYLE_CLASS_GRIP: &'static str = unsafe{CStr::from_ptr(gtk_sys::GTK_STYLE_CLASS_GRIP).to_str().unwrap()};
}
lazy_static! {
...
lazy_static! {
    pub static ref STYLE_REGION_COLUMN: &'static str = unsafe{CStr::from_ptr(gtk_sys::GTK_STYLE_REGION_COLUMN).to_str().unwrap()};
}
#[cfg_attr(feature = "v3_20", deprecated)]
lazy_static! {
    pub static ref STYLE_REGION_COLUMN_HEADER: &'static str = unsafe{CStr::from_ptr(gtk_sys::GTK_STYLE_REGION_COLUMN_HEADER).to_str().unwrap()};
}
#[cfg_attr(feature = "v3_20", deprecated)]
lazy_static! {
    pub static ref STYLE_REGION_ROW: &'static str = unsafe{CStr::from_ptr(gtk_sys::GTK_STYLE_REGION_ROW).to_str().unwrap()};
}
#[cfg_attr(feature = "v3_20", deprecated)]
lazy_static! {
    pub static ref STYLE_REGION_TAB: &'static str = unsafe{CStr::from_ptr(gtk_sys::GTK_STYLE_REGION_TAB).to_str().unwrap()};
}

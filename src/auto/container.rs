...
pub trait ContainerExt {
    ...
    //fn forall(&self, callback: /*Unknown conversion*//*Unimplemented*/Callback, callback_data: /*Unimplemented*/Fundamental: Pointer);

    //fn foreach(&self, callback: /*Unknown conversion*//*Unimplemented*/Callback, callback_data: /*Unimplemented*/Fundamental: Pointer);
...
unsafe extern "C" fn add_trampoline<T>(this: *mut GtkContainer, object: *mut GtkWidget, f: gpointer)
...
unsafe extern "C" fn check_resize_trampoline<T>(this: *mut GtkContainer, f: gpointer)
where T: IsA<Container> {
    callback_guard!();
...
unsafe extern "C" fn remove_trampoline<T>(this: *mut GtkContainer, object: *mut GtkWidget, f: gpointer)
where T: IsA<Container> {
    callback_guard!();
    let f: &Box_<Fn(&T, &Widget) + 'static> = transmute(f);
    f(&Container::from_glib_none(this).downcast_unchecked(), &from_glib_none(object))
...
unsafe extern "C" fn set_focus_child_trampoline<T>(this: *mut GtkContainer, object: *mut GtkWidget, f: gpointer)
where T: IsA<Container> {
    callback_guard!();
    let f: &Box_<Fn(&T, &Widget) + 'static> = transmute(f);
    f(&Container::from_glib_none(this).downcast_unchecked(), &from_glib_none(object))

...
pub trait ContainerExt {
    ...
    fn connect_property_border_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_child_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_resize_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}

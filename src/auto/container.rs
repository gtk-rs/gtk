...
pub trait ContainerExt {
    ...
    //fn child_get_property<T: Upcast<Widget>>(&self, child: &T, property_name: &str, value: /*Ignored*/&mut gobject::Value);
    ...
    //fn propagate_draw<T: Upcast<Widget>>(&self, child: &T, cr: /*Ignored*/&mut cairo::Context);

...
pub type Toolbar = Object<ffi::GtkToolbar>;

unsafe impl Upcast<Widget> for Toolbar { }
unsafe impl Upcast<Container> for Toolbar { }
unsafe impl Upcast<Buildable> for Toolbar { }
unsafe impl Upcast<Orientable> for Toolbar { }
...
impl Toolbar {
    ...
    pub fn get_item_index<T: Upcast<ToolItem>>(&self, item: &T) -> i32 {
        unsafe {
            ffi::gtk_toolbar_get_item_index(self.to_glib_none().0, item.upcast().to_glib_none().0)
        }
    }
    ...
    pub fn insert<T: Upcast<ToolItem>>(&self, item: &T, pos: i32) {
        unsafe {
            ffi::gtk_toolbar_insert(self.to_glib_none().0, item.upcast().to_glib_none().0, pos);
        }
    }

    pub fn set_drop_highlight_item<T: Upcast<ToolItem>>(&self, tool_item: Option<&T>, index_: i32) {
        unsafe {
            ffi::gtk_toolbar_set_drop_highlight_item(self.to_glib_none().0, tool_item.map(Upcast::upcast).to_glib_none().0, index_);
        }
    }
...
impl types::StaticType for Toolbar {
    #[inline]
    fn static_type() -> types::Type {
        unsafe { from_glib(ffi::gtk_toolbar_get_type()) }
    }
}

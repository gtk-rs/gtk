...
impl Toolbar {
    ...
    pub fn get_item_index<P: IsA<ToolItem>>(&self, item: &P) -> i32 {
        unsafe {
    ...
    pub fn insert<P: IsA<ToolItem>>(&self, item: &P, pos: i32) {
        unsafe {
            ffi::gtk_toolbar_insert(self.to_glib_none().0, item.to_glib_none().0, pos);
        }
    }

    pub fn set_drop_highlight_item<'a, P: IsA<ToolItem> + 'a, Q: Into<Option<&'a P>>>(&self, tool_item: Q, index_: i32) {
        let tool_item = tool_item.into();
        let tool_item = tool_item.to_glib_none().0;
        unsafe {
            ffi::gtk_toolbar_set_drop_highlight_item(self.to_glib_none().0, tool_item, index_);
        }
    }

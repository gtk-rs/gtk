...
pub trait FlowBoxExt {
    ...
    fn connect_activate_cursor_child<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_child_activated<F: Fn(&Self, &FlowBoxChild) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_selected_children_changed<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_toggle_cursor_child<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_homogeneous_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_max_children_per_line_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_min_children_per_line_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
...
impl<O: IsA<FlowBox> + IsA<glib::object::Object>> FlowBoxExt for O {
    //#[cfg(feature = "v3_18")]
    //fn bind_model<'a, P: IsA</*Ignored*/gio::ListModel> + 'a, Q: Into<Option<&'a P>>, R: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, model: Q, create_widget_func: /*Unknown conversion*//*Unimplemented*/FlowBoxCreateWidgetFunc, user_data: R, user_data_free_func: /*Unknown conversion*//*Unimplemented*/DestroyNotify) {
...
where P: IsA<FlowBox> {
    ...
    f(&FlowBox::from_glib_none(this).downcast_unchecked())
}
...
where P: IsA<FlowBox> {
    ...
    f(&FlowBox::from_glib_none(this).downcast_unchecked(), &from_glib_none(child))
}
...
where P: IsA<FlowBox> {
    ...
    f(&FlowBox::from_glib_none(this).downcast_unchecked(), from_glib(step), count).to_glib()
}

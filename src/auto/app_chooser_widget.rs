...
pub trait AppChooserWidgetExt {
    ...
    fn connect_property_default_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_all_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_default_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_fallback_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_other_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_recommended_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<AppChooserWidget> {
    ...
    f(&AppChooserWidget::from_glib_none(this).downcast_unchecked())
}

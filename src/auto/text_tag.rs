...
impl<O: IsA<TextTag> + IsA<glib::object::Object>> TextTagExt for O {
    ...
    fn get_property_direction(&self) -> TextDirection {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <TextDirection as StaticType>::static_type().to_glib());
    ...
    fn get_property_justification(&self) -> Justification {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <Justification as StaticType>::static_type().to_glib());
    ...
    fn get_property_wrap_mode(&self) -> WrapMode {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <WrapMode as StaticType>::static_type().to_glib());

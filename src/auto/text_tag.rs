...
impl TextTag {
    pub fn new<'a, P: Into<Option<&'a str>>>(name: P) -> TextTag {
        ...
        unsafe {
            from_glib_full(ffi::gtk_text_tag_new(name))
        }
    }
    ...
    pub fn event<P: IsA<glib::Object>>(&self, event_object: &P, event: &gdk::Event, iter: &TextIter) -> bool {
        unsafe {
    ...
    pub fn get_property_background_rgba(&self) -> Option<gdk::RGBA> {
    ...
    pub fn get_property_foreground_rgba(&self) -> Option<gdk::RGBA> {
        let mut value = Value::from(None::<&gdk::RGBA>);
        unsafe {
    ...
    pub fn get_property_paragraph_background_rgba(&self) -> Option<gdk::RGBA> {
        let mut value = Value::from(None::<&gdk::RGBA>);
        unsafe {
    ...
    #[cfg(feature = "v3_16")]
    pub fn get_property_strikethrough_rgba(&self) -> Option<gdk::RGBA> {
        let mut value = Value::from(None::<&gdk::RGBA>);
        unsafe {
    ...
    //pub fn get_property_tabs(&self) -> /*Ignored*/Option<pango::TabArray> {
    ...
    #[cfg(feature = "v3_16")]
    pub fn get_property_underline_rgba(&self) -> Option<gdk::RGBA> {
        let mut value = Value::from(None::<&gdk::RGBA>);
        unsafe {

...
pub trait TextTagExt {
    ...
    fn connect_property_accumulative_margin_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_background_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_background_full_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_background_full_height_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    #[cfg(feature = "v3_16")]
    fn connect_property_fallback_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_fallback_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    #[cfg(feature = "v3_18")]
    fn connect_property_font_features_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_font_features_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_indent_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_indent_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_invisible_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_invisible_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_justification_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_justification_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_left_margin_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_left_margin_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_16")]
    fn connect_property_letter_spacing_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_letter_spacing_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_paragraph_background_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_paragraph_background_rgba_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_paragraph_background_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_pixels_above_lines_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_pixels_above_lines_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_pixels_below_lines_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_pixels_below_lines_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_pixels_inside_wrap_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_pixels_inside_wrap_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_right_margin_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_right_margin_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    #[cfg(feature = "v3_16")]
    fn connect_property_strikethrough_rgba_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_16")]
    fn connect_property_strikethrough_rgba_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_tabs_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_underline_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_16")]
    fn connect_property_underline_rgba_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_16")]
    fn connect_property_underline_rgba_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_wrap_mode_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<TextTag> {
    ...
    f(&TextTag::from_glib_none(this).downcast_unchecked())
}

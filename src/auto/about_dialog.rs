...
impl AboutDialog {
    ...
    pub fn set_comments<'a, P: Into<Option<&'a str>>>(&self, comments: P) {
        ...
        let comments = comments.to_glib_none().0;
        unsafe {
            ffi::gtk_about_dialog_set_comments(self.to_glib_none().0, comments);
        }
    }

    pub fn set_copyright<'a, P: Into<Option<&'a str>>>(&self, copyright: P) {
        let copyright = copyright.into();
        let copyright = copyright.to_glib_none().0;
        unsafe {
            ffi::gtk_about_dialog_set_copyright(self.to_glib_none().0, copyright);
        }
    }
    ...
    pub fn set_license<'a, P: Into<Option<&'a str>>>(&self, license: P) {
        ...
        let license = license.to_glib_none().0;
        unsafe {
            ffi::gtk_about_dialog_set_license(self.to_glib_none().0, license);
        }
    }
    ...
    pub fn set_logo<'a, P: Into<Option<&'a gdk_pixbuf::Pixbuf>>>(&self, logo: P) {
        let logo = logo.into();
        let logo = logo.to_glib_none().0;
        unsafe {
            ffi::gtk_about_dialog_set_logo(self.to_glib_none().0, logo);
        }
    }
    ...
    pub fn set_logo_icon_name<'a, P: Into<Option<&'a str>>>(&self, icon_name: P) {
        ...
        unsafe {
            ffi::gtk_about_dialog_set_logo_icon_name(self.to_glib_none().0, icon_name);
        }
    }
    ...
    pub fn set_translator_credits<'a, P: Into<Option<&'a str>>>(&self, translator_credits: P) {
        ...
        let translator_credits = translator_credits.to_glib_none().0;
        unsafe {
            ffi::gtk_about_dialog_set_translator_credits(self.to_glib_none().0, translator_credits);
        }
    }

    pub fn set_version<'a, P: Into<Option<&'a str>>>(&self, version: P) {
        let version = version.into();
        let version = version.to_glib_none().0;
        unsafe {
            ffi::gtk_about_dialog_set_version(self.to_glib_none().0, version);
        }
    }

    pub fn set_website<'a, P: Into<Option<&'a str>>>(&self, website: P) {
        let website = website.into();
        let website = website.to_glib_none().0;
        unsafe {
            ffi::gtk_about_dialog_set_website(self.to_glib_none().0, website);
        }
    }

    pub fn set_website_label<'a, P: Into<Option<&'a str>>>(&self, website_label: P) {
        let website_label = website_label.into();
        let website_label = website_label.to_glib_none().0;
        unsafe {
            ffi::gtk_about_dialog_set_website_label(self.to_glib_none().0, website_label);
        }
    }

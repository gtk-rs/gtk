...
pub trait AboutDialogExt {
    ...
    fn connect_property_artists_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_authors_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_comments_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_copyright_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_documenters_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_license_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_license_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_logo_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_logo_icon_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_program_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_translator_credits_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_version_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_website_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_website_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_wrap_license_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<AboutDialog> {
    ...
    f(&AboutDialog::from_glib_none(this).downcast_unchecked(), &String::from_glib_none(uri)).to_glib()
}
...
where P: IsA<AboutDialog> {
    ...
    f(&AboutDialog::from_glib_none(this).downcast_unchecked())
}

...
impl HeaderBar {
    ...
    pub fn set_custom_title<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, title_widget: Q) {
        ...
        let title_widget = title_widget.to_glib_none().0;
        unsafe {
            ffi::gtk_header_bar_set_custom_title(self.to_glib_none().0, title_widget);
        }
    }
    ...
    pub fn set_decoration_layout<'a, P: Into<Option<&'a str>>>(&self, layout: P) {
        ...
        let layout = layout.to_glib_none().0;
        unsafe {
            ffi::gtk_header_bar_set_decoration_layout(self.to_glib_none().0, layout);
        }
    }
    ...
    pub fn set_subtitle<'a, P: Into<Option<&'a str>>>(&self, subtitle: P) {
        ...
        let subtitle = subtitle.to_glib_none().0;
        unsafe {
            ffi::gtk_header_bar_set_subtitle(self.to_glib_none().0, subtitle);
        }
    }
    ...
    pub fn set_title<'a, P: Into<Option<&'a str>>>(&self, title: P) {
        ...
        let title = title.to_glib_none().0;
        unsafe {
            ffi::gtk_header_bar_set_title(self.to_glib_none().0, title);
        }
    }

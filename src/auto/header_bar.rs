...
pub trait HeaderBarExt {
    ...
    fn connect_property_custom_title_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_12")]
    fn connect_property_decoration_layout_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_12")]
    fn connect_property_decoration_layout_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_12")]
    fn connect_property_has_subtitle_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_subtitle_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
...
where P: IsA<HeaderBar> {
    ...
    f(&HeaderBar::from_glib_none(this).downcast_unchecked())
}

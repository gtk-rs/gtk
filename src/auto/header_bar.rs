...
impl<O: IsA<HeaderBar>> HeaderBarExt for O {
    ...
    fn get_show_close_button(&self) -> bool {
        unsafe {
            from_glib(gtk_sys::gtk_header_bar_get_show_close_button(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_show_close_button(&self, setting: bool) {
        unsafe {
            gtk_sys::gtk_header_bar_set_show_close_button(self.as_ref().to_glib_none().0, setting.to_glib());
        }
    }

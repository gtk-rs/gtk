...
unsafe extern "C" fn color_activated_trampoline<T>(this: *mut ffi::GtkColorChooser, color: *mut gdk_ffi::GdkRGBA, f: glib_ffi::gpointer)
where T: IsA<ColorChooser> {
    callback_guard!();
    let f: &Box_<Fn(&T, &gdk::RGBA) + 'static> = transmute(f);

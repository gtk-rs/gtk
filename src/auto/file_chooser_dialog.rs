...
impl FileChooserDialog {
    //pub fn new<'a, T: Into<Option<&'a str>>, U: IsA<Window>, V: Into<Option<&'a str>>>(title: T, parent: Option<&U>, action: FileChooserAction, first_button_text: V, : /*Unknown conversion*//*Unimplemented*/Fundamental: VarArgs) -> FileChooserDialog {

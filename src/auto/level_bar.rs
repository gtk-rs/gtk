...
impl LevelBar {
    ...
    #[cfg(feature = "v3_6")]
    pub fn get_offset_value<'a, P: Into<Option<&'a str>>>(&self, name: P) -> Option<f64> {
        let name = name.into();
        let name = name.to_glib_none().0;
        unsafe {
            let mut value = mem::uninitialized();
            let ret = from_glib(ffi::gtk_level_bar_get_offset_value(self.to_glib_none().0, name, &mut value));
    ...
    #[cfg(feature = "v3_6")]
    pub fn remove_offset_value<'a, P: Into<Option<&'a str>>>(&self, name: P) {
        let name = name.into();
        let name = name.to_glib_none().0;
        unsafe {
            ffi::gtk_level_bar_remove_offset_value(self.to_glib_none().0, name);
        }
    }

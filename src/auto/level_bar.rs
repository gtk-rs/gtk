...
pub trait LevelBarExt {
    ...
    #[cfg(feature = "v3_6")]
    fn connect_property_max_value_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_6")]
    fn connect_property_min_value_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
...
where P: IsA<LevelBar> {
    ...
    f(&LevelBar::from_glib_none(this).downcast_unchecked())
}

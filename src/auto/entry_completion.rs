...
impl EntryCompletion {
    ...
    //pub fn set_match_func<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, func: /*Unknown conversion*//*Unimplemented*/EntryCompletionMatchFunc, func_data: P, func_notify: /*Unknown conversion*//*Unimplemented*/DestroyNotify) {
    ...
    pub fn set_model<'a, P: IsA<TreeModel> + 'a, Q: Into<Option<&'a P>>>(&self, model: Q) {
        ...
        unsafe {
            ffi::gtk_entry_completion_set_model(self.to_glib_none().0, model);
        }
    }

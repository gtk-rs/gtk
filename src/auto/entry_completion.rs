...
pub trait EntryCompletionExt {
    ...
    fn connect_cursor_on_match<F: Fn(&Self, &TreeModel, &TreeIter) -> Inhibit + 'static>(&self, f: F) -> u64;

    fn connect_insert_prefix<F: Fn(&Self, &str) -> Inhibit + 'static>(&self, f: F) -> u64;

    fn connect_match_selected<F: Fn(&Self, &TreeModel, &TreeIter) -> Inhibit + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_inline_completion_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_inline_selection_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_minimum_key_length_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_model_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_popup_completion_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_popup_set_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_popup_single_match_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
...
where P: IsA<EntryCompletion> {
    ...
    f(&EntryCompletion::from_glib_none(this).downcast_unchecked(), index)
}
...
where P: IsA<EntryCompletion> {
    ...
    f(&EntryCompletion::from_glib_none(this).downcast_unchecked(), &from_glib_none(model), &from_glib_none(iter)).to_glib()
}
...
where P: IsA<EntryCompletion> {
    ...
    f(&EntryCompletion::from_glib_none(this).downcast_unchecked(), &String::from_glib_none(prefix)).to_glib()
}
...
where P: IsA<EntryCompletion> {
    ...
    f(&EntryCompletion::from_glib_none(this).downcast_unchecked())
}

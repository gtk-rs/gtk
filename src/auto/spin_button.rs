...
pub trait SpinButtonExt {
    ...
    fn connect_property_climb_rate_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_digits_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_numeric_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_snap_to_ticks_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_update_policy_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
...
where P: IsA<SpinButton> {
    ...
    f(&SpinButton::from_glib_none(this).downcast_unchecked())
}

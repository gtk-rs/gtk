...
use Widget;
use ffi;
use ffi::GtkFileChooser;
use ffi::GtkFileChooserConfirmation;
...
unsafe extern "C" fn confirm_overwrite_trampoline<T>(this: *mut GtkFileChooser, f: gpointer) -> GtkFileChooserConfirmation
...
unsafe extern "C" fn current_folder_changed_trampoline<T>(this: *mut GtkFileChooser, f: gpointer)
where T: IsA<FileChooser> {
    callback_guard!();
...
unsafe extern "C" fn file_activated_trampoline<T>(this: *mut GtkFileChooser, f: gpointer)
where T: IsA<FileChooser> {
    callback_guard!();
    let f: &Box_<Fn(&T) + 'static> = transmute(f);
    f(&FileChooser::from_glib_none(this).downcast_unchecked())
...
unsafe extern "C" fn selection_changed_trampoline<T>(this: *mut GtkFileChooser, f: gpointer)
where T: IsA<FileChooser> {
    callback_guard!();
    let f: &Box_<Fn(&T) + 'static> = transmute(f);
    f(&FileChooser::from_glib_none(this).downcast_unchecked())
...
unsafe extern "C" fn update_preview_trampoline<T>(this: *mut GtkFileChooser, f: gpointer)
where T: IsA<FileChooser> {
    callback_guard!();
    let f: &Box_<Fn(&T) + 'static> = transmute(f);
    f(&FileChooser::from_glib_none(this).downcast_unchecked())

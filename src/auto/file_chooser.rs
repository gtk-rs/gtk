...
pub trait FileChooserExt {
    ...
    fn select_all(&self);
    //fn select_file<T: Upcast</*Ignored*/gio::File>>(&self, file: &T) -> Result<(), Error>;
    ...
    //fn set_current_folder_file<T: Upcast</*Ignored*/gio::File>>(&self, file: &T) -> Result<(), Error>;
    ...
    //fn set_file<T: Upcast</*Ignored*/gio::File>>(&self, file: &T) -> Result<(), Error>;

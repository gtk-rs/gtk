...
glib_wrapper! {
    pub struct FileChooser(Object<ffi::GtkFileChooser>): Widget, Buildable;
...
pub trait FileChooserExt {
    ...
    //fn get_current_folder_file(&self) -> /*Ignored*/Option<glib::File>;
    ...
    //fn select_file<T: IsA</*Ignored*/glib::File>>(&self, file: &T) -> Result<(), Error>;
    ...
    //fn set_current_folder_file<T: IsA</*Ignored*/glib::File>>(&self, file: &T) -> Result<(), Error>;
    ...
    //fn set_file<T: IsA</*Ignored*/glib::File>>(&self, file: &T) -> Result<(), Error>;
    ...
    //fn unselect_file<T: IsA</*Ignored*/glib::File>>(&self, file: &T);

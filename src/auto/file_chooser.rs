...
pub trait FileChooserExt {
    ...
    fn connect_property_create_folders_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_do_overwrite_confirmation_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_extra_widget_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_preview_widget_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_preview_widget_active_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_select_multiple_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_hidden_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_use_preview_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}

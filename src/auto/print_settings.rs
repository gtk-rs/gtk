...
impl PrintSettings {
    ...
    //pub fn new_from_file(file_name: &str, error: Option<glib::Error>) -> PrintSettings {
    //    unsafe { TODO: call ffi::gtk_print_settings_new_from_file() }
    //}

    //pub fn new_from_key_file(key_file: /*Ignored*/&glib::KeyFile, group_name: Option<&str>, error: Option<glib::Error>) -> PrintSettings {
    ...
    //pub fn load_file(&self, file_name: &str, error: Option<glib::Error>) -> bool {
    //    unsafe { TODO: call ffi::gtk_print_settings_load_file() }
    //}

    //pub fn load_key_file(&self, key_file: /*Ignored*/&glib::KeyFile, group_name: Option<&str>, error: Option<glib::Error>) -> bool {
    ...
    //pub fn to_file(&self, file_name: &str, error: Option<glib::Error>) -> bool {

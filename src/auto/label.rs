...
pub trait LabelExt {
    ...
    fn connect_property_angle_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_justify_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_10")]
    fn connect_property_lines_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_max_width_chars_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_mnemonic_keyval_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_mnemonic_widget_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_pattern_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_selectable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_selection_bound_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_single_line_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_track_visited_links_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_use_markup_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_use_underline_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_width_chars_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_wrap_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

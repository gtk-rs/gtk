...
impl Label {
    pub fn new<'a, P: Into<Option<&'a str>>>(str: P) -> Label {
        ...
        let str = str.into();
        let str = str.to_glib_none().0;
        unsafe {
            Widget::from_glib_none(ffi::gtk_label_new(str)).downcast_unchecked()
        }
    }
    ...
    pub fn new_with_mnemonic<'a, P: Into<Option<&'a str>>>(str: P) -> Label {
        ...
        let str = str.to_glib_none().0;
        unsafe {
            Widget::from_glib_none(ffi::gtk_label_new_with_mnemonic(str)).downcast_unchecked()
        }
    }
    ...
    //pub fn set_attributes<'a, P: Into<Option<&'a /*Ignored*/pango::AttrList>>>(&self, attrs: P) {
    ...
    pub fn set_mnemonic_widget<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, widget: Q) {
        let widget = widget.into();
        let widget = widget.to_glib_none().0;
        unsafe {
            ffi::gtk_label_set_mnemonic_widget(self.to_glib_none().0, widget);
        }
    }
    ...
    pub fn get_property_wrap_mode(&self) -> pango::WrapMode {
        let mut value = Value::from(&0);
        unsafe {
    ...
    pub fn set_property_wrap_mode(&self, wrap_mode: pango::WrapMode) {

...
pub trait IMContextExt {
    ...
    //fn get_preedit_string(&self, str: /*Unimplemented*/String, attrs: /*Ignored*/pango::AttrList) -> i32;

    //fn get_surrounding(&self, text: /*Unimplemented*/String) -> Option<i32>;
...
impl<O: IsA<IMContext> + IsA<glib::object::Object>> IMContextExt for O {
    ...
    //fn get_surrounding(&self, text: /*Unimplemented*/String) -> Option<i32> {
    //    unsafe { TODO: call ffi::gtk_im_context_get_surrounding() }
    //}

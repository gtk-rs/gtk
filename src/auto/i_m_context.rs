...
impl<O: IsA<IMContext> + IsA<glib::object::Object>> IMContextExt for O {
    ...
    fn get_property_input_hints(&self) -> InputHints {
        unsafe {
            ...
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <InputHints as StaticType>::static_type().to_glib());
    ...
    fn get_property_input_purpose(&self) -> InputPurpose {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <InputPurpose as StaticType>::static_type().to_glib());

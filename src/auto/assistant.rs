...
impl Assistant {
    ...
    #[cfg(feature = "v3_18")]
    pub fn get_page_has_padding<P: IsA<Widget>>(&self, page: &P) -> bool {
        unsafe {
            from_glib(ffi::gtk_assistant_get_page_has_padding(self.to_glib_none().0, page.to_glib_none().0))
        }
    }

    pub fn get_page_title<P: IsA<Widget>>(&self, page: &P) -> Option<String> {
        unsafe {
    ...
    //pub fn set_forward_page_func<'a, P: Into<Option<&'a /*Unimplemented*/AssistantPageFunc>>, Q: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, page_func: P, data: Q, destroy: /*Unknown conversion*//*Unimplemented*/DestroyNotify) {
    ...
    #[cfg(feature = "v3_18")]
    pub fn set_page_has_padding<P: IsA<Widget>>(&self, page: &P, has_padding: bool) {
        unsafe {

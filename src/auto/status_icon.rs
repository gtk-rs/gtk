...
impl StatusIcon {
    ...
    //pub fn set_from_gicon<P: IsA</*Ignored*/gio::Icon>>(&self, icon: &P) {
    ...
    pub fn set_from_pixbuf<'a, P: Into<Option<&'a gdk_pixbuf::Pixbuf>>>(&self, pixbuf: P) {
        ...
        unsafe {
            ffi::gtk_status_icon_set_from_pixbuf(self.to_glib_none().0, pixbuf);
        }
    }
    ...
    pub fn set_tooltip_markup<'a, P: Into<Option<&'a str>>>(&self, markup: P) {
        let markup = markup.into();
        let markup = markup.to_glib_none().0;
        unsafe {
            ffi::gtk_status_icon_set_tooltip_markup(self.to_glib_none().0, markup);
        }
    }

...
impl StatusIcon {
    ...
    //pub fn new_from_gicon<T: IsA</*Ignored*/glib::Icon>>(icon: &T) -> StatusIcon {
    ...
    //pub fn get_gicon(&self) -> /*Ignored*/Option<glib::Icon> {
    ...
    //pub fn set_from_gicon<T: IsA</*Ignored*/glib::Icon>>(&self, icon: &T) {

...
pub trait CellRendererAccelExt {
    ...
    fn connect_property_accel_key_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_accel_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_accel_mods_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_keycode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}

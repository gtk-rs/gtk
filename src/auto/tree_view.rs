...
impl TreeView {
    ...
    //pub fn insert_column_with_attributes<T: IsA<CellRenderer>>(&self, position: i32, title: &str, cell: &T, : /*Unknown conversion*/Fundamental: VarArgs) -> i32 {
    //    unsafe { TODO: call ffi::gtk_tree_view_insert_column_with_attributes() }
    //}

    //pub fn insert_column_with_data_func<T: IsA<CellRenderer>>(&self, position: i32, title: &str, cell: &T, func: /*Unknown conversion*/Unknown rust type: "TreeCellDataFunc", data: Fundamental: Pointer, dnotify: /*Unknown conversion*/Unknown rust type: "DestroyNotify") -> i32 {
    ...
    //pub fn set_tooltip_cell<T: IsA<CellRenderer>>(&self, tooltip: /*Ignored*/&Tooltip, path: Option<&mut TreePath>, column: Option<&TreeViewColumn>, cell: Option<&T>) {

...
impl TreeView {
    ...
    pub fn get_background_area<'a, 'b, P: Into<Option<&'a TreePath>>, Q: Into<Option<&'b TreeViewColumn>>>(&self, path: P, column: Q) -> gdk::Rectangle {
        ...
        let column = column.to_glib_none().0;
        unsafe {
            let mut rect = gdk::Rectangle::uninitialized();
            ffi::gtk_tree_view_get_background_area(self.to_glib_none().0, mut_override(path.to_glib_none().0), column, rect.to_glib_none_mut().0);
            rect
        }
    }
    ...
    pub fn get_cell_area<'a, 'b, P: Into<Option<&'a TreePath>>, Q: Into<Option<&'b TreeViewColumn>>>(&self, path: P, column: Q) -> gdk::Rectangle {
        ...
        unsafe {
            let mut rect = gdk::Rectangle::uninitialized();
            ffi::gtk_tree_view_get_cell_area(self.to_glib_none().0, mut_override(path.to_glib_none().0), column, rect.to_glib_none_mut().0);
            rect
        }
    }
    ...
    pub fn move_column_after<'a, P: Into<Option<&'a TreeViewColumn>>>(&self, column: &TreeViewColumn, base_column: P) {
        ...
        let base_column = base_column.to_glib_none().0;
        unsafe {
            ffi::gtk_tree_view_move_column_after(self.to_glib_none().0, column.to_glib_none().0, base_column);
        }
    }
    ...
    pub fn scroll_to_cell<'a, 'b, P: Into<Option<&'a TreePath>>, Q: Into<Option<&'b TreeViewColumn>>>(&self, path: P, column: Q, use_align: bool, row_align: f32, col_align: f32) {
        ...
        let column = column.to_glib_none().0;
        unsafe {
            ffi::gtk_tree_view_scroll_to_cell(self.to_glib_none().0, mut_override(path.to_glib_none().0), column, use_align.to_glib(), row_align, col_align);
        }
    }
    ...
    pub fn set_cursor<'a, P: Into<Option<&'a TreeViewColumn>>>(&self, path: &TreePath, focus_column: P, start_editing: bool) {
        ...
        let focus_column = focus_column.to_glib_none().0;
        unsafe {
            ffi::gtk_tree_view_set_cursor(self.to_glib_none().0, mut_override(path.to_glib_none().0), focus_column, start_editing.to_glib());
        }
    }
    ...
    pub fn set_cursor_on_cell<'a, 'b, P: Into<Option<&'a TreeViewColumn>>, Q: IsA<CellRenderer> + 'b, R: Into<Option<&'b Q>>>(&self, path: &TreePath, focus_column: P, focus_cell: R, start_editing: bool) {
        ...
        let focus_cell = focus_cell.to_glib_none().0;
        unsafe {
            ffi::gtk_tree_view_set_cursor_on_cell(self.to_glib_none().0, mut_override(path.to_glib_none().0), focus_column, focus_cell, start_editing.to_glib());
        }
    }
    ...
    pub fn set_model<'a, P: IsA<TreeModel> + 'a, Q: Into<Option<&'a P>>>(&self, model: Q) {
        ...
        unsafe {
            ffi::gtk_tree_view_set_model(self.to_glib_none().0, model);
        }
    }
    ...
    pub fn set_search_entry<'a, P: IsA<Entry> + 'a, Q: Into<Option<&'a P>>>(&self, entry: Q) {
        ...
        let entry = entry.to_glib_none().0;
        unsafe {
            ffi::gtk_tree_view_set_search_entry(self.to_glib_none().0, entry);
        }
    }
    ...
    pub fn set_tooltip_cell<'a, 'b, 'c, P: Into<Option<&'a TreePath>>, Q: Into<Option<&'b TreeViewColumn>>, R: IsA<CellRenderer> + 'c, S: Into<Option<&'c R>>>(&self, tooltip: &Tooltip, path: P, column: Q, cell: S) {
        ...
        let column = column.to_glib_none().0;
        let cell = cell.into();
        let cell = cell.to_glib_none().0;
        unsafe {
            ffi::gtk_tree_view_set_tooltip_cell(self.to_glib_none().0, tooltip.to_glib_none().0, mut_override(path.to_glib_none().0), column, cell);
        }
    }

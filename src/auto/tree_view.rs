...
pub trait TreeViewExt {
    ...
    fn connect_expand_collapse_cursor_row<F: Fn(&Self, bool, bool, bool) -> bool + 'static>(&self, f: F) -> u64;
    ...
    fn connect_test_collapse_row<F: Fn(&Self, &TreeIter, &TreePath) -> Inhibit + 'static>(&self, f: F) -> u64;

    fn connect_test_expand_row<F: Fn(&Self, &TreeIter, &TreePath) -> Inhibit + 'static>(&self, f: F) -> u64;
    ...
    #[cfg(feature = "v3_8")]
    fn connect_property_activate_on_single_click_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_grid_lines_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_search_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_enable_tree_lines_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_expander_column_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_fixed_height_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_headers_clickable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_headers_visible_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_hover_expand_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_hover_selection_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_level_indentation_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_model_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_reorderable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_rubber_banding_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_rules_hint_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_search_column_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_expanders_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_tooltip_column_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_ubuntu_almost_fixed_height_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<TreeView> {
    ...
    f(&TreeView::from_glib_none(this).downcast_unchecked())
}
...
where P: IsA<TreeView> {
    ...
    f(&TreeView::from_glib_none(this).downcast_unchecked(), from_glib(object), from_glib(p0), from_glib(p1)).to_glib()
}
...
where P: IsA<TreeView> {
    ...
    f(&TreeView::from_glib_none(this).downcast_unchecked(), from_glib(step), direction).to_glib()
}
...
where P: IsA<TreeView> {
    ...
    f(&TreeView::from_glib_none(this).downcast_unchecked(), &from_glib_borrow(path), &from_glib_none(column))
}
...
where P: IsA<TreeView> {
    ...
    f(&TreeView::from_glib_none(this).downcast_unchecked(), &from_glib_borrow(iter), &from_glib_borrow(path))
}
...
where P: IsA<TreeView> {
    ...
    f(&TreeView::from_glib_none(this).downcast_unchecked()).to_glib()
}
...
where P: IsA<TreeView> {
    ...
    f(&TreeView::from_glib_none(this).downcast_unchecked(), from_glib(object)).to_glib()
}
...
where P: IsA<TreeView> {
    ...
    f(&TreeView::from_glib_none(this).downcast_unchecked(), &from_glib_borrow(iter), &from_glib_borrow(path)).to_glib()
}

...
where P: IsA<TreeView> {
    callback_guard!();
    let f: &Box_<Fn(&P, bool, bool, bool) -> bool + 'static> = transmute(f);
...
where P: IsA<TreeView> {
    callback_guard!();
    let f: &Box_<Fn(&P, &TreePath, &TreeViewColumn) + 'static> = transmute(f);
...
where P: IsA<TreeView> {
    callback_guard!();
    let f: &Box_<Fn(&P, &TreeIter, &TreePath) + 'static> = transmute(f);
...
where P: IsA<TreeView> {
    callback_guard!();
    let f: &Box_<Fn(&P, &TreeIter, &TreePath) -> Inhibit + 'static> = transmute(f);

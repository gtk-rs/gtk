...
unsafe extern "C" fn create_menu_proxy_trampoline<T>(this: *mut GtkToolItem, f: gpointer) -> gboolean
...
unsafe extern "C" fn toolbar_reconfigured_trampoline<T>(this: *mut GtkToolItem, f: gpointer)
where T: IsA<ToolItem> {
    callback_guard!();

...
pub trait ToolItemExt {
    ...
    fn connect_property_is_important_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_visible_horizontal_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_visible_vertical_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}

...
pub trait ScrollableExt {
    ...
    fn connect_property_hscroll_policy_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_vadjustment_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_vscroll_policy_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<Scrollable> {
    ...
    f(&Scrollable::from_glib_none(this).downcast_unchecked())
}

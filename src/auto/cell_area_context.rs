...
pub trait CellAreaContextExt {
    ...
    fn connect_property_area_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_minimum_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_minimum_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
...
where P: IsA<CellAreaContext> {
    ...
    f(&CellAreaContext::from_glib_none(this).downcast_unchecked())
}

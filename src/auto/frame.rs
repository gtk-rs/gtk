...
impl Frame {
    pub fn new<'a, P: Into<Option<&'a str>>>(label: P) -> Frame {
        ...
        unsafe {
            Widget::from_glib_none(ffi::gtk_frame_new(label)).downcast_unchecked()
        }
    }
}
...
impl<O: IsA<Frame> + IsA<Object>> FrameExt for O {
    ...
    fn set_label<'a, P: Into<Option<&'a str>>>(&self, label: P) {
        ...
        let label = label.to_glib_none().0;
        unsafe {
            ffi::gtk_frame_set_label(self.to_glib_none().0, label);
        }
    }
    ...
    fn set_label_widget<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, label_widget: Q) {
        ...
        unsafe {
            ffi::gtk_frame_set_label_widget(self.to_glib_none().0, label_widget);
        }
    }

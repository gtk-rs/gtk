...
impl FrameBuilder {
    ...
    pub fn build(self) -> Frame {
        ...
        glib::Object::new(Frame::static_type(), &properties).expect("object new").downcast().expect("downcast")
    }
...
impl<O: IsA<Frame>> FrameExt for O {
    ...
    fn get_label_align(&self) -> (f32, f32) {
        unsafe {
            ...
            gtk_sys::gtk_frame_get_label_align(self.as_ref().to_glib_none().0, &mut xalign, &mut yalign);
            (xalign, yalign)
        }
    }
    ...
    fn get_property_label_yalign(&self) -> f32 {
        unsafe {
            let mut value = Value::from_type(<f32 as StaticType>::static_type());
            gobject_sys::g_object_get_property(self.to_glib_none().0 as *mut gobject_sys::GObject, b"label-yalign\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get().unwrap()
        }
    }
    ...
    fn set_property_label_yalign(&self, label_yalign: f32) {
        unsafe {
            gobject_sys::g_object_set_property(self.to_glib_none().0 as *mut gobject_sys::GObject, b"label-yalign\0".as_ptr() as *const _, Value::from(&label_yalign).to_glib_none().0);
        }
    }
    ...
    fn connect_property_label_yalign_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_label_yalign_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkFrame, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
            where P: IsA<Frame>
        {
            let f: &F = &*(f as *const F);
            f(&Frame::from_glib_borrow(this).unsafe_cast())

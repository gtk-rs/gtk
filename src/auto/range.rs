...
pub trait RangeExt {
    ...
    fn connect_property_adjustment_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_fill_level_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_inverted_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_lower_stepper_sensitivity_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_restrict_to_fill_level_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_round_digits_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_fill_level_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_upper_stepper_sensitivity_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}

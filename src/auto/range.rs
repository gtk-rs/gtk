...
impl<O: IsA<Range>> RangeExt for O {
    ...
    fn get_lower_stepper_sensitivity(&self) -> SensitivityType {
        unsafe {
            from_glib(gtk_sys::gtk_range_get_lower_stepper_sensitivity(self.as_ref().to_glib_none().0))
        }
    }

    fn get_min_slider_size(&self) -> i32 {
        unsafe {
            gtk_sys::gtk_range_get_min_slider_size(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn get_upper_stepper_sensitivity(&self) -> SensitivityType {
        unsafe {
            from_glib(gtk_sys::gtk_range_get_upper_stepper_sensitivity(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn set_lower_stepper_sensitivity(&self, sensitivity: SensitivityType) {
        unsafe {
            gtk_sys::gtk_range_set_lower_stepper_sensitivity(self.as_ref().to_glib_none().0, sensitivity.to_glib());
        }
    }
    ...
    fn set_upper_stepper_sensitivity(&self, sensitivity: SensitivityType) {
        unsafe {
            gtk_sys::gtk_range_set_upper_stepper_sensitivity(self.as_ref().to_glib_none().0, sensitivity.to_glib());
        }
    }
    ...
    fn connect_property_lower_stepper_sensitivity_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::lower-stepper-sensitivity\0".as_ptr() as *const _,
                Some(transmute(notify_lower_stepper_sensitivity_trampoline::<Self, F> as usize)), Box_::into_raw(f))
        }
    }
    ...
    fn connect_property_upper_stepper_sensitivity_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::upper-stepper-sensitivity\0".as_ptr() as *const _,
                Some(transmute(notify_upper_stepper_sensitivity_trampoline::<Self, F> as usize)), Box_::into_raw(f))
        }
    }
}
...
unsafe extern "C" fn notify_lower_stepper_sensitivity_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkRange, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<Range> {
    let f: &F = &*(f as *const F);
    f(&Range::from_glib_borrow(this).unsafe_cast())
}
...
unsafe extern "C" fn notify_upper_stepper_sensitivity_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkRange, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
where P: IsA<Range> {
    let f: &F = &*(f as *const F);
    f(&Range::from_glib_borrow(this).unsafe_cast())
}

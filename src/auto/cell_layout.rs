...
pub trait CellLayoutExt {
    ...
    //fn set_attributes<T: IsA<CellRenderer>>(&self, cell: &T, : /*Unknown conversion*/Fundamental: VarArgs);

    //fn set_cell_data_func<T: IsA<CellRenderer>>(&self, cell: &T, func: /*Unknown conversion*/Unknown rust type: "CellLayoutDataFunc", func_data: Fundamental: Pointer, destroy: /*Unknown conversion*/Unknown rust type: "DestroyNotify");
}

...
pub fn bindings_activate_event<P: IsA<glib::Object>>(object: &P, event: &mut gdk::EventKey) -> bool {
    assert_initialized_main_thread!();
    unsafe {
        from_glib(gtk_sys::gtk_bindings_activate_event(object.as_ref().to_glib_none().0, event.to_glib_none_mut().0))
    }
}
...
pub fn cairo_should_draw_window<P: IsA<gdk::Window>>(cr: &cairo::Context, window: &P) -> bool {
    assert_initialized_main_thread!();
    unsafe {
        from_glib(gtk_sys::gtk_cairo_should_draw_window(mut_override(cr.to_glib_none().0), window.as_ref().to_glib_none().0))
    }
}
...
pub fn cairo_transform_to_window<P: IsA<Widget>, Q: IsA<gdk::Window>>(cr: &cairo::Context, widget: &P, window: &Q) {
    ...
    unsafe {
        gtk_sys::gtk_cairo_transform_to_window(mut_override(cr.to_glib_none().0), widget.as_ref().to_glib_none().0, window.as_ref().to_glib_none().0);
    }
}
...
pub fn get_event_widget(event: &mut gdk::Event) -> Option<Widget> {
    assert_initialized_main_thread!();
    unsafe {
        from_glib_none(gtk_sys::gtk_get_event_widget(event.to_glib_none_mut().0))
    }
}
...
pub fn render_extension<P: IsA<StyleContext>>(context: &P, cr: &cairo::Context, x: f64, y: f64, width: f64, height: f64, gap_side: PositionType) {
    skip_assert_initialized!();
    unsafe {
        gtk_sys::gtk_render_extension(context.as_ref().to_glib_none().0, mut_override(cr.to_glib_none().0), x, y, width, height, gap_side.to_glib());
    }
}
...
pub fn render_frame_gap<P: IsA<StyleContext>>(context: &P, cr: &cairo::Context, x: f64, y: f64, width: f64, height: f64, gap_side: PositionType, xy0_gap: f64, xy1_gap: f64) {
    skip_assert_initialized!();
    unsafe {
        gtk_sys::gtk_render_frame_gap(context.as_ref().to_glib_none().0, mut_override(cr.to_glib_none().0), x, y, width, height, gap_side.to_glib(), xy0_gap, xy1_gap);
    }
}
...
pub fn render_icon<P: IsA<StyleContext>>(context: &P, cr: &cairo::Context, pixbuf: &gdk_pixbuf::Pixbuf, x: f64, y: f64) {
    skip_assert_initialized!();
    unsafe {
        gtk_sys::gtk_render_icon(context.as_ref().to_glib_none().0, mut_override(cr.to_glib_none().0), pixbuf.to_glib_none().0, x, y);
    }
}
...
pub fn render_icon_surface<P: IsA<StyleContext>>(context: &P, cr: &cairo::Context, surface: &cairo::Surface, x: f64, y: f64) {
    skip_assert_initialized!();
    unsafe {
        gtk_sys::gtk_render_icon_surface(context.as_ref().to_glib_none().0, mut_override(cr.to_glib_none().0), mut_override(surface.to_glib_none().0), x, y);
    }
}
...
pub fn selection_add_target<P: IsA<Widget>>(widget: &P, selection: &gdk::Atom, target: &gdk::Atom, info: u32) {
    skip_assert_initialized!();
    unsafe {
        gtk_sys::gtk_selection_add_target(widget.as_ref().to_glib_none().0, selection.to_glib_none().0, target.to_glib_none().0, info);
    }
}
...
pub fn selection_clear_targets<P: IsA<Widget>>(widget: &P, selection: &gdk::Atom) {
    skip_assert_initialized!();
    unsafe {
        gtk_sys::gtk_selection_clear_targets(widget.as_ref().to_glib_none().0, selection.to_glib_none().0);
    }
}
...
pub fn selection_convert<P: IsA<Widget>>(widget: &P, selection: &gdk::Atom, target: &gdk::Atom, time_: u32) -> bool {
    skip_assert_initialized!();
    unsafe {
        from_glib(gtk_sys::gtk_selection_convert(widget.as_ref().to_glib_none().0, selection.to_glib_none().0, target.to_glib_none().0, time_))
    }
}
...
pub fn selection_owner_set<P: IsA<Widget>>(widget: Option<&P>, selection: &gdk::Atom, time_: u32) -> bool {
    assert_initialized_main_thread!();
    unsafe {
        from_glib(gtk_sys::gtk_selection_owner_set(widget.map(|p| p.as_ref()).to_glib_none().0, selection.to_glib_none().0, time_))
    }
}
...
pub fn selection_owner_set_for_display<P: IsA<Widget>>(display: &gdk::Display, widget: Option<&P>, selection: &gdk::Atom, time_: u32) -> bool {
    assert_initialized_main_thread!();
    unsafe {
        from_glib(gtk_sys::gtk_selection_owner_set_for_display(display.to_glib_none().0, widget.map(|p| p.as_ref()).to_glib_none().0, selection.to_glib_none().0, time_))
    }
}
...
pub fn show_uri(screen: Option<&gdk::Screen>, uri: &str, timestamp: u32) -> Result<(), Error> {
    ...
    unsafe {
        ...
        let _ = gtk_sys::gtk_show_uri(screen.to_glib_none().0, uri.to_glib_none().0, timestamp, &mut error);
...
pub fn targets_include_rich_text<P: IsA<TextBuffer>>(targets: &[&gdk::Atom], buffer: &P) -> bool {
    ...
    let n_targets = targets.len() as i32;
    unsafe {
        from_glib(gtk_sys::gtk_targets_include_rich_text(targets.to_glib_none().0, n_targets, buffer.as_ref().to_glib_none().0))
    }
}
...
pub fn test_create_simple_window(window_title: &str, dialog_text: &str) -> Option<Widget> {
    assert_initialized_main_thread!();
    unsafe {
        from_glib_none(gtk_sys::gtk_test_create_simple_window(window_title.to_glib_none().0, dialog_text.to_glib_none().0))
    }
}
...
pub fn test_find_label<P: IsA<Widget>>(widget: &P, label_pattern: &str) -> Option<Widget> {
    skip_assert_initialized!();
    unsafe {
        from_glib_none(gtk_sys::gtk_test_find_label(widget.as_ref().to_glib_none().0, label_pattern.to_glib_none().0))
    }
}
...
pub fn test_find_sibling<P: IsA<Widget>>(base_widget: &P, widget_type: glib::types::Type) -> Option<Widget> {
    skip_assert_initialized!();
    unsafe {
        from_glib_none(gtk_sys::gtk_test_find_sibling(base_widget.as_ref().to_glib_none().0, widget_type.to_glib()))
    }
}
...
pub fn test_find_widget<P: IsA<Widget>>(widget: &P, label_pattern: &str, widget_type: glib::types::Type) -> Option<Widget> {
    skip_assert_initialized!();
    unsafe {
        from_glib_none(gtk_sys::gtk_test_find_widget(widget.as_ref().to_glib_none().0, label_pattern.to_glib_none().0, widget_type.to_glib()))
    }
}
...
pub fn test_slider_get_value<P: IsA<Widget>>(widget: &P) -> f64 {
    skip_assert_initialized!();
    unsafe {
        gtk_sys::gtk_test_slider_get_value(widget.as_ref().to_glib_none().0)
    }
}
...
pub fn test_spin_button_click<P: IsA<SpinButton>>(spinner: &P, button: u32, upwards: bool) -> bool {
    skip_assert_initialized!();
    unsafe {
        from_glib(gtk_sys::gtk_test_spin_button_click(spinner.as_ref().to_glib_none().0, button, upwards.to_glib()))
    }
}
...
pub fn test_text_get<P: IsA<Widget>>(widget: &P) -> Option<GString> {
    skip_assert_initialized!();
    unsafe {
        from_glib_full(gtk_sys::gtk_test_text_get(widget.as_ref().to_glib_none().0))
    }
}
...
pub fn test_widget_click<P: IsA<Widget>>(widget: &P, button: u32, modifiers: gdk::ModifierType) -> bool {
    skip_assert_initialized!();
    unsafe {
        from_glib(gtk_sys::gtk_test_widget_click(widget.as_ref().to_glib_none().0, button, modifiers.to_glib()))
    }
}
...
pub fn test_widget_send_key<P: IsA<Widget>>(widget: &P, keyval: u32, modifiers: gdk::ModifierType) -> bool {
    skip_assert_initialized!();
    unsafe {
        from_glib(gtk_sys::gtk_test_widget_send_key(widget.as_ref().to_glib_none().0, keyval, modifiers.to_glib()))
    }
}

...
//pub fn init_with_args<'a, 'b, P: Into<Option<&'a str>>, Q: Into<Option<&'b str>>>(argc: &mut i32, argv: /*Unimplemented*/Vec<String>, parameter_string: P, entries: /*Ignored*/&[&glib::OptionEntry], translation_domain: Q) -> Result<(), Error> {
...
//pub fn parse_args(argc: &mut i32, argv: /*Unimplemented*/Vec<String>) -> bool {
...
//pub fn stock_add(items: /*Ignored*/&[&StockItem], n_items: u32) {
//    unsafe { TODO: call ffi::gtk_stock_add() }
//}

//pub fn stock_add_static(items: /*Ignored*/&[&StockItem], n_items: u32) {
...
pub fn targets_include_image(targets: &[&gdk::Atom], n_targets: i32, writable: bool) -> bool {
    assert_initialized_main_thread!();
    unsafe {
...
pub fn targets_include_rich_text(targets: &[&gdk::Atom], n_targets: i32, buffer: &TextBuffer) -> bool {
    skip_assert_initialized!();
    unsafe {
...
pub fn targets_include_text(targets: &[&gdk::Atom], n_targets: i32) -> bool {
    assert_initialized_main_thread!();
    unsafe {
...
pub fn targets_include_uri(targets: &[&gdk::Atom], n_targets: i32) -> bool {
    assert_initialized_main_thread!();
    unsafe {
...
//pub fn test_init(argcp: &mut i32, argvp: /*Unimplemented*/Vec<String>, : /*Unknown conversion*//*Unimplemented*/Fundamental: VarArgs) {
//    unsafe { TODO: call ffi::gtk_test_init() }
//}

//pub fn test_list_all_types() -> (/*Unimplemented*/CArray TypeId { ns_id: 0, id: 30 }, u32) {

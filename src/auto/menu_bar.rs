...
pub trait MenuBarExt {
    ...
    fn connect_property_child_pack_direction_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_pack_direction_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<MenuBar> {
    ...
    f(&MenuBar::from_glib_none(this).downcast_unchecked())
}

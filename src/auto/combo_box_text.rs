...
impl ComboBoxText {
    ...
    pub fn append<'a, P: Into<Option<&'a str>>>(&self, id: P, text: &str) {
        let id = id.into();
        let id = id.to_glib_none().0;
        unsafe {
            ffi::gtk_combo_box_text_append(self.to_glib_none().0, id, text.to_glib_none().0);
        }
    }
    ...
    pub fn insert<'a, P: Into<Option<&'a str>>>(&self, position: i32, id: P, text: &str) {
        let id = id.into();
        let id = id.to_glib_none().0;
        unsafe {
            ffi::gtk_combo_box_text_insert(self.to_glib_none().0, position, id, text.to_glib_none().0);
        }
    }
    ...
    pub fn prepend<'a, P: Into<Option<&'a str>>>(&self, id: P, text: &str) {
        let id = id.into();
        let id = id.to_glib_none().0;
        unsafe {
            ffi::gtk_combo_box_text_prepend(self.to_glib_none().0, id, text.to_glib_none().0);
        }
    }

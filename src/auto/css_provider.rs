...
impl CssProvider {
    ...
    //pub fn load_from_data(&self, data: &Unknown rust type: "CArray TypeId { ns_id: 0, id: 3 }", length: Fundamental: SSize, error: Option<glib::Error>) -> bool {
    //    unsafe { TODO: call ffi::gtk_css_provider_load_from_data() }
    //}

    //pub fn load_from_file<T: Upcast</*Ignored*/gio::File>>(&self, file: &T, error: Option<glib::Error>) -> bool {
    //    unsafe { TODO: call ffi::gtk_css_provider_load_from_file() }
    //}

    //pub fn load_from_path(&self, path: &str, error: Option<glib::Error>) -> bool {

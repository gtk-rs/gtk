...
impl<O: IsA<Entry> + IsA<glib::object::Object> + glib::object::ObjectExt> EntryExt for O {
    ...
    fn get_property_primary_icon_gicon(&self) -> Option<gio::Icon> {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <gio::Icon as StaticType>::static_type().to_glib());
    ...
    fn get_property_primary_icon_pixbuf(&self) -> Option<gdk_pixbuf::Pixbuf> {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <gdk_pixbuf::Pixbuf as StaticType>::static_type().to_glib());
    ...
    fn get_property_primary_icon_storage_type(&self) -> ImageType {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <ImageType as StaticType>::static_type().to_glib());
    ...
    fn get_property_shadow_type(&self) -> ShadowType {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <ShadowType as StaticType>::static_type().to_glib());

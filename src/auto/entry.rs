...
pub trait EntryExt {
    ...
    fn connect_property_activates_default_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
    ...
    fn connect_property_caps_lock_warning_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_completion_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_cursor_position_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_editable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_has_frame_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_im_module_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_6")]
    fn connect_property_input_hints_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_6")]
    fn connect_property_input_purpose_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_invisible_char_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_invisible_char_set_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_max_length_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_12")]
    fn connect_property_max_width_chars_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_overwrite_mode_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_placeholder_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_8")]
    fn connect_property_populate_all_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_primary_icon_activatable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_primary_icon_gicon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_primary_icon_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_primary_icon_pixbuf_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_primary_icon_sensitive_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_primary_icon_stock_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_primary_icon_storage_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_primary_icon_tooltip_markup_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_primary_icon_tooltip_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_progress_fraction_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_progress_pulse_step_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_scroll_offset_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_secondary_icon_activatable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_secondary_icon_gicon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_secondary_icon_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_secondary_icon_pixbuf_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_secondary_icon_sensitive_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_secondary_icon_stock_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_secondary_icon_storage_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_secondary_icon_tooltip_markup_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_secondary_icon_tooltip_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_selection_bound_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_shadow_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_emoji_icon_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_text_length_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_truncate_multiline_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_visibility_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_width_chars_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
...
where P: IsA<Entry> {
    ...
    f(&Entry::from_glib_none(this).downcast_unchecked(), &from_glib_none(widget))
}

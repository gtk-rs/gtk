...
pub trait EntryExt {
    ...
    //fn get_icon_gicon(&self, icon_pos: EntryIconPosition) -> /*Ignored*/Option<glib::Icon>;
    ...
    //fn set_icon_from_gicon<T: IsA</*Ignored*/glib::Icon>>(&self, icon_pos: EntryIconPosition, icon: Option<&T>);

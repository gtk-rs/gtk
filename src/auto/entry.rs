...
glib_wrapper! {
    pub struct Entry(Object<ffi::GtkEntry>): Widget, Buildable, Editable;
...
pub trait EntryExt {
    ...
    //fn get_icon_area(&self, icon_pos: EntryIconPosition, icon_area: Rectangle);
    ...
    //fn get_text_area(&self, text_area: Rectangle);

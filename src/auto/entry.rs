...
pub trait EntryExt {
    ...
    //fn set_icon_from_gicon<'a, P: IsA</*Ignored*/gio::Icon> + 'a, Q: Into<Option<&'a P>>>(&self, icon_pos: EntryIconPosition, icon: Q);
...
impl<O: IsA<Entry> + IsA<Object>> EntryExt for O {
    ...
    fn set_completion<'a, P: Into<Option<&'a EntryCompletion>>>(&self, completion: P) {
        ...
        let completion = completion.to_glib_none().0;
        unsafe {
            ffi::gtk_entry_set_completion(self.to_glib_none().0, completion);
        }
    }
    ...
    fn set_cursor_hadjustment<'a, P: Into<Option<&'a Adjustment>>>(&self, adjustment: P) {
        ...
        unsafe {
            ffi::gtk_entry_set_cursor_hadjustment(self.to_glib_none().0, adjustment);
        }
    }
    ...
    fn set_icon_from_icon_name<'a, P: Into<Option<&'a str>>>(&self, icon_pos: EntryIconPosition, icon_name: P) {
        ...
        unsafe {
            ffi::gtk_entry_set_icon_from_icon_name(self.to_glib_none().0, icon_pos.to_glib(), icon_name);
        }
    }

    fn set_icon_from_pixbuf<'a, P: Into<Option<&'a gdk_pixbuf::Pixbuf>>>(&self, icon_pos: EntryIconPosition, pixbuf: P) {
        let pixbuf = pixbuf.into();
        let pixbuf = pixbuf.to_glib_none().0;
        unsafe {
            ffi::gtk_entry_set_icon_from_pixbuf(self.to_glib_none().0, icon_pos.to_glib(), pixbuf);
        }
    }

    fn set_icon_from_stock<'a, P: Into<Option<&'a str>>>(&self, icon_pos: EntryIconPosition, stock_id: P) {
        let stock_id = stock_id.into();
        let stock_id = stock_id.to_glib_none().0;
        unsafe {
            ffi::gtk_entry_set_icon_from_stock(self.to_glib_none().0, icon_pos.to_glib(), stock_id);
        }
    }
    ...
    fn set_icon_tooltip_markup<'a, P: Into<Option<&'a str>>>(&self, icon_pos: EntryIconPosition, tooltip: P) {
        ...
        let tooltip = tooltip.to_glib_none().0;
        unsafe {
            ffi::gtk_entry_set_icon_tooltip_markup(self.to_glib_none().0, icon_pos.to_glib(), tooltip);
        }
    }
    ...
    fn set_icon_tooltip_text<'a, P: Into<Option<&'a str>>>(&self, icon_pos: EntryIconPosition, tooltip: P) {
        ...
        let tooltip = tooltip.to_glib_none().0;
        unsafe {
            ffi::gtk_entry_set_icon_tooltip_text(self.to_glib_none().0, icon_pos.to_glib(), tooltip);
        }
    }
    ...
    fn set_placeholder_text<'a, P: Into<Option<&'a str>>>(&self, text: P) {
        ...
        unsafe {
            ffi::gtk_entry_set_placeholder_text(self.to_glib_none().0, text);
        }
    }

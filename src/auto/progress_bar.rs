...
pub trait ProgressBarExt {
    ...
    fn connect_property_fraction_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_inverted_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_pulse_step_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
...
where P: IsA<ProgressBar> {
    ...
    f(&ProgressBar::from_glib_none(this).downcast_unchecked())
}

...
glib_wrapper! {
    pub struct CellRendererSpin(Object<gtk_sys::GtkCellRendererSpin, gtk_sys::GtkCellRendererSpinClass, CellRendererSpinClass>) @extends CellRendererText, CellRenderer;
...
impl CellRendererSpin {
    pub fn new() -> CellRendererSpin {
        ...
        unsafe {
            CellRenderer::from_glib_none(gtk_sys::gtk_cell_renderer_spin_new()).unsafe_cast()
        }
    }
}
...
impl CellRendererSpinBuilder {
    ...
    pub fn build(self) -> CellRendererSpin {
        ...
        glib::Object::new(CellRendererSpin::static_type(), &properties).expect("object new").downcast().expect("downcast")
    }
...
impl<O: IsA<CellRendererSpin>> CellRendererSpinExt for O {
    fn get_property_adjustment(&self) -> Option<Adjustment> {
        unsafe {
            ...
            gobject_sys::g_object_get_property(self.to_glib_none().0 as *mut gobject_sys::GObject, b"adjustment\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get()
        }
    }
    ...
    fn set_property_adjustment(&self, adjustment: Option<&Adjustment>) {
        unsafe {
            gobject_sys::g_object_set_property(self.to_glib_none().0 as *mut gobject_sys::GObject, b"adjustment\0".as_ptr() as *const _, Value::from(adjustment).to_glib_none().0);
        }
    }
    ...
    fn get_property_digits(&self) -> u32 {
        unsafe {
            ...
            gobject_sys::g_object_get_property(self.to_glib_none().0 as *mut gobject_sys::GObject, b"digits\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get().unwrap()
        }
    }
    ...
    fn set_property_digits(&self, digits: u32) {
        unsafe {
            gobject_sys::g_object_set_property(self.to_glib_none().0 as *mut gobject_sys::GObject, b"digits\0".as_ptr() as *const _, Value::from(&digits).to_glib_none().0);
        }
    }

    fn connect_property_adjustment_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_adjustment_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkCellRendererSpin, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
    ...
    fn connect_property_climb_rate_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_climb_rate_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkCellRendererSpin, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
            where P: IsA<CellRendererSpin>
        {
            let f: &F = &*(f as *const F);
            f(&CellRendererSpin::from_glib_borrow(this).unsafe_cast())
    ...
    fn connect_property_digits_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_digits_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_sys::GtkCellRendererSpin, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
            where P: IsA<CellRendererSpin>
        {
            let f: &F = &*(f as *const F);
            f(&CellRendererSpin::from_glib_borrow(this).unsafe_cast())

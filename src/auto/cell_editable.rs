...
unsafe extern "C" fn editing_done_trampoline<T>(this: *mut GtkCellEditable, f: gpointer)
...
unsafe extern "C" fn remove_widget_trampoline<T>(this: *mut GtkCellEditable, f: gpointer)
where T: IsA<CellEditable> {
    callback_guard!();
    let f: &Box_<Fn(&T) + 'static> = transmute(f);
    f(&CellEditable::from_glib_none(this).downcast_unchecked())

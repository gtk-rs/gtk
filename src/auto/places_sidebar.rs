...
impl PlacesSidebar {
    ...
    //#[cfg(feature = "v3_10")]
    //pub fn add_shortcut<P: IsA</*Ignored*/gio::File>>(&self, location: &P) {
    ...
    //#[cfg(feature = "v3_10")]
    //pub fn remove_shortcut<P: IsA</*Ignored*/gio::File>>(&self, location: &P) {
    ...
    //#[cfg(feature = "v3_10")]
    //pub fn set_location<'a, P: IsA</*Ignored*/gio::File> + 'a, Q: Into<Option<&'a P>>>(&self, location: Q) {
    ...
    //pub fn set_property_location<P: IsA</*Ignored*/gio::File> + IsA<Object>>(&self, location: Option<&P>) {
    //    unsafe {

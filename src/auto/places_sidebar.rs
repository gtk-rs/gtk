    ...
    pub fn connect_drag_action_ask<F: Fn(&PlacesSidebar, i32) -> i32 + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&drag_action_ask_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_mount<F: Fn(&PlacesSidebar, &gio::MountOperation) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&mount_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_open_location<F: Fn(&PlacesSidebar, &gio::File, PlacesOpenFlags) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&open_location_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_show_connect_to_server<F: Fn(&PlacesSidebar) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&show_connect_to_server_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_show_enter_location<F: Fn(&PlacesSidebar) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&show_enter_location_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_show_error_message<F: Fn(&PlacesSidebar, &str, &str) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&show_error_message_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_show_other_locations<F: Fn(&PlacesSidebar) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                b"show-other-locations\0".as_ptr() as *const _,
                Some(*(&show_other_locations_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    >(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&show_other_locations_with_flags_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_show_starred_location<F: Fn(&PlacesSidebar, PlacesOpenFlags) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&show_starred_location_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_unmount<F: Fn(&PlacesSidebar, &gio::MountOperation) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&unmount_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_property_local_only_notify<F: Fn(&PlacesSidebar) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&notify_local_only_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_property_location_notify<F: Fn(&PlacesSidebar) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&notify_location_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_property_open_flags_notify<F: Fn(&PlacesSidebar) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&notify_open_flags_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_property_populate_all_notify<F: Fn(&PlacesSidebar) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&notify_populate_all_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_property_show_connect_to_server_notify<F: Fn(&PlacesSidebar) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&notify_show_connect_to_server_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_property_show_desktop_notify<F: Fn(&PlacesSidebar) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&notify_show_desktop_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_property_show_enter_location_notify<F: Fn(&PlacesSidebar) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&notify_show_enter_location_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_property_show_other_locations_notify<F: Fn(&PlacesSidebar) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&notify_show_other_locations_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_property_show_recent_notify<F: Fn(&PlacesSidebar) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&notify_show_recent_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_property_show_starred_location_notify<F: Fn(&PlacesSidebar) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&notify_show_starred_location_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }
    ...
    pub fn connect_property_show_trash_notify<F: Fn(&PlacesSidebar) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(*(&notify_show_trash_trampoline::<F> as *const _ as *const _)),
                Box_::into_raw(f),
            )
        }
    }

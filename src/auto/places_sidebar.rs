...
pub trait PlacesSidebarExt {
    ...
    fn connect_property_open_flags_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_18")]
    fn connect_property_populate_all_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_connect_to_server_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_desktop_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_enter_location_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_other_locations_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_recent_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_trash_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}

...
glib_wrapper! {
    pub struct CellAreaBox(Object<ffi::GtkCellAreaBox>): CellArea, Buildable, CellLayout, Orientable;
...
impl CellAreaBox {
    ...
    pub fn pack_end<T: Upcast<CellRenderer>>(&self, renderer: &T, expand: bool, align: bool, fixed: bool) {
        unsafe {
            ffi::gtk_cell_area_box_pack_end(self.to_glib_none().0, renderer.to_glib_none().0, expand.to_glib(), align.to_glib(), fixed.to_glib());
        }
    }

    pub fn pack_start<T: Upcast<CellRenderer>>(&self, renderer: &T, expand: bool, align: bool, fixed: bool) {
        unsafe {

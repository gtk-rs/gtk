...
pub trait ExpanderExt {
    ...
    fn connect_property_expanded_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_label_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_label_fill_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_label_widget_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_resize_toplevel_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

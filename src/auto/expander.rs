...
impl Expander {
    pub fn new<'a, P: Into<Option<&'a str>>>(label: P) -> Expander {
        ...
        unsafe {
            Widget::from_glib_none(ffi::gtk_expander_new(label)).downcast_unchecked()
        }
    }
    ...
    pub fn set_label<'a, P: Into<Option<&'a str>>>(&self, label: P) {
        ...
        let label = label.to_glib_none().0;
        unsafe {
            ffi::gtk_expander_set_label(self.to_glib_none().0, label);
        }
    }
    ...
    pub fn set_label_widget<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, label_widget: Q) {
        let label_widget = label_widget.into();
        let label_widget = label_widget.to_glib_none().0;
        unsafe {
            ffi::gtk_expander_set_label_widget(self.to_glib_none().0, label_widget);
        }
    }

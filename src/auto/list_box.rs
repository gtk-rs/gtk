...
unsafe extern "C" fn activate_cursor_row_trampoline(this: *mut GtkListBox, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&ListBox) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

unsafe extern "C" fn move_cursor_trampoline(this: *mut GtkListBox, object: GtkMovementStep, p0: c_int, f: gpointer) {
    callback_guard!();
...
#[cfg(feature = "v3_10")]
unsafe extern "C" fn row_activated_trampoline(this: *mut GtkListBox, row: *mut GtkListBoxRow, f: gpointer) {
    callback_guard!();
...
#[cfg(feature = "v3_14")]
unsafe extern "C" fn select_all_trampoline(this: *mut GtkListBox, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&ListBox) + 'static> = transmute(f);
    f(&from_glib_none(this))
}
...
#[cfg(feature = "v3_14")]
unsafe extern "C" fn selected_rows_changed_trampoline(this: *mut GtkListBox, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&ListBox) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

unsafe extern "C" fn toggle_cursor_row_trampoline(this: *mut GtkListBox, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&ListBox) + 'static> = transmute(f);
    f(&from_glib_none(this))
}
...
#[cfg(feature = "v3_14")]
unsafe extern "C" fn unselect_all_trampoline(this: *mut GtkListBox, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&ListBox) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

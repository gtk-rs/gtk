...
impl ListBox {
    ...
    //#[cfg(feature = "v3_16")]
    //pub fn bind_model<'a, 'b, P: IsA</*Ignored*/gio::ListModel> + 'a, Q: Into<Option<&'a P>>, R: Into<Option<&'b /*Unimplemented*/ListBoxCreateWidgetFunc>>, S: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, model: Q, create_widget_func: R, user_data: S, user_data_free_func: /*Unknown conversion*//*Unimplemented*/DestroyNotify) {
    ...
    #[cfg(feature = "v3_10")]
    pub fn select_row<'a, P: Into<Option<&'a ListBoxRow>>>(&self, row: P) {
        let row = row.into();
        let row = row.to_glib_none().0;
        unsafe {
            ffi::gtk_list_box_select_row(self.to_glib_none().0, row);
        }
    }

    //#[cfg(feature = "v3_14")]
    //pub fn selected_foreach<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, func: /*Unknown conversion*//*Unimplemented*/ListBoxForeachFunc, data: P) {
    ...
    #[cfg(feature = "v3_10")]
    pub fn set_adjustment<'a, P: Into<Option<&'a Adjustment>>>(&self, adjustment: P) {
        let adjustment = adjustment.into();
        let adjustment = adjustment.to_glib_none().0;
        unsafe {
            ffi::gtk_list_box_set_adjustment(self.to_glib_none().0, adjustment);
        }
    }

    //#[cfg(feature = "v3_10")]
    //pub fn set_filter_func<'a, P: Into<Option<&'a /*Unimplemented*/ListBoxFilterFunc>>, Q: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, filter_func: P, user_data: Q, destroy: /*Unknown conversion*//*Unimplemented*/DestroyNotify) {
    //    unsafe { TODO: call ffi::gtk_list_box_set_filter_func() }
    //}

    //#[cfg(feature = "v3_10")]
    //pub fn set_header_func<'a, P: Into<Option<&'a /*Unimplemented*/ListBoxUpdateHeaderFunc>>, Q: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, update_header: P, user_data: Q, destroy: /*Unknown conversion*//*Unimplemented*/DestroyNotify) {
    //    unsafe { TODO: call ffi::gtk_list_box_set_header_func() }
    //}

    #[cfg(feature = "v3_10")]
    pub fn set_placeholder<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, placeholder: Q) {
        let placeholder = placeholder.into();
        let placeholder = placeholder.to_glib_none().0;
        unsafe {
            ffi::gtk_list_box_set_placeholder(self.to_glib_none().0, placeholder);
        }
    }
    ...
    //#[cfg(feature = "v3_10")]
    //pub fn set_sort_func<'a, P: Into<Option<&'a /*Unimplemented*/ListBoxSortFunc>>, Q: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, sort_func: P, user_data: Q, destroy: /*Unknown conversion*//*Unimplemented*/DestroyNotify) {

...
impl ListBox {
    ...
    //#[cfg(gtk_3_16)]
    //pub fn bind_model<T: IsA</*Ignored*/gio::ListModel>>(&self, model: Option<&T>, create_widget_func: /*Unknown conversion*/Unknown rust type: "ListBoxCreateWidgetFunc", user_data: Fundamental: Pointer, user_data_free_func: /*Unknown conversion*/Unknown rust type: "DestroyNotify") {

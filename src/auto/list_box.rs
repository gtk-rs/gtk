...
pub type ListBox = Object<ffi::GtkListBox>;

unsafe impl Upcast<Widget> for ListBox { }
unsafe impl Upcast<Container> for ListBox { }
unsafe impl Upcast<Buildable> for ListBox { }
...
impl ListBox {
    ...
    //#[cfg(gtk_3_16)]
    //pub fn bind_model(&self, model: Unknown rust type: "ListModel", create_widget_func: /*Unknown kind*/Unknown rust type: "ListBoxCreateWidgetFunc", user_data: Fundamental: Pointer, user_data_free_func: /*Unknown kind*/Unknown rust type: "DestroyNotify") {
    ...
    pub fn insert<T: Upcast<Widget>>(&self, child: &T, position: i32) {
        unsafe {
            ffi::gtk_list_box_insert(self.to_glib_none().0, child.upcast().to_glib_none().0, position);
        }
    }
    ...
    pub fn prepend<T: Upcast<Widget>>(&self, child: &T) {
        unsafe {
            ffi::gtk_list_box_prepend(self.to_glib_none().0, child.upcast().to_glib_none().0);
        }
    }
    ...
    //#[cfg(gtk_3_14)]
    //pub fn selected_foreach(&self, func: /*Unknown kind*/Unknown rust type: "ListBoxForeachFunc", data: Fundamental: Pointer) {
    ...
    //#[cfg(gtk_3_10)]
    //pub fn set_filter_func(&self, filter_func: /*Unknown kind*/Unknown rust type: "ListBoxFilterFunc", user_data: Fundamental: Pointer, destroy: /*Unknown kind*/Unknown rust type: "DestroyNotify") {
    //    unsafe { TODO: call ffi:gtk_list_box_set_filter_func() }
    //}

    //#[cfg(gtk_3_10)]
    //pub fn set_header_func(&self, update_header: /*Unknown kind*/Unknown rust type: "ListBoxUpdateHeaderFunc", user_data: Fundamental: Pointer, destroy: /*Unknown kind*/Unknown rust type: "DestroyNotify") {
    ...
    pub fn set_placeholder<T: Upcast<Widget>>(&self, placeholder: Option<&T>) {
        unsafe {
            ffi::gtk_list_box_set_placeholder(self.to_glib_none().0, placeholder.map(Upcast::upcast).to_glib_none().0);
        }
    }
    ...
    //#[cfg(gtk_3_10)]
    //pub fn set_sort_func(&self, sort_func: /*Unknown kind*/Unknown rust type: "ListBoxSortFunc", user_data: Fundamental: Pointer, destroy: /*Unknown kind*/Unknown rust type: "DestroyNotify") {
...
impl types::StaticType for ListBox {
    #[inline]
    fn static_type() -> types::Type {
        unsafe { from_glib(ffi::gtk_list_box_get_type()) }
    }
}

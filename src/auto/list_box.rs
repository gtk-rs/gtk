...
impl ListBox {
    ...
    //#[cfg(feature = "3.16")]
    //pub fn bind_model<T: IsA</*Ignored*/glib::ListModel>>(&self, model: Option<&T>, create_widget_func: /*Unknown conversion*//*Unimplemented*/ListBoxCreateWidgetFunc, user_data: /*Unimplemented*/Fundamental: Pointer, user_data_free_func: /*Unknown conversion*//*Unimplemented*/DestroyNotify) {

...
unsafe extern "C" fn day_selected_trampoline(this: *mut GtkCalendar, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&Calendar) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

unsafe extern "C" fn day_selected_double_click_trampoline(this: *mut GtkCalendar, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&Calendar) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

unsafe extern "C" fn month_changed_trampoline(this: *mut GtkCalendar, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&Calendar) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

unsafe extern "C" fn next_month_trampoline(this: *mut GtkCalendar, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&Calendar) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

unsafe extern "C" fn next_year_trampoline(this: *mut GtkCalendar, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&Calendar) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

unsafe extern "C" fn prev_month_trampoline(this: *mut GtkCalendar, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&Calendar) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

unsafe extern "C" fn prev_year_trampoline(this: *mut GtkCalendar, f: gpointer) {
    callback_guard!();
    let f: &Box_<Fn(&Calendar) + 'static> = transmute(f);
    f(&from_glib_none(this))
}

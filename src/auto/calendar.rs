...
pub trait CalendarExt {
    ...
    fn connect_property_day_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_detail_height_rows_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_detail_width_chars_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_month_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_no_month_change_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_day_names_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_details_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_heading_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_show_week_numbers_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_year_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<Calendar> {
    ...
    f(&Calendar::from_glib_none(this).downcast_unchecked())
}

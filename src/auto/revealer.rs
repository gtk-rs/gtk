...
pub trait RevealerExt {
    ...
    fn connect_property_child_revealed_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_reveal_child_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
...
where P: IsA<Revealer> {
    ...
    f(&Revealer::from_glib_none(this).downcast_unchecked())
}

...
impl Menu {
    ...
    //pub fn attach_to_widget<T: IsA<Widget>>(&self, attach_widget: &T, detacher: /*Unknown conversion*/Unknown rust type: "MenuDetachFunc") {
    ...
    //pub fn popup<T: IsA<Widget>, U: IsA<Widget>>(&self, parent_menu_shell: Option<&T>, parent_menu_item: Option<&U>, func: /*Unknown conversion*/Unknown rust type: "MenuPositionFunc", data: Fundamental: Pointer, button: u32, activate_time: u32) {
    //    unsafe { TODO: call ffi::gtk_menu_popup() }
    //}

    //pub fn popup_for_device<T: IsA<Widget>, U: IsA<Widget>>(&self, device: /*Ignored*/Option<&gdk::Device>, parent_menu_shell: Option<&T>, parent_menu_item: Option<&U>, func: /*Unknown conversion*/Unknown rust type: "MenuPositionFunc", data: Option<Fundamental: Pointer>, destroy: /*Unknown conversion*/Unknown rust type: "DestroyNotify", button: u32, activate_time: u32) {

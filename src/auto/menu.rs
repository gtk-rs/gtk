...
pub trait MenuExt {
    ...
    fn connect_property_accel_group_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_accel_path_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_active_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_22")]
    fn connect_property_anchor_hints_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_attach_widget_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_22")]
    fn connect_property_menu_type_hint_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_monitor_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_22")]
    fn connect_property_rect_anchor_dx_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_22")]
    fn connect_property_rect_anchor_dy_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_reserve_toggle_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_tearoff_state_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
...
where P: IsA<Menu> {
    ...
    f(&Menu::from_glib_none(this).downcast_unchecked())
}

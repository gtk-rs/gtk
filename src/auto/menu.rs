...
impl<O: IsA<Menu> + IsA<Container> + IsA<glib::object::Object> + glib::object::ObjectExt> MenuExt for O {
    ...
    fn get_property_anchor_hints(&self) -> gdk::AnchorHints {
        unsafe {
            ...
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <gdk::AnchorHints as StaticType>::static_type().to_glib());
    ...
    fn get_property_menu_type_hint(&self) -> gdk::WindowTypeHint {
        unsafe {
            let mut value = Value::uninitialized();
            gobject_ffi::g_value_init(value.to_glib_none_mut().0, <gdk::WindowTypeHint as StaticType>::static_type().to_glib());

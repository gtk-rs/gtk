...
impl Menu {
    ...
    pub fn attach<P: IsA<Widget>>(&self, child: &P, left_attach: u32, right_attach: u32, top_attach: u32, bottom_attach: u32) {
        unsafe {
            ffi::gtk_menu_attach(self.to_glib_none().0, child.to_glib_none().0, left_attach, right_attach, top_attach, bottom_attach);
        }
    }

    //pub fn attach_to_widget<'a, P: IsA<Widget>, Q: Into<Option<&'a /*Unimplemented*/MenuDetachFunc>>>(&self, attach_widget: &P, detacher: Q) {
    ...
    //pub fn popup<'a, 'b, 'c, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>, R: IsA<Widget> + 'b, S: Into<Option<&'b R>>, T: Into<Option<&'c /*Unimplemented*/MenuPositionFunc>>, U: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(&self, parent_menu_shell: Q, parent_menu_item: S, func: T, data: U, button: u32, activate_time: u32) {
    //    unsafe { TODO: call ffi::gtk_menu_popup() }
    //}

    #[cfg(feature = "v3_22")]
    pub fn popup_at_pointer<'a, P: Into<Option<&'a gdk::Event>>>(&self, trigger_event: P) {
        let trigger_event = trigger_event.into();
        let trigger_event = trigger_event.to_glib_none().0;
        unsafe {
            ffi::gtk_menu_popup_at_pointer(self.to_glib_none().0, trigger_event);
        }
    }

    #[cfg(feature = "v3_22")]
    pub fn popup_at_rect<'a, P: Into<Option<&'a gdk::Event>>>(&self, rect_window: &gdk::Window, rect: &gdk::Rectangle, rect_anchor: gdk::Gravity, menu_anchor: gdk::Gravity, trigger_event: P) {
        let trigger_event = trigger_event.into();
        let trigger_event = trigger_event.to_glib_none().0;
        unsafe {
            ffi::gtk_menu_popup_at_rect(self.to_glib_none().0, rect_window.to_glib_none().0, rect.to_glib_none().0, rect_anchor.to_glib(), menu_anchor.to_glib(), trigger_event);
        }
    }

    #[cfg(feature = "v3_22")]
    pub fn popup_at_widget<'a, P: IsA<Widget>, Q: Into<Option<&'a gdk::Event>>>(&self, widget: &P, widget_anchor: gdk::Gravity, menu_anchor: gdk::Gravity, trigger_event: Q) {
        let trigger_event = trigger_event.into();
        let trigger_event = trigger_event.to_glib_none().0;
        unsafe {
            ffi::gtk_menu_popup_at_widget(self.to_glib_none().0, widget.to_glib_none().0, widget_anchor.to_glib(), menu_anchor.to_glib(), trigger_event);
        }
    }
    ...
    pub fn reorder_child<P: IsA<Widget>>(&self, child: &P, position: i32) {
        unsafe {
    ...
    pub fn set_accel_group<'a, P: Into<Option<&'a AccelGroup>>>(&self, accel_group: P) {
        let accel_group = accel_group.into();
        let accel_group = accel_group.to_glib_none().0;
        unsafe {
            ffi::gtk_menu_set_accel_group(self.to_glib_none().0, accel_group);
        }
    }

    pub fn set_accel_path<'a, P: Into<Option<&'a str>>>(&self, accel_path: P) {
        let accel_path = accel_path.into();
        let accel_path = accel_path.to_glib_none().0;
        unsafe {
            ffi::gtk_menu_set_accel_path(self.to_glib_none().0, accel_path);
        }
    }
    ...
    pub fn set_screen<'a, P: Into<Option<&'a gdk::Screen>>>(&self, screen: P) {
        let screen = screen.into();
        let screen = screen.to_glib_none().0;
        unsafe {
            ffi::gtk_menu_set_screen(self.to_glib_none().0, screen);
        }
    }

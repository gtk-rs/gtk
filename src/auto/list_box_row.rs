...
impl ListBoxRow {
    ...
    #[cfg(feature = "v3_10")]
    pub fn set_header<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, header: Q) {
        let header = header.into();
        let header = header.to_glib_none().0;
        unsafe {
            ffi::gtk_list_box_row_set_header(self.to_glib_none().0, header);
        }
    }

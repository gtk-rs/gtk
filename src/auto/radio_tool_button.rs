...
glib_wrapper! {
    pub struct RadioToolButton(Object<ffi::GtkRadioToolButton, ffi::GtkRadioToolButtonClass>): ToggleToolButton, ToolButton, ToolItem, Bin, Container, Widget, Actionable;

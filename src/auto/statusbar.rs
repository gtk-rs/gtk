...
pub type Statusbar = Object<ffi::GtkStatusbar>;

unsafe impl Upcast<Widget> for Statusbar { }
unsafe impl Upcast<Container> for Statusbar { }
unsafe impl Upcast<Box> for Statusbar { }
unsafe impl Upcast<Buildable> for Statusbar { }
unsafe impl Upcast<Orientable> for Statusbar { }
...
impl types::StaticType for Statusbar {
    #[inline]
    fn static_type() -> types::Type {
        unsafe { from_glib(ffi::gtk_statusbar_get_type()) }
    }
}

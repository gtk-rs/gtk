...
impl SelectionData {
    ...
    pub fn get_selection(&self) -> gdk::Atom {
        unsafe {
            from_glib_none(gtk_sys::gtk_selection_data_get_selection(self.to_glib_none().0))
        }
    }
    ...
    pub fn targets_include_rich_text<P: IsA<TextBuffer>>(&self, buffer: &P) -> bool {
        unsafe {
            from_glib(gtk_sys::gtk_selection_data_targets_include_rich_text(self.to_glib_none().0, buffer.as_ref().to_glib_none().0))
        }
    }

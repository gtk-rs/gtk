...
impl Stack {
    ...
    #[cfg(feature = "v3_10")]
    pub fn add_named<P: IsA<Widget>>(&self, child: &P, name: &str) {
        unsafe {
    ...
    #[cfg(feature = "v3_10")]
    pub fn add_titled<P: IsA<Widget>>(&self, child: &P, name: &str, title: &str) {
        unsafe {
    ...
    pub fn set_property_visible_child<P: IsA<Widget> + IsA<Object>>(&self, visible_child: Option<&P>) {
        unsafe {

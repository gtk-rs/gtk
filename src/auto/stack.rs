...
pub trait StackExt {
    ...
    #[cfg(feature = "v3_16")]
    fn connect_property_hhomogeneous_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_homogeneous_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_interpolate_size_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_transition_duration_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_transition_running_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_transition_type_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    #[cfg(feature = "v3_16")]
    fn connect_property_vhomogeneous_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_visible_child_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;

    fn connect_property_visible_child_name_notify<F: Fn(&Self) + 'static>(&self, f: F) -> u64;
}
...
where P: IsA<Stack> {
    ...
    f(&Stack::from_glib_none(this).downcast_unchecked())
}

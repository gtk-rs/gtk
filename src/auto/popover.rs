...
impl Popover {
    ...
    pub fn new<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(relative_to: Q) -> Popover {
        ...
        let relative_to = relative_to.to_glib_none().0;
        unsafe {
            Widget::from_glib_none(ffi::gtk_popover_new(relative_to)).downcast_unchecked()
        }
    }
    ...
    pub fn new_from_model<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>, R: IsA<gio::MenuModel>>(relative_to: Q, model: &R) -> Popover {
        ...
        let relative_to = relative_to.to_glib_none().0;
        unsafe {
            Widget::from_glib_none(ffi::gtk_popover_new_from_model(relative_to, model.to_glib_none().0)).downcast_unchecked()
        }
    }
}
...
impl<O: IsA<Popover> + IsA<Object>> PopoverExt for O {
    ...
    fn bind_model<'a, 'b, P: IsA<gio::MenuModel> + 'a, Q: Into<Option<&'a P>>, R: Into<Option<&'b str>>>(&self, model: Q, action_namespace: R) {
        ...
        let action_namespace = action_namespace.to_glib_none().0;
        unsafe {
            ffi::gtk_popover_bind_model(self.to_glib_none().0, model, action_namespace);
        }
    }
    ...
    fn set_default_widget<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, widget: Q) {
        ...
        unsafe {
            ffi::gtk_popover_set_default_widget(self.to_glib_none().0, widget);
        }
    }
    ...
    fn set_relative_to<'a, P: IsA<Widget> + 'a, Q: Into<Option<&'a P>>>(&self, relative_to: Q) {
        ...
        let relative_to = relative_to.to_glib_none().0;
        unsafe {
            ffi::gtk_popover_set_relative_to(self.to_glib_none().0, relative_to);
        }
    }

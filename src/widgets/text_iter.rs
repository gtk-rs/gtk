...
impl TextIter {
    ...
    pub fn get_buffer(&self) -> Option<::TextBuffer> {
        let tmp_pointer = unsafe { ffi::gtk_text_iter_get_buffer(self.pointer as *const ffi::GtkTextIter) };
    ...
    pub fn copy(&self) -> Option<TextIter> {
        let tmp_pointer = unsafe { ffi::gtk_text_iter_copy(self.pointer as *const ffi::GtkTextIter) };
    ...
    pub fn assign(&self, other: &TextIter) {
        unsafe { ffi::gtk_text_iter_assign(self.pointer, other.pointer as *const ffi::GtkTextIter) }
    }

    pub fn get_offset(&self) -> i32 {
        unsafe { ffi::gtk_text_iter_get_offset(self.pointer as *const ffi::GtkTextIter) }
    }

    pub fn get_line(&self) -> i32 {
        unsafe { ffi::gtk_text_iter_get_line(self.pointer as *const ffi::GtkTextIter) }
    }

    pub fn get_line_offset(&self) -> i32 {
        unsafe { ffi::gtk_text_iter_get_line_offset(self.pointer as *const ffi::GtkTextIter) }
    }

    pub fn get_line_index(&self) -> i32 {
        unsafe { ffi::gtk_text_iter_get_line_index(self.pointer as *const ffi::GtkTextIter) }
    }

    pub fn get_visible_line_index(&self) -> i32 {
        unsafe { ffi::gtk_text_iter_get_visible_line_index(self.pointer as *const ffi::GtkTextIter) }
    }

    pub fn get_visible_line_offset(&self) -> i32 {
        unsafe { ffi::gtk_text_iter_get_visible_line_offset(self.pointer as *const ffi::GtkTextIter) }
    }

    pub fn get_char(&self) -> u32 {
        unsafe { ffi::gtk_text_iter_get_char(self.pointer as *const ffi::GtkTextIter) }
    }

    pub fn get_slice(&self, end: &TextIter) -> Option<String> {
        unsafe {
            from_glib_none(ffi::gtk_text_iter_get_slice(
                    self.pointer as *const ffi::GtkTextIter,
                    end.pointer as *const ffi::GtkTextIter))
        }
    }
    ...
    pub fn get_child_anchor(&self) -> Option<::TextChildAnchor> {
        let tmp_pointer = unsafe { ffi::gtk_text_iter_get_child_anchor(self.pointer as *const ffi::GtkTextIter) };
    ...
    pub fn begins_tag(&self, tag: &::TextTag) -> bool {
        unsafe { to_bool(ffi::gtk_text_iter_begins_tag(self.pointer as *const ffi::GtkTextIter, tag.unwrap_pointer())) }
    }

    pub fn ends_tag(&self, tag: &::TextTag) -> bool {
        unsafe { to_bool(ffi::gtk_text_iter_ends_tag(self.pointer as *const ffi::GtkTextIter, tag.unwrap_pointer())) }
    }
    ...
    pub fn editable(&self, default_setting: bool) -> bool {
        unsafe { to_bool(ffi::gtk_text_iter_editable(self.pointer as *const ffi::GtkTextIter, to_gboolean(default_setting))) }
    }

    pub fn can_insert(&self, default_setting: bool) -> bool {
        unsafe { to_bool(ffi::gtk_text_iter_can_insert(self.pointer as *const ffi::GtkTextIter, to_gboolean(default_setting))) }
    }

    pub fn starts_word(&self) -> bool {
        unsafe { to_bool(ffi::gtk_text_iter_starts_word(self.pointer as *const ffi::GtkTextIter)) }
    }

    pub fn ends_word(&self) -> bool {
        unsafe { to_bool(ffi::gtk_text_iter_ends_word(self.pointer as *const ffi::GtkTextIter)) }
    }
    ...
    pub fn starts_line(&self) -> bool {
        unsafe { to_bool(ffi::gtk_text_iter_starts_line(self.pointer as *const ffi::GtkTextIter)) }
    }

    pub fn ends_line(&self) -> bool {
        unsafe { to_bool(ffi::gtk_text_iter_ends_line(self.pointer as *const ffi::GtkTextIter)) }
    }

    pub fn starts_sentence(&self) -> bool {
        unsafe { to_bool(ffi::gtk_text_iter_starts_sentence(self.pointer as *const ffi::GtkTextIter)) }
    }

    pub fn ends_sentence(&self) -> bool {
        unsafe { to_bool(ffi::gtk_text_iter_ends_sentence(self.pointer as *const ffi::GtkTextIter)) }
    }

    pub fn inside_sentence(&self) -> bool {
        unsafe { to_bool(ffi::gtk_text_iter_inside_sentence(self.pointer as *const ffi::GtkTextIter)) }
    }

    pub fn is_cursor_position(&self) -> bool {
        unsafe { to_bool(ffi::gtk_text_iter_is_cursor_position(self.pointer as *const ffi::GtkTextIter)) }
    }

    pub fn get_chars_in_line(&self) -> i32 {
        unsafe { ffi::gtk_text_iter_get_chars_in_line(self.pointer as *const ffi::GtkTextIter) }
    }

    pub fn get_bytes_in_line(&self) -> i32 {
        unsafe { ffi::gtk_text_iter_get_bytes_in_line(self.pointer as *const ffi::GtkTextIter) }
    }

    pub fn get_attributes(&self, values: &::TextAttributes) -> bool {
        unsafe { to_bool(ffi::gtk_text_iter_get_attributes(self.pointer as *const ffi::GtkTextIter, values.unwrap_pointer())) }
    }

    pub fn is_end(&self) -> bool {
        unsafe { to_bool(ffi::gtk_text_iter_is_end(self.pointer as *const ffi::GtkTextIter)) }
    }

    pub fn is_start(&self) -> bool {
        unsafe { to_bool(ffi::gtk_text_iter_is_start(self.pointer as *const ffi::GtkTextIter)) }
    }
    ...
    pub fn is_equal_to(&self, other: &TextIter) -> bool {
        unsafe { to_bool(ffi::gtk_text_iter_equal(self.pointer as *const ffi::GtkTextIter,
            other.pointer as *const ffi::GtkTextIter)) }
    }

    pub fn compare_to(&self, other: &TextIter) -> i32 {
        unsafe { ffi::gtk_text_iter_compare(self.pointer as *const ffi::GtkTextIter, other.pointer as *const ffi::GtkTextIter) }
    }

    pub fn in_range(&self, start: &TextIter, end: &TextIter) -> bool {
        unsafe { to_bool(ffi::gtk_text_iter_in_range(self.pointer as *const ffi::GtkTextIter,
            start.pointer as *const ffi::GtkTextIter, end.pointer as *const ffi::GtkTextIter)) }
    }
...
impl_GObjectFunctions!(TextIter, GtkTextIter);
impl_TraitObject!(TextIter, GtkTextIter);

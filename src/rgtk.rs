...
pub use gtk::traits::RecentChooser as GtkRecentChooserTrait;
pub use gtk::traits::ScaleButton as GtkScaleButtonTrait;
pub use gtk::traits::Scrollable as GtkScrollableTrait;
pub use gtk::traits::ScrolledWindow as GtkScrolledWindowTrait;
pub use gtk::traits::TextBuffer as GtkTextBufferTrait;

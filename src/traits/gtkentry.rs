...
pub trait GtkEntry: GtkWidget {
    ...
    fn set_icon_from_stock(&mut self, icon_pos: GtkEntryIconPosition, stock_id: &str) -> () {
        unsafe {
            ffi::gtk_entry_set_icon_from_stock(GTK_ENTRY(self.get_widget()), icon_pos, stock_id.to_c_str().unwrap());
        }
    }

    fn set_icon_from_icon_name(&mut self, icon_pos: GtkEntryIconPosition, icon_name: &str) -> () {
        unsafe {
    ...
    fn get_icon_storage_type(&self, icon_pos: GtkEntryIconPosition) -> GtkImageType {
        unsafe {
    ...
    fn get_icon_activatable(&self, icon_pos: GtkEntryIconPosition) -> bool {
    ...
    fn set_icon_activatable(&mut self, icon_pos: GtkEntryIconPosition, activatable: bool) {
        match activatable {
    ...
    fn get_icon_sensitive(&self, icon_pos: GtkEntryIconPosition) -> bool {
    ...
    fn set_icon_sensitive(&mut self, icon_pos: GtkEntryIconPosition, sensitive: bool) {
        match sensitive {
    ...
    fn set_icon_tooltip_text(&mut self, icon_pos: GtkEntryIconPosition, tooltip: &str) -> () {
        unsafe {
    ...
    fn set_icon_tooltip_markup(&mut self, icon_pos: GtkEntryIconPosition, tooltip: &str) -> () {
        unsafe {
    ...
    fn get_input_purpose(&self) -> GtkInputPurpose {
        unsafe {
    ...
    fn get_input_hints(&self) -> GtkInputHints {
        unsafe {

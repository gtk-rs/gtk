...
glib_wrapper! {
    ...
    match fn {
        copy => |ptr| ffi::gtk_text_iter_copy(ptr as *mut ffi::GtkTextIter),
...
impl TextIter {
    ...
    pub fn backward_cursor_positions(&mut self, count: i32) -> bool {
        unsafe {
            from_glib(
                ffi::gtk_text_iter_backward_cursor_positions(self.to_glib_none_mut().0, count))
        }
    }

    //pub fn backward_find_char(&self, pred: /*Unknown conversion*/Unknown rust type: "TextCharPredicate", user_data: Fundamental: Pointer, limit: Option<&TextIter>) -> bool {
    ...
    pub fn backward_search(&self, str: &str, flags: TextSearchFlags, limit: Option<&TextIter>)
            -> Option<(TextIter, TextIter)> {
        unsafe {
            let mut match_start = TextIter::uninitialized();
            let mut match_end = TextIter::uninitialized();
            let ret = from_glib(
                ffi::gtk_text_iter_backward_search(self.to_glib_none().0, str.to_glib_none().0,
                    flags, match_start.to_glib_none_mut().0, match_end.to_glib_none_mut().0,
    ...
    pub fn backward_to_tag_toggle(&mut self, tag: Option<&TextTag>) -> bool {
        unsafe {
            from_glib(
                ffi::gtk_text_iter_backward_to_tag_toggle(self.to_glib_none_mut().0,
                    tag.to_glib_none().0))
        }
    }
    ...
    pub fn backward_visible_cursor_position(&mut self) -> bool {
        unsafe {
            from_glib(
                ffi::gtk_text_iter_backward_visible_cursor_position(self.to_glib_none_mut().0))
        }
    }
    ...
    pub fn backward_visible_cursor_positions(&mut self, count: i32) -> bool {
        unsafe {
            from_glib(
                ffi::gtk_text_iter_backward_visible_cursor_positions(self.to_glib_none_mut().0,
                    count))
        }
    }
    ...
    pub fn backward_visible_word_starts(&mut self, count: i32) -> bool {
        unsafe {
            from_glib(
                ffi::gtk_text_iter_backward_visible_word_starts(self.to_glib_none_mut().0, count))
        }
    }
    ...
    pub fn can_insert(&self, default_editability: bool) -> bool {
        unsafe {
            from_glib(
                ffi::gtk_text_iter_can_insert(self.to_glib_none().0, default_editability.to_glib()))
        }
    }

    pub fn compare(&self, rhs: &TextIter) -> i32 {
        unsafe {
    ...
    pub fn equal(&self, rhs: &TextIter) -> bool {
        unsafe {
    ...
    //pub fn forward_find_char(&self, pred: /*Unknown conversion*/Unknown rust type: "TextCharPredicate", user_data: Fundamental: Pointer, limit: Option<&TextIter>) -> bool {
    ...
    pub fn forward_search(&self, str: &str, flags: TextSearchFlags, limit: Option<&TextIter>)
            -> Option<(TextIter, TextIter)> {
        unsafe {
            let mut match_start = TextIter::uninitialized();
            let mut match_end = TextIter::uninitialized();
            let ret = from_glib(
                ffi::gtk_text_iter_forward_search(self.to_glib_none().0, str.to_glib_none().0,
                    flags, match_start.to_glib_none_mut().0, match_end.to_glib_none_mut().0,
                    limit.to_glib_none().0));
            if ret { Some((match_start, match_end)) } else { None }
        }
    ...
    pub fn forward_to_tag_toggle(&mut self, tag: Option<&TextTag>) -> bool {
        unsafe {
            from_glib(
                ffi::gtk_text_iter_forward_to_tag_toggle(self.to_glib_none_mut().0,
                    tag.to_glib_none().0))
        }
    }
    ...
    pub fn forward_visible_cursor_positions(&mut self, count: i32) -> bool {
        unsafe {
            from_glib(
                ffi::gtk_text_iter_forward_visible_cursor_positions(self.to_glib_none_mut().0,
                    count))
        }
    }
    ...
    pub fn forward_visible_word_ends(&mut self, count: i32) -> bool {
        unsafe {
            from_glib(
                ffi::gtk_text_iter_forward_visible_word_ends(self.to_glib_none_mut().0, count))
        }
    }
    ...
    //pub fn get_attributes(&self, values: /*Ignored*/TextAttributes) -> bool {
    //    unsafe { TODO: call ffi::gtk_text_iter_get_attributes() }
    //}
    ...
    //pub fn get_char(&self) -> /*Unknown conversion*/Fundamental: UniChar {
    //    unsafe { TODO: call ffi::gtk_text_iter_get_char() }
    //}
    ...
    //pub fn get_language(&self) -> /*Ignored*/pango::Language {
    ...
    //pub fn get_marks(&self) -> /*Unknown conversion*/Unknown rust type: "SList TypeId { ns_id: 1, id: 828 }" {
    //    unsafe { TODO: call ffi::gtk_text_iter_get_marks() }
    //}
    ...
    pub fn get_slice(&self, end: &TextIter) -> Option<String> {
        unsafe {
            from_glib_full(
                ffi::gtk_text_iter_get_slice(self.to_glib_none().0, end.to_glib_none().0))
        }
    }

    //pub fn get_tags(&self) -> /*Unknown conversion*/Unknown rust type: "SList TypeId { ns_id: 1, id: 830 }" {
    //    unsafe { TODO: call ffi::gtk_text_iter_get_tags() }
    //}
    ...
    //pub fn get_toggled_tags(&self, toggled_on: bool) -> /*Unknown conversion*/Unknown rust type: "SList TypeId { ns_id: 1, id: 830 }" {
    //    unsafe { TODO: call ffi::gtk_text_iter_get_toggled_tags() }
    //}
    ...
    pub fn get_visible_slice(&self, end: &TextIter) -> Option<String> {
        unsafe {
            from_glib_full(
                ffi::gtk_text_iter_get_visible_slice(self.to_glib_none().0, end.to_glib_none().0))
        }
    }
    ...
    pub fn get_visible_text(&self, end: &TextIter) -> Option<String> {
        unsafe {
            from_glib_full(
                ffi::gtk_text_iter_get_visible_text(self.to_glib_none().0, end.to_glib_none().0))
        }
    }
    ...
    pub fn in_range(&self, start: &TextIter, end: &TextIter) -> bool {
        unsafe {
            from_glib(
                ffi::gtk_text_iter_in_range(self.to_glib_none().0, start.to_glib_none().0,
                    end.to_glib_none().0))
        }
    }

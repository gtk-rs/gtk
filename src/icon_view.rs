...
impl IconView {
    ...
    //pub fn create_drag_icon(&self, path: &TreePath) -> /*Ignored*/cairo::Surface {
    ...
    pub fn get_cell_rect<T: Upcast<CellRenderer>>(&self, path: &TreePath, cell: Option<&T>) -> Option<Rectangle> {
        unsafe {
            ...
            let ret = from_glib(
                ffi::gtk_icon_view_get_cell_rect(self.to_glib_none().0,
                    mut_override(path.to_glib_none().0), cell.to_glib_none().0,
    ...
    pub fn get_item_column(&self, path: &TreePath) -> i32 {
        unsafe {
            ffi::gtk_icon_view_get_item_column(self.to_glib_none().0,
    ...
    pub fn get_item_row(&self, path: &TreePath) -> i32 {
        unsafe {
            ffi::gtk_icon_view_get_item_row(self.to_glib_none().0,
                mut_override(path.to_glib_none().0))
        }
    }
    ...
    pub fn item_activated(&self, path: &TreePath) {
        unsafe {
            ffi::gtk_icon_view_item_activated(self.to_glib_none().0,
                mut_override(path.to_glib_none().0));
        }
    }
    ...
    pub fn path_is_selected(&self, path: &TreePath) -> bool {
        unsafe {
            from_glib(ffi::gtk_icon_view_path_is_selected(self.to_glib_none().0,
                mut_override(path.to_glib_none().0)))
        }
    }
    ...
    pub fn scroll_to_path(&self, path: &TreePath, use_align: bool, row_align: f32, col_align: f32) {
        unsafe {
            ffi::gtk_icon_view_scroll_to_path(self.to_glib_none().0,
                mut_override(path.to_glib_none().0), use_align.to_glib(), row_align, col_align);
        }
    }
    ...
    pub fn select_path(&self, path: &TreePath) {
        unsafe {
            ffi::gtk_icon_view_select_path(self.to_glib_none().0,
                mut_override(path.to_glib_none().0));
        }
    }
    ...
    pub fn set_cursor<T: Upcast<CellRenderer>>(&self, path: &TreePath, cell: Option<&T>, start_editing: bool) {
        unsafe {
            ffi::gtk_icon_view_set_cursor(self.to_glib_none().0,
                mut_override(path.to_glib_none().0), cell.to_glib_none().0,
    ...
    pub fn set_drag_dest_item(&self, path: Option<&TreePath>, pos: IconViewDropPosition) {
        unsafe {
            ffi::gtk_icon_view_set_drag_dest_item(self.to_glib_none().0,
                mut_override(path.to_glib_none().0), pos);
        }
    }
    ...
    //pub fn set_tooltip_cell<T: Upcast<CellRenderer>>(&self, tooltip: /*Ignored*/&Tooltip, path: &TreePath, cell: Option<&T>) {
    ...
    //pub fn set_tooltip_item(&self, tooltip: /*Ignored*/&Tooltip, path: &TreePath) {
    ...
    pub fn unselect_path(&self, path: &TreePath) {
        unsafe {
            ffi::gtk_icon_view_unselect_path(self.to_glib_none().0,
                mut_override(path.to_glib_none().0));
        }
    }
